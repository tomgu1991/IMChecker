...
int ec_main(int argc, char **argv)
{
    ...
    OPTION_CHOICE o;
    int asn1_flag = 0x001, new_form = 0, new_asn1_flag = 0;
    int informat = (5 | 0x8000), outformat = (5 | 0x8000), text = 0, noout = 0;
 ...
 opthelp:
    ...
    if (no_public)
        EC_KEY_set_enc_flags(eckey, 0x002);
    ...
    EC_KEY_free(eckey);
    release_engine(e);
    CRYPTO_free(passin, "apps/ec.c", 279);
    CRYPTO_free(passout, "apps/ec.c", 280);
    return ret;
}
