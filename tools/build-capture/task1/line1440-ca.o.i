...
static int certify(X509 **xret, const char *infile, EVP_PKEY *pkey, X509 *x509,
                   const EVP_MD *dgst, struct stack_st_OPENSSL_STRING *sigopts,
                   struct stack_st_CONF_VALUE *policy, CA_DB *db,
...
static int do_body(X509 **xret, EVP_PKEY *pkey, X509 *x509,
                   const EVP_MD *dgst, struct stack_st_OPENSSL_STRING *sigopts,
                   struct stack_st_CONF_VALUE *policy, CA_DB *db, BIGNUM *serial,
...
int ca_main(int argc, char **argv)
{
    CONF *conf = ((void*)0);
    ENGINE *e = ((void*)0);
    BIGNUM *crlnumber = ((void*)0), *serial = ((void*)0);
    EVP_PKEY *pkey = ((void*)0);
    BIO *in = ((void*)0), *out = ((void*)0), *Sout = ((void*)0);
    ASN1_INTEGER *tmpser;
    ASN1_TIME *tmptm;
    CA_DB *db = ((void*)0);
    DB_ATTR db_attr;
    struct stack_st_CONF_VALUE *attribs = ((void*)0);
    struct stack_st_OPENSSL_STRING *sigopts = ((void*)0);
    struct stack_st_X509 *cert_sk = ((void*)0);
    X509_CRL *crl = ((void*)0);
    const EVP_MD *dgst = ((void*)0);
    char *configfile = default_config_file, *section = ((void*)0);
    char *md = ((void*)0), *policy = ((void*)0), *keyfile = ((void*)0);
    char *certfile = ((void*)0), *crl_ext = ((void*)0), *crlnumberfile = ((void*)0), *key = ((void*)0);
    const char *infile = ((void*)0), *spkac_file = ((void*)0), *ss_cert_file = ((void*)0);
    const char *extensions = ((void*)0), *extfile = ((void*)0), *passinarg = ((void*)0);
    char *outdir = ((void*)0), *outfile = ((void*)0), *rev_arg = ((void*)0), *ser_status = ((void*)0);
    const char *serialfile = ((void*)0), *subj = ((void*)0);
    char *prog, *startdate = ((void*)0), *enddate = ((void*)0);
    char *dbfile = ((void*)0), *f;
    char new_cert[4096];
    char tmp[10 + 1] = "\0";
    char *const *pp;
    const char *p;
    ...
    int batch = 0, default_op = 1, doupdatedb = 0, ext_copy = 0;
    int keyformat = (5 | 0x8000), multirdn = 0, notext = 0, output_der = 0;
    int ret = 1, email_dn = 1, req = 0, verbose = 0, gencrl = 0, dorevoke = 0;
    int rand_ser = 0, i, j, selfsign = 0;
    long crldays = 0, crlhours = 0, crlsec = 0, days = 0;
    unsigned long chtype = (0x1000|1), certopt = 0;
    X509 *x509 = ((void*)0), *x509p = ((void*)0), *x = ((void*)0);
    REVINFO_TYPE rev_type = REV_NONE;
    X509_REVOKED *r = ((void*)0);
    OPTION_CHOICE o;
...
opthelp:
        ...
        case OPT_KEYFILE:
            ...
            break;
        case OPT_KEYFORM:
            if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10)), &keyformat))
                goto opthelp;
            break;
        case OPT_PASSIN:
            passinarg = opt_arg();
        ...
        case OPT_SIGOPT:
            ...
            if (sigopts == ((void*)0) || !sk_OPENSSL_STRING_push(sigopts, opt_arg()))
                goto end;
            break;
        case OPT_NOTEXT:
            notext = 1;
...
end_of_options:
    ...
    if ((conf = app_load_config(configfile)) == ((void*)0))
        goto end;
    ...
    if (section == ((void*)0)
        && (section = lookup_conf(conf, "ca", "default_ca")) == ((void*)0))
        goto end;
    ...
    app_RAND_load_conf(conf, "ca");

    f = NCONF_get_string(conf, section, "string_mask");
    if (f == ((void*)0))
        ERR_clear_error();

    if (f != ((void*)0) && !ASN1_STRING_set_default_mask_asc(f)) {
        BIO_printf(bio_err, "Invalid global string mask setting %s\n", f);
        goto end;
    }

    if (chtype != (0x1000)) {
        f = NCONF_get_string(conf, section, "utf8");
        if (f == ((void*)0))
            ERR_clear_error();
    ...
    if (ser_status) {
        dbfile = lookup_conf(conf, section, "database");
        if (dbfile == ((void*)0))
            goto end;
    ...
    if (keyfile == ((void*)0)
        && (keyfile = lookup_conf(conf, section, "private_key")) == ((void*)0))
        goto end;

    if (key == ((void*)0)) {
        free_key = 1;
        if (!app_passwd(passinarg, ((void*)0), &key, ((void*)0))) {
    ...
    if (!selfsign || spkac_file || ss_cert_file || gencrl) {
        if (certfile == ((void*)0)
            && (certfile = lookup_conf(conf, section, "certificate")) == ((void*)0))
            goto end;

        x509 = load_cert(certfile, (5 | 0x8000), "CA certificate");
        if (x509 == ((void*)0))
            goto end;
    ...
    f = NCONF_get_string(conf, "ca", "preserve");
    if (f == ((void*)0))
        ERR_clear_error();
    if ((f != ((void*)0)) && ((*f == 'y') || (*f == 'Y')))
        preserve = 1;
    f = NCONF_get_string(conf, "ca", "msie_hack");
    if (f == ((void*)0))
        ERR_clear_error();
    if ((f != ((void*)0)) && ((*f == 'y') || (*f == 'Y')))
        msie_hack = 1;

    f = NCONF_get_string(conf, section, "name_opt");
    ...
    f = NCONF_get_string(conf, section, "cert_opt");
    ...
    f = NCONF_get_string(conf, section, "copy_extensions");
    ...
    if ((outdir == ((void*)0)) && (req)) {

        outdir = NCONF_get_string(conf, section, "new_certs_dir");
        if (outdir == ((void*)0)) {
            BIO_printf(bio_err,
...
# 612 "apps/ca.c"
    ...
    for (i = 0; i < sk_OPENSSL_PSTRING_num(db->db->data); i++) {
        ...
        if ((pp[0][0] == 'R') &&
            !make_revoked(((void*)0), pp[2])) {
            BIO_printf(bio_err, " in entry %d\n", i + 1);
            goto end;
        }
        if (!check_time_format((char *)pp[1])) {
    ...
    if (extfile) {
        if ((extconf = app_load_config(extfile)) == ((void*)0)) {
            ret = 1;
            goto end;
        }
    ...
    if (req || gencrl) {
        if (spkac_file != ((void*)0)) {
            output_der = 1;
            batch = 1;
        }
        Sout = bio_open_default(outfile, 'w',
                                output_der ? 4 : (1 | 0x8000));
        if (Sout == ((void*)0))
            goto end;
    }

    if (md == ((void*)0) && (md = lookup_conf(conf, section, "default_md")) == ((void*)0))
        goto end;
    ...
    if (req) {
        if (email_dn == 1) {
            char *tmp_email_dn = ((void*)0);

            tmp_email_dn = NCONF_get_string(conf, section, "email_in_dn");
            if (tmp_email_dn != ((void*)0) && strcmp(tmp_email_dn, "no") == 0)
                email_dn = 0;
        }
        if (verbose)
        ...
        if (policy == ((void*)0)
            && (policy = lookup_conf(conf, section, "policy")) == ((void*)0))
            goto end;

        if (verbose)
            BIO_printf(bio_err, "policy is %s\n", policy);

        if (NCONF_get_string(conf, section, "rand_serial") != ((void*)0)) {
            rand_ser = 1;
        } else {
            serialfile = lookup_conf(conf, section, "serial");
            if (serialfile == ((void*)0))
                goto end;
        }
        ...
        if (extconf == ((void*)0)) {
            ...
            if (extensions == ((void*)0)) {
                extensions = NCONF_get_string(conf, section, "x509_extensions");
                if (extensions == ((void*)0))
                    ERR_clear_error();
            }
            if (extensions != ((void*)0)) {
                ...
                X509V3_CTX ctx;
                X509V3_set_ctx(&ctx, ((void*)0), ((void*)0), ((void*)0), ((void*)0), 0x1);
                X509V3_set_nconf(&ctx, conf);
                if (!X509V3_EXT_add_nconf(conf, &ctx, extensions, ((void*)0))) {
                    BIO_printf(bio_err,
        ...
        if (startdate == ((void*)0)) {
            startdate = NCONF_get_string(conf, section, "default_startdate");
            if (startdate == ((void*)0))
                ERR_clear_error();
        }
        if (startdate != ((void*)0) && !ASN1_TIME_set_string_X509(((void*)0), startdate)) {
            BIO_printf(bio_err,
        ...
        if (enddate == ((void*)0)) {
            enddate = NCONF_get_string(conf, section, "default_enddate");
            if (enddate == ((void*)0))
                ERR_clear_error();
        }
        if (enddate != ((void*)0) && !ASN1_TIME_set_string_X509(((void*)0), enddate)) {
            BIO_printf(bio_err,
        ...
        if (days == 0) {
            if (!NCONF_get_number_e(conf,section,"default_days",&days))
                days = 0;
        }
        if (enddate == ((void*)0) && days == 0) {
            BIO_printf(bio_err, "cannot lookup how many days to certify for\n");
            goto end;
        }

        if (rand_ser) {
            if ((serial = BN_new()) == ((void*)0) || !rand_serial(serial, ((void*)0))) {
                BIO_printf(bio_err, "error generating serial number\n");
                goto end;
            }
        } else {
            if ((serial = load_serial(serialfile, create_ser, ((void*)0))) == ((void*)0)) {
            ...
            if (verbose) {
                if (BN_is_zero(serial)) {
                    ...
                    if ((f = BN_bn2hex(serial)) == ((void*)0))
                        goto end;
                    BIO_printf(bio_err, "next serial number is %s\n", f);
                    CRYPTO_free(f, "apps/ca.c", 856);
                }
            }
        }

        if ((attribs = NCONF_get_section(conf, policy)) == ((void*)0)) {
            BIO_printf(bio_err, "unable to find 'section' for %s\n", policy);
            goto end;
        }

        if ((cert_sk = sk_X509_new_null()) == ((void*)0)) {
        ...
        if (sk_X509_num(cert_sk) > 0) {
            ...
            if (!rand_ser
                    && !save_serial(serialfile, "new", serial, ((void*)0)))
                goto end;
    ...
    if (gencrl) {
        int crl_v2 = 0;
        if (crl_ext == ((void*)0)) {
            crl_ext = NCONF_get_string(conf, section, "crl_extensions");
            if (crl_ext == ((void*)0))
                ERR_clear_error();
        }
        if (crl_ext != ((void*)0)) {
            ...
            X509V3_set_ctx(&ctx, ((void*)0), ((void*)0), ((void*)0), ((void*)0), 0x1);
            X509V3_set_nconf(&ctx, conf);
            if (!X509V3_EXT_add_nconf(conf, &ctx, crl_ext, ((void*)0))) {
                BIO_printf(bio_err,
        ...
        if ((crlnumberfile = NCONF_get_string(conf, section, "crlnumber"))
            != ((void*)0))
            if ((crlnumber = load_serial(crlnumberfile, 0, ((void*)0))) == ((void*)0)) {
                BIO_printf(bio_err, "error while loading CRL number\n");
                goto end;
            }

        if (!crldays && !crlhours && !crlsec) {
            if (!NCONF_get_number_e(conf,section,"default_crl_days",&crldays))

                crldays = 0;
            if (!NCONF_get_number_e(conf,section,"default_crl_hours",&crlhours))
        ...
        tmptm = ASN1_TIME_new();
        if (tmptm == ((void*)0)
                || X509_gmtime_adj(tmptm, 0) == ((void*)0)
        ...
        for (i = 0; i < sk_OPENSSL_PSTRING_num(db->db->data); i++) {
            pp = sk_OPENSSL_PSTRING_value(db->db->data, i);
            if (pp[0][0] == 'R') {
                if ((r = X509_REVOKED_new()) == ((void*)0))
                    goto end;
                j = make_revoked(r, pp[2]);
                if (!j)
                    goto end;
                if (j == 2)
                    crl_v2 = 1;
                if (!BN_hex2bn(&serial, pp[3]))
                    goto end;
                tmpser = BN_to_ASN1_INTEGER(serial, ((void*)0));
                BN_free(serial);
                serial = ((void*)0);
                if (!tmpser)
                    goto end;
        ...
        if (crl_ext != ((void*)0) || crlnumberfile != ((void*)0)) {
            X509V3_CTX crlctx;
            X509V3_set_ctx(&crlctx, x509, ((void*)0), ((void*)0), crl, 0);
            X509V3_set_nconf(&crlctx, conf);

            if (crl_ext != ((void*)0))
                if (!X509V3_EXT_CRL_add_nconf(conf, &crlctx, crl_ext, crl))
                    goto end;
            if (crlnumberfile != ((void*)0)) {
                tmpser = BN_to_ASN1_INTEGER(crlnumber, ((void*)0));
                if (!tmpser)
                    goto end;
                X509_CRL_add1_ext_i2d(crl, 88, tmpser, 0, 0);
                ASN1_INTEGER_free(tmpser);
                crl_v2 = 1;
        ...
        if (crlnumberfile != ((void*)0))
            if (!rand_ser
                    && !save_serial(crlnumberfile, "new", crlnumber, ((void*)0)))
                goto end;
    ...
    if (dorevoke) {
        if (infile == ((void*)0)) {
            ...
            X509 *revcert;
            revcert = load_cert(infile, (5 | 0x8000), infile);
            if (revcert == ((void*)0))
                goto end;
            if (dorevoke == 2)
                rev_type = REV_VALID;
    ...
    if (free_key)
        CRYPTO_free(key, "apps/ca.c", 1228);
    BN_free(serial);
    BN_free(crlnumber);
    free_index(db);
                   ...
                   int default_op, int ext_copy, int selfsign)
{
    ...
    if ((req = PEM_read_bio_X509_REQ(in, ((void*)0), ((void*)0), ((void*)0))) == ((void*)0)) {
        BIO_printf(bio_err, "Error reading certificate request in %s\n",
                   infile);
        goto end;
    }
    if (verbose)
        X509_REQ_print_ex(bio_err, req, nameopt, 0);
    ...
    if ((pktmp = X509_REQ_get0_pubkey(req)) == ((void*)0)) {
...
{
    X509 *req = ((void*)0);
    X509_REQ *rreq = ((void*)0);
    EVP_PKEY *pktmp = ((void*)0);
    int ok = -1, i;

    if ((req = load_cert(infile, (5 | 0x8000), infile)) == ((void*)0))
        goto end;
    if (verbose)
    ...
    if ((pktmp = X509_get0_pubkey(req)) == ((void*)0)) {
        BIO_printf(bio_err, "error unpacking public key\n");
        goto end;
    }
    ...
    if ((rreq = X509_to_X509_REQ(req, ((void*)0), ((void*)0))) == ((void*)0))
        goto end;
...
static int do_body(X509 **xret, EVP_PKEY *pkey, X509 *x509,
                   ...
                   int default_op, int ext_copy, int selfsign)
{
    X509_NAME *name = ((void*)0), *CAname = ((void*)0), *subject = ((void*)0);
    const ASN1_TIME *tm;
    ...
    OPENSSL_STRING *irow = ((void*)0);
    OPENSSL_STRING *rrow = ((void*)0);
    char buf[25];
    ...
    for (i = 0; i < X509_NAME_entry_count(name); i++) {
        ...
        if (nid == 48 && str->type != 22) {
            BIO_printf(bio_err,
                       "\nemailAddress type needs to be of type IA5STRING\n");
            goto end;
        }
        if (str->type != 30 && str->type != 12) {
    ...
    if ((subject = X509_NAME_new()) == ((void*)0)) {
        BIO_printf(bio_err, "Memory allocation failure\n");
        goto end;
    }
 ...
 again2:
                ...
                if (j < 0) {
                    BIO_printf(bio_err,
                               ...
                               cv->name,
                               ((str2 == ((void*)0)) ? "NULL" : (char *)str2->data),
                               ((str == ((void*)0)) ? "NULL" : (char *)str->data));
                    goto end;
                }
            } else {
                BIO_printf(bio_err,
    ...
    if (BN_to_ASN1_INTEGER(serial, X509_get_serialNumber(ret)) == ((void*)0))
        goto end;
    if (selfsign) {
    ...
    if (enddate != ((void*)0)) {
        ...
        ASN1_TIME_diff(&tdays, ((void*)0), ((void*)0), X509_get0_notAfter(ret));
        days = tdays;
    }
    ...
    if (ext_sect) {
        ...
        if (selfsign)
            X509V3_set_ctx(&ctx, ret, ret, req, ((void*)0), 0);
        else
            X509V3_set_ctx(&ctx, x509, ret, req, ((void*)0), 0);
    ...
    {
        const struct stack_st_X509_EXTENSION *exts = X509_get0_extensions(ret);

        if (exts != ((void*)0) && sk_X509_EXTENSION_num(exts) > 0)
    ...
    if (!email_dn) {
        ...
        if ((dn_subject = X509_NAME_dup(subject)) == ((void*)0)) {
            BIO_printf(bio_err, "Memory allocation failure\n");
            goto end;
        }
    ...
    row[5] = X509_NAME_oneline(X509_get_subject_name(ret), ((void*)0), 0);
    if (row[5] == ((void*)0)) {
        BIO_printf(bio_err, "Memory allocation failure\n");
        goto end;
    }
    ...
    if (BN_is_zero(serial))
        row[3] = CRYPTO_strdup("00", "apps/ca.c", 1724);
    else
        row[3] = BN_bn2hex(serial);
    if (row[3] == ((void*)0)) {
        BIO_printf(bio_err, "Memory allocation failure\n");
        goto end;
    }
    ...
    if (row[5][0] == '\0') {
        ...
        CRYPTO_free(row[5], "apps/ca.c", 1738);
        row[5] = CRYPTO_strdup(row[3], "apps/ca.c", 1739);
        if (row[5] == ((void*)0)) {
            BIO_printf(bio_err, "Memory allocation failure\n");
            goto end;
        }
    ...
    if (db->attributes.unique_subject) {
        ...
        rrow = TXT_DB_get_by_index(db->db, 5, crow);
        if (rrow != ((void*)0)) {
            BIO_printf(bio_err,
    ...
    row[0] = CRYPTO_strdup("V", "apps/ca.c", 1846);
    tm = X509_get0_notAfter(ret);
    row[1] = app_malloc(tm->length + 1, "row expdate");
    memcpy(row[1], tm->data, tm->length);
    row[1][tm->length] = '\0';
    row[2] = ((void*)0);
    row[4] = CRYPTO_strdup("unknown", "apps/ca.c", 1852);
    if ((row[0] == ((void*)0)) || (row[1] == ((void*)0)) ||
        (row[4] == ((void*)0)) || (row[5] == ((void*)0))) {
        BIO_printf(bio_err, "Memory allocation failure\n");
        goto end;
    }

    irow = app_malloc(sizeof(*irow) * (6 + 1), "row space");
    for (i = 0; i < 6; i++)
        irow[i] = row[i];
    irow[6] = ((void*)0);
    ...
    if (ok != 1) {
        for (i = 0; i < 6; i++)
            CRYPTO_free(row[i], "apps/ca.c", 1874);
    }
    CRYPTO_free(irow, "apps/ca.c", 1876);
...
static int certify_spkac(X509 **xret, const char *infile, EVP_PKEY *pkey,
                         ...
                         unsigned long nameopt, int default_op, int ext_copy)
{
    struct stack_st_CONF_VALUE *sk = ((void*)0);
    struct lhash_st_CONF_VALUE *parms = ((void*)0);
    X509_REQ *req = ((void*)0);
    CONF_VALUE *cv = ((void*)0);
    NETSCAPE_SPKI *spki = ((void*)0);
    char *type, *buf;
    EVP_PKEY *pktmp = ((void*)0);
    X509_NAME *n = ((void*)0);
    X509_NAME_ENTRY *ne = ((void*)0);
    int ok = -1, i, j;
    long errline;
    int nid;
    ...
    parms = CONF_load(((void*)0), infile, &errline);
    if (parms == ((void*)0)) {
...
# 1947 "apps/ca.c"
    ...
    if ((pktmp = NETSCAPE_SPKI_get_pubkey(spki)) == ((void*)0)) {
...
static int do_revoke(X509 *x509, CA_DB *db, REVINFO_TYPE rev_type,
                     const char *value)
{
    const ASN1_TIME *tm = ((void*)0);
    char *row[6], **rrow, **irow;
    char *rev_str = ((void*)0);
    BIGNUM *bn = ((void*)0);
    int ok = -1, i;
    ...
    for (i = 0; i < 6; i++)
        row[i] = ((void*)0);
    row[5] = X509_NAME_oneline(X509_get_subject_name(x509), ((void*)0), 0);
    bn = ASN1_INTEGER_to_BN(X509_get_serialNumber(x509), ((void*)0));
    if (!bn)
        goto end;
    if (BN_is_zero(bn))
        row[3] = CRYPTO_strdup("00", "apps/ca.c", 2055);
    else
        row[3] = BN_bn2hex(bn);
    BN_free(bn);
    if (row[5] != ((void*)0) && row[5][0] == '\0') {

        CRYPTO_free(row[5], "apps/ca.c", 2061);
        row[5] = CRYPTO_strdup(row[3], "apps/ca.c", 2062);
    }
    if ((row[5] == ((void*)0)) || (row[3] == ((void*)0))) {
        BIO_printf(bio_err, "Memory allocation failure\n");
        goto end;
    }
    ...
    if (rrow == ((void*)0)) {
        ...
        row[0] = CRYPTO_strdup("V", "apps/ca.c", 2079);
        tm = X509_get0_notAfter(x509);
        row[1] = app_malloc(tm->length + 1, "row exp_data");
        memcpy(row[1], tm->data, tm->length);
        row[1][tm->length] = '\0';
        row[2] = ((void*)0);
        row[4] = CRYPTO_strdup("unknown", "apps/ca.c", 2085);

        if (row[0] == ((void*)0) || row[4] == ((void*)0)) {
            BIO_printf(bio_err, "Memory allocation failure\n");
            goto end;
        }

        irow = app_malloc(sizeof(*irow) * (6 + 1), "row ptr");
        for (i = 0; i < 6; i++)
            irow[i] = row[i];
        irow[6] = ((void*)0);
        ...
        if (!TXT_DB_insert(db->db, irow)) {
            BIO_printf(bio_err, "failed to update database\n");
            BIO_printf(bio_err, "TXT_DB error number %ld\n", db->db->error);
            CRYPTO_free(irow, "apps/ca.c", 2100);
            goto end;
        }
    ...
    } else if (index_name_cmp((const OPENSSL_CSTRING *)((void*) (1 ? row : (OPENSSL_STRING*)0)), (const OPENSSL_CSTRING *)((void*) (1 ? rrow : (OPENSSL_STRING*)0)))) {
    ...
    for (i = 0; i < 6; i++)
        CRYPTO_free(row[i], "apps/ca.c", 2141);
    return ok;
}
...
static int get_certificate_status(const char *serial, CA_DB *db)
{
    ...
    row[3] = app_malloc(serial_len + 2, "row serial#");
    ...
    if (serial_len % 2) {
        ...
        memcpy(row[3] + 1, serial, serial_len);
        row[3][serial_len + 1] = '\0';
    } else {

        memcpy(row[3], serial, serial_len);
        row[3][serial_len] = '\0';
    }


    make_uppercase(row[3]);
    ...
    for (i = 0; i < 6; i++) {
        CRYPTO_free(row[i], "apps/ca.c", 2207);
    }
    return ok;
}
...
static int do_updatedb(CA_DB *db)
{
    ...
    ASN1_UTCTIME_free(a_tm);
    CRYPTO_free(a_tm_s, "apps/ca.c", 2269);
    return cnt;
}
...
static int make_revoked(X509_REVOKED *rev, const char *str)
{
    ...
    if (rev && (reason_code != -1)) {
        rtmp = ASN1_ENUMERATED_new();
        if (rtmp == ((void*)0) || !ASN1_ENUMERATED_set(rtmp, reason_code))
            goto end;
        if (!X509_REVOKED_add1_ext_i2d(rev, 141, rtmp, 0, 0))
            goto end;
    }

    if (rev && comp_time) {
        if (!X509_REVOKED_add1_ext_i2d
            (rev, 142, comp_time, 0, 0))
            goto end;
    }
    if (rev && hold) {
        if (!X509_REVOKED_add1_ext_i2d
    ...
    CRYPTO_free(tmp, "apps/ca.c", 2435);
                   ...
                   ASN1_GENERALIZEDTIME **pinvtm, const char *str)
{
    ...
    tmp = CRYPTO_strdup(str, "apps/ca.c", 2496);
    if (!tmp) {
        BIO_printf(bio_err, "memory allocation failure\n");
        goto end;
    }
    ...
    if (reason_str) {
        for (i = 0; i < (sizeof(crl_reasons)/sizeof((crl_reasons)[0])); i++) {
    ...
    CRYPTO_free(tmp, "apps/ca.c", 2590);
    ASN1_GENERALIZEDTIME_free(comp_time);
