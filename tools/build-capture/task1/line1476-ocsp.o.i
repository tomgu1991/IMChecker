...
static int add_ocsp_cert(OCSP_REQUEST **req, X509 *cert,
                         ...
                         struct stack_st_OCSP_CERTID *ids);
...
static void print_ocsp_summary(BIO *out, OCSP_BASICRESP *bs, OCSP_REQUEST *req,
                              struct stack_st_OPENSSL_STRING *names,
                              struct stack_st_OCSP_CERTID *ids, long nsec,
                              long maxage);
static void make_ocsp_response(BIO *err, OCSP_RESPONSE **resp, OCSP_REQUEST *req,
                              CA_DB *db, struct stack_st_X509 *ca, X509 *rcert,
                              EVP_PKEY *rkey, const EVP_MD *md,
                              struct stack_st_OPENSSL_STRING *sigopts,
                              struct stack_st_X509 *rother, unsigned long flags,
...
{
    BIO *acbio = ((void*)0), *cbio = ((void*)0), *derbio = ((void*)0), *out = ((void*)0);
    const EVP_MD *cert_id_md = ((void*)0), *rsign_md = ((void*)0);
    struct stack_st_OPENSSL_STRING *rsign_sigopts = ((void*)0);
    int trailing_md = 0;
    CA_DB *rdb = ((void*)0);
    EVP_PKEY *key = ((void*)0), *rkey = ((void*)0);
    OCSP_BASICRESP *bs = ((void*)0);
    OCSP_REQUEST *req = ((void*)0);
    OCSP_RESPONSE *resp = ((void*)0);
    struct stack_st_CONF_VALUE *headers = ((void*)0);
    struct stack_st_OCSP_CERTID *ids = ((void*)0);
    struct stack_st_OPENSSL_STRING *reqnames = ((void*)0);
    struct stack_st_X509 *sign_other = ((void*)0), *verify_other = ((void*)0), *rother = ((void*)0);
    struct stack_st_X509 *issuers = ((void*)0);
    X509 *issuer = ((void*)0), *cert = ((void*)0);
    struct stack_st_X509 *rca_cert = ((void*)0);
    X509 *signer = ((void*)0), *rsigner = ((void*)0);
    X509_STORE *store = ((void*)0);
    X509_VERIFY_PARAM *vpm = ((void*)0);
    const char *CAfile = ((void*)0), *CApath = ((void*)0);
    char *header, *value;
    char *host = ((void*)0), *port = ((void*)0), *path = "/", *outfile = ((void*)0);
    char *rca_filename = ((void*)0), *reqin = ((void*)0), *respin = ((void*)0);
    char *reqout = ((void*)0), *respout = ((void*)0), *ridx_filename = ((void*)0);
    char *rsignfile = ((void*)0), *rkeyfile = ((void*)0);
    char *sign_certfile = ((void*)0), *verify_certfile = ((void*)0), *rcertfile = ((void*)0);
    char *signfile = ((void*)0), *keyfile = ((void*)0);
    char *thost = ((void*)0), *tport = ((void*)0), *tpath = ((void*)0);
    int noCAfile = 0, noCApath = 0;
    int accept_count = -1, add_nonce = 1, noverify = 0, use_ssl = -1;
    int vpmtouched = 0, badsig = 0, i, ignore_err = 0, nmin = 0, ndays = -1;
    int req_text = 0, resp_text = 0, ret = 1;
    int req_timeout = -1;
    long nsec = (5 * 60), maxage = -1;
 ...
 opthelp:
        ...
        case OPT_TIMEOUT:
            ...
            break;
        case OPT_URL:
            CRYPTO_free(thost, "apps/ocsp.c", 269);
            CRYPTO_free(tport, "apps/ocsp.c", 270);
            CRYPTO_free(tpath, "apps/ocsp.c", 271);
            thost = tport = tpath = ((void*)0);
        ...
        case OPT_PATH:
            ...
            break;
        case OPT_ISSUER:
            issuer = load_cert(opt_arg(), (5 | 0x8000), "issuer certificate");
            if (issuer == ((void*)0))
                goto end;
            if (issuers == ((void*)0)) {
                if ((issuers = sk_X509_new_null()) == ((void*)0))
                    goto end;
            }
        ...
        case OPT_CERT:
            X509_free(cert);
            cert = load_cert(opt_arg(), (5 | 0x8000), "certificate");
            if (cert == ((void*)0))
                goto end;
            if (cert_id_md == ((void*)0))
                cert_id_md = EVP_sha1();
        ...
        case OPT_RMD:
            ...
            break;
        case OPT_RSIGOPT:
            if (rsign_sigopts == ((void*)0))
                rsign_sigopts = sk_OPENSSL_STRING_new_null();
            if (rsign_sigopts == ((void*)0) || !sk_OPENSSL_STRING_push(rsign_sigopts, opt_arg()))
                goto end;
            break;
        case OPT_HEADER:
            header = opt_arg();
    ...
    if (req == ((void*)0) && reqin == ((void*)0)
        && respin == ((void*)0) && !(port != ((void*)0) && ridx_filename != ((void*)0)))
        goto opthelp;

    out = bio_open_default(outfile, 'w', (1 | 0x8000));
    if (out == ((void*)0))
        goto end;

    if (req == ((void*)0) && (add_nonce != 2))
        add_nonce = 0;

    if (req == ((void*)0) && reqin != ((void*)0)) {
        derbio = bio_open_default(reqin, 'r', 4);
        if (derbio == ((void*)0))
            goto end;
        req = ((OCSP_REQUEST*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? OCSP_REQUEST_new : ((OCSP_REQUEST *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_OCSP_REQUEST : ((OCSP_REQUEST *(*)(OCSP_REQUEST **,const unsigned char **,long))0))), derbio, ((void**) (1 ? ((void*)0) : (OCSP_REQUEST**)0))));
        BIO_free(derbio);
        if (req == ((void*)0)) {
    ...
    if (rsignfile != ((void*)0)) {
        if (rkeyfile == ((void*)0))
            rkeyfile = rsignfile;
        rsigner = load_cert(rsignfile, (5 | 0x8000), "responder certificate");
        if (rsigner == ((void*)0)) {
            BIO_printf(bio_err, "Error loading responder certificate\n");
            goto end;
        }
        if (!load_certs(rca_filename, &rca_cert, (5 | 0x8000),
                        ((void*)0), "CA certificate"))
            goto end;
        if (rcertfile != ((void*)0)) {
            if (!load_certs(rcertfile, &rother, (5 | 0x8000), ((void*)0),
                            "responder other certificates"))
                goto end;
        }
        rkey = load_key(rkeyfile, (5 | 0x8000), 0, ((void*)0), ((void*)0),
                        "responder private key");
        if (rkey == ((void*)0))
            goto end;
    }

    if (ridx_filename != ((void*)0)
        && (rkey == ((void*)0) || rsigner == ((void*)0) || rca_cert == ((void*)0))) {
        BIO_printf(bio_err,
    ...
    if (ridx_filename != ((void*)0)) {
        rdb = load_index(ridx_filename, ((void*)0));
        if (rdb == ((void*)0) || index_index(rdb) <= 0) {
            ret = 1;
            goto end;
        }
    }
    ...
    if (multi && acbio != ((void*)0))
        spawn_loop();
    if (acbio != ((void*)0) && req_timeout > 0)
        signal(14, sock_timeout);


    if (acbio != ((void*)0))
        log_message(6, "waiting for OCSP client connections...");
...
redo_accept:
    ...
    if (acbio != ((void*)0)) {
        ...
        if (index_changed(rdb)) {
            CA_DB *newrdb = load_index(ridx_filename, ((void*)0));

            if (newrdb != ((void*)0) && index_index(newrdb) > 0) {
                free_index(rdb);
                rdb = newrdb;
            } else {
                free_index(newrdb);
                log_message(3, "error reloading updated index: %s",
                            ridx_filename);
            }
        }
    ...
    if (req == ((void*)0)
        && (signfile != ((void*)0) || reqout != ((void*)0)
            || host != ((void*)0) || add_nonce || ridx_filename != ((void*)0))) {
        BIO_printf(bio_err, "Need an OCSP request for this operation!\n");
        goto end;
    }

    if (req != ((void*)0) && add_nonce)
        OCSP_request_add1_nonce(req, ((void*)0), -1);

    if (signfile != ((void*)0)) {
        if (keyfile == ((void*)0))
            keyfile = signfile;
        signer = load_cert(signfile, (5 | 0x8000), "signer certificate");
        if (signer == ((void*)0)) {
            BIO_printf(bio_err, "Error loading signer certificate\n");
            goto end;
        }
        if (sign_certfile != ((void*)0)) {
            if (!load_certs(sign_certfile, &sign_other, (5 | 0x8000), ((void*)0),
                            "signer certificates"))
                goto end;
        }
        key = load_key(keyfile, (5 | 0x8000), 0, ((void*)0), ((void*)0),
                       "signer private key");
        if (key == ((void*)0))
            goto end;

        if (!OCSP_request_sign
            (req, signer, key, ((void*)0), sign_other, sign_flags)) {
            BIO_printf(bio_err, "Error signing OCSP request\n");
            goto end;
        }
    }

    if (req_text && req != ((void*)0))
        OCSP_REQUEST_print(out, req, 0);

    if (reqout != ((void*)0)) {
        derbio = bio_open_default(reqout, 'w', 4);
        if (derbio == ((void*)0))
            goto end;
        (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_OCSP_REQUEST : ((int (*)(OCSP_REQUEST *,unsigned char **))0))), derbio, ((void*) (1 ? req : (OCSP_REQUEST*)0))));
        BIO_free(derbio);
    }
    ...
    } else if (respin != ((void*)0)) {
        derbio = bio_open_default(respin, 'r', 4);
        if (derbio == ((void*)0))
            goto end;
 ...
 done_resp:
    ...
    if (respout != ((void*)0)) {
        derbio = bio_open_default(respout, 'w', 4);
        if (derbio == ((void*)0))
            goto end;
        (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_OCSP_RESPONSE : ((int (*)(OCSP_RESPONSE *,unsigned char **))0))), derbio, ((void*) (1 ? resp : (OCSP_RESPONSE*)0))));
        BIO_free(derbio);
    }
    ...
    if (verify_certfile != ((void*)0)) {
        if (!load_certs(verify_certfile, &verify_other, (5 | 0x8000), ((void*)0),
    ...
    if (!noverify) {
        if (req != ((void*)0) && ((i = OCSP_check_nonce(req, bs)) <= 0)) {
            if (i == -1)
        ...
        if (i <= 0 && issuers) {
            i = OCSP_basic_verify(bs, issuers, store, 0x200);
            if (i > 0)
                ERR_clear_error();
        }
        if (i <= 0) {
    ...
    CRYPTO_free(thost, "apps/ocsp.c", 800);
    CRYPTO_free(tport, "apps/ocsp.c", 801);
    CRYPTO_free(tpath, "apps/ocsp.c", 802);
...
static int index_changed(CA_DB *rdb)
{
    ...
    if (rdb != ((void*)0) && stat(rdb->dbfname, &sb) != -1) {
        if (rdb->dbst.st_mtim.tv_sec != sb.st_mtim.tv_sec
            || rdb->dbst.st_ctim.tv_sec != sb.st_ctim.tv_sec
            || rdb->dbst.st_ino != sb.st_ino
            || rdb->dbst.st_dev != sb.st_dev) {
            syslog(6, "index file changed, reloading");
            return 1;
        }
    }
    return 0;
...
static void spawn_loop(void)
{
    ...
    openlog(prog, 0x01, (3<<3));

    if (setpgid(0, 0)) {
        syslog(3, "fatal: error detaching from parent process group: %s",
    ...
    while (termsig == 0) {
        ...
        while (termsig == 0 && procs >= multi) {
            if ((fpid = waitpid(-1, &status, 0)) > 0) {
                ...
                if (i >= multi) {
                    syslog(3, "fatal: internal error: "
                           "no matching child slot for pid: %ld",
                           (long) fpid);
                    killall(1, kidpids);
                }
                if (status != 0) {
                    if (((((__extension__ (((union { __typeof(status) __in; int __i; }) { .__in = (status) }).__i))) & 0x7f) == 0))
                        syslog(4, "child process: %ld, exit status: %d",
                               (long)fpid, ((((__extension__ (((union { __typeof(status) __in; int __i; }) { .__in = (status) }).__i))) & 0xff00) >> 8));
                    else if ((((signed char) ((((__extension__ (((union { __typeof(status) __in; int __i; }) { .__in = (status) }).__i))) & 0x7f) + 1) >> 1) > 0))
                        syslog(4, "child process: %ld, term signal %d%s",
                               (long)fpid, (((__extension__ (((union { __typeof(status) __in; int __i; }) { .__in = (status) }).__i))) & 0x7f),

                               (((__extension__ (((union { __typeof(status) __in; int __i; }) { .__in = (status) }).__i))) & 0x80) ? " (core dumped)" :
                ...
                syslog(3, "fatal: waitpid(): %s", strerror((*__errno_location ())));
                killall(1, kidpids);
            }
        }
        if (termsig)
        ...
        case 0:
            ...
            if (termsig)
                _exit(0);
            if (RAND_poll() <= 0) {
                syslog(3, "fatal: RAND_poll() failed");
                _exit(1);
            }
            return;
        default:
            ...
            if (i >= multi) {
                syslog(3, "fatal: internal error: no free child slots");
                killall(1, kidpids);
            }
            break;
        }
    ...
    syslog(6, "terminating on signal: %d", termsig);
    killall(0, kidpids);
}
                         ...
                         struct stack_st_OCSP_CERTID *ids)
{
    ...
    if (id == ((void*)0) || !sk_OCSP_CERTID_push(ids, id))
        goto err;
                           ...
                           struct stack_st_OCSP_CERTID *ids)
{
    ...
    sno = s2i_ASN1_INTEGER(((void*)0), serial);
    if (sno == ((void*)0)) {
                              ...
                              long maxage)
{
    ...
    if (bs == ((void*)0) || req == ((void*)0) || !sk_OPENSSL_STRING_num(names)
...
static void make_ocsp_response(BIO *err, OCSP_RESPONSE **resp, OCSP_REQUEST *req,
                              ...
                              int nmin, int ndays, int badsig)
{
    ASN1_TIME *thisupd = ((void*)0), *nextupd = ((void*)0);
    OCSP_CERTID *cid;
    OCSP_BASICRESP *bs = ((void*)0);
    int i, id_count;
    ...
    if (id_count <= 0) {
        *resp =
            OCSP_response_create(1, ((void*)0));
        goto end;
    }

    bs = OCSP_BASICRESP_new();
    thisupd = X509_gmtime_adj(((void*)0), 0);
    if (ndays != -1)
        nextupd = X509_time_adj_ex(((void*)0), ndays, nmin * 60, ((void*)0));
    ...
    for (i = 0; i < id_count; i++) {
        ...
        OCSP_id_get0_info(((void*)0), &cert_id_md_oid, ((void*)0), ((void*)0), cid);

        cert_id_md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(cert_id_md_oid)));
        if (cert_id_md == ((void*)0)) {
            *resp = OCSP_response_create(2,
                                         ((void*)0));
            goto end;
        }
        for (jj = 0; jj < sk_X509_num(ca) && !found; jj++) {
            X509 *ca_cert = sk_X509_value(ca, jj);
            OCSP_CERTID *ca_id = OCSP_cert_to_id(cert_id_md, ((void*)0), ca_cert);
        ...
        OCSP_id_get0_info(((void*)0), ((void*)0), ((void*)0), &serial, cid);
        ...
        if (inf == ((void*)0)) {
            ...
            ASN1_OBJECT *inst = ((void*)0);
            ASN1_TIME *revtm = ((void*)0);
            ASN1_GENERALIZEDTIME *invtm = ((void*)0);
            OCSP_SINGLERESP *single;
            int reason = -1;
            unpack_revinfo(&revtm, &reason, &inst, &invtm, inf[2]);
            single = OCSP_basic_add1_status(bs, cid,
                                            1,
                                            reason, revtm, thisupd, nextupd);
            if (invtm != ((void*)0))
                OCSP_SINGLERESP_add1_ext_i2d(single, 142,
                                             invtm, 0, 0);
            else if (inst != ((void*)0))
    ...
    mctx = EVP_MD_CTX_new();
    if ( mctx == ((void*)0) || !EVP_DigestSignInit(mctx, &pkctx, rmd, ((void*)0), rkey)) {
        *resp = OCSP_response_create(2, ((void*)0));
        goto end;
    }
    ...
    *resp = OCSP_response_create(0, bs);
...
static char **lookup_serial(CA_DB *db, ASN1_INTEGER *ser)
{
    int i;
    BIGNUM *bn = ((void*)0);
    char *itmp, *row[6], **rrow;
    for (i = 0; i < 6; i++)
        row[i] = ((void*)0);
    bn = ASN1_INTEGER_to_BN(ser, ((void*)0));
    (void)((bn) ? 0 : (OPENSSL_die("assertion failed: " "bn", "apps/ocsp.c", 1242), 1));

    if (BN_is_zero(bn))
        itmp = CRYPTO_strdup("00", "apps/ocsp.c", 1245);
    else
        itmp = BN_bn2hex(bn);
    row[3] = itmp;
    BN_free(bn);
    rrow = TXT_DB_get_by_index(db->db, 3, row);
    CRYPTO_free(itmp, "apps/ocsp.c", 1251);
    return rrow;
}
...
static BIO *init_responder(const char *port)
{
    ...
    if (acbio == ((void*)0)
        || BIO_ctrl(acbio,131,0x01,((void*)0)) < 0
        || BIO_ctrl(acbio,118,1, (char *)(port)) < 0) {
        log_message(3, "Error setting up accept BIO");
        goto err;
    }

    BIO_ctrl(acbio,118,3, (char *)(bufbio));
    bufbio = ((void*)0);
    if (BIO_ctrl(acbio,101,0,((void*)0)) <= 0) {
        log_message(3, "Error starting accept");
        goto err;
    }
...
static int urldecode(char *p)
{
    ...
    for (; *p; p++) {
        if (*p != '%')
            *out++ = *p;
        else if (((*__ctype_b_loc ())[(int) ((((unsigned char)(p[1]))))] & (unsigned short int) _ISxdigit) && ((*__ctype_b_loc ())[(int) ((((unsigned char)(p[2]))))] & (unsigned short int) _ISxdigit)) {
                        ...
                        int timeout)
{
    ...
    *preq = ((void*)0);
    ...
    cbio = BIO_pop(acbio);
    *pcbio = cbio;
    client = ((const char *)BIO_ptr_ctrl(cbio,124,2));


    if (timeout > 0) {
        (void) BIO_ctrl(cbio,105,0,(char *)(&acfd));
        alarm(timeout);
    }
    ...
    if (strncmp(reqbuf, "GET ", 4) == 0) {
        ...
        for (p = reqbuf + 4; *p == ' '; ++p)
            continue;
        if (*p != '/') {
            log_message(6, "Invalid request -- bad URL: %s", client);
            goto out;
        }
        p++;
        ...
        *q = '\0';
        ...
        if ((getbio = BIO_new_mem_buf(p, len)) == ((void*)0)
            ...
            log_message(3, "Could not allocate base64 bio: %s", client);
            goto out;
        }
        BIO_set_flags(b64, 0x100);
        getbio = BIO_push(b64, getbio);
    } else if (strncmp(reqbuf, "POST ", 5) != 0) {
        log_message(6, "Invalid request -- bad HTTP verb: %s", client);
        goto out;
    }
    ...
    if (getbio != ((void*)0)) {
        req = ((OCSP_REQUEST*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? OCSP_REQUEST_new : ((OCSP_REQUEST *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_OCSP_REQUEST : ((OCSP_REQUEST *(*)(OCSP_REQUEST **,const unsigned char **,long))0))), getbio, ((void**) (1 ? ((void*)0) : (OCSP_REQUEST**)0))));
        BIO_free_all(getbio);
    } else {
        req = ((OCSP_REQUEST*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? OCSP_REQUEST_new : ((OCSP_REQUEST *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_OCSP_REQUEST : ((OCSP_REQUEST *(*)(OCSP_REQUEST **,const unsigned char **,long))0))), cbio, ((void**) (1 ? ((void*)0) : (OCSP_REQUEST**)0))));
    }

    if (req == ((void*)0))
        log_message(3, "Error parsing OCSP request");
...
static int send_ocsp_response(BIO *cbio, OCSP_RESPONSE *resp)
{
    ...
    (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_OCSP_RESPONSE : ((int (*)(OCSP_RESPONSE *,unsigned char **))0))), cbio, ((void*) (1 ? resp : (OCSP_RESPONSE*)0))));
    (void)(int)BIO_ctrl(cbio,11,0,((void*)0));
    return 1;
}
                                      ...
                                      OCSP_REQUEST *req, int req_timeout)
{
    ...
    int i;
    int add_host = 1;
    OCSP_REQ_CTX *ctx = ((void*)0);
    OCSP_RESPONSE *rsp = ((void*)0);
    fd_set confds;
    struct timeval tv;

    if (req_timeout != -1)
        BIO_ctrl(cbio,102,(1),((void*)0));

    rv = BIO_ctrl(cbio,101,0,((void*)0));

    if ((rv <= 0) && ((req_timeout == -1) || !BIO_test_flags(cbio, 0x08))) {
        BIO_puts(bio_err, "Error connecting BIO\n");
        return ((void*)0);
    }

    if (BIO_ctrl(cbio,105,0,(char *)(&fd)) < 0) {
        BIO_puts(bio_err, "Can't get connection fd\n");
        goto err;
    }

    if (req_timeout != -1 && rv <= 0) {
        do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&confds)->__fds_bits)[0]) : "memory"); } while (0);
        ((void) (((&confds)->__fds_bits)[((fd) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) (1UL << ((fd) % (8 * (int) sizeof (__fd_mask)))))));
        tv.tv_usec = 0;
        tv.tv_sec = req_timeout;
        rv = select(fd + 1, ((void*)0), (void *)&confds, ((void*)0), &tv);
        if (rv == 0) {
    ...
    ctx = OCSP_sendreq_new(cbio, path, ((void*)0), -1);
    if (ctx == ((void*)0))
        return ((void*)0);
    ...
    for (;;) {
        ...
        tv.tv_usec = 0;
        tv.tv_sec = req_timeout;
        if (BIO_test_flags(cbio, 0x01)) {
            rv = select(fd + 1, (void *)&confds, ((void*)0), ((void*)0), &tv);
        } else if (BIO_test_flags(cbio, 0x02)) {
            rv = select(fd + 1, ((void*)0), (void *)&confds, ((void*)0), &tv);
        } else {
                                 ...
                                 int req_timeout)
{
    ...
    if (use_ssl == 1) {
        ...
        SSL_CTX_ctrl((ctx),33,(0x00000004U),((void*)0));
