...
# 1 "include/openssl/cms.h" 1
# 13 "include/openssl/cms.h"
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/cms.h" 2




# 1 "include/openssl/cmserr.h" 1
# 14 "include/openssl/cmserr.h"
# 1 "include/openssl/opensslconf.h" 1
# 15 "include/openssl/cmserr.h" 2
...
struct stack_st_CMS_SignerInfo; typedef int (*sk_CMS_SignerInfo_compfunc)(const CMS_SignerInfo * const *a, const CMS_SignerInfo *const *b); typedef void (*sk_CMS_SignerInfo_freefunc)(CMS_SignerInfo *a); typedef CMS_SignerInfo * (*sk_CMS_SignerInfo_copyfunc)(const CMS_SignerInfo *a); static inline int sk_CMS_SignerInfo_num(const struct stack_st_CMS_SignerInfo *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static inline CMS_SignerInfo *sk_CMS_SignerInfo_value(const struct stack_st_CMS_SignerInfo *sk, int idx) { return (CMS_SignerInfo *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static inline struct stack_st_CMS_SignerInfo *sk_CMS_SignerInfo_new(sk_CMS_SignerInfo_compfunc compare) { return (struct stack_st_CMS_SignerInfo *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static inline struct stack_st_CMS_SignerInfo *sk_CMS_SignerInfo_new_null(void) { return (struct stack_st_CMS_SignerInfo *)OPENSSL_sk_new_null(); } static inline struct stack_st_CMS_SignerInfo *sk_CMS_SignerInfo_new_reserve(sk_CMS_SignerInfo_compfunc compare, int n) { return (struct stack_st_CMS_SignerInfo *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static inline int sk_CMS_SignerInfo_reserve(struct stack_st_CMS_SignerInfo *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static inline void sk_CMS_SignerInfo_free(struct stack_st_CMS_SignerInfo *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static inline void sk_CMS_SignerInfo_zero(struct stack_st_CMS_SignerInfo *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static inline CMS_SignerInfo *sk_CMS_SignerInfo_delete(struct stack_st_CMS_SignerInfo *sk, int i) { return (CMS_SignerInfo *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static inline CMS_SignerInfo *sk_CMS_SignerInfo_delete_ptr(struct stack_st_CMS_SignerInfo *sk, CMS_SignerInfo *ptr) { return (CMS_SignerInfo *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_SignerInfo_push(struct stack_st_CMS_SignerInfo *sk, CMS_SignerInfo *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_SignerInfo_unshift(struct stack_st_CMS_SignerInfo *sk, CMS_SignerInfo *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static inline CMS_SignerInfo *sk_CMS_SignerInfo_pop(struct stack_st_CMS_SignerInfo *sk) { return (CMS_SignerInfo *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static inline CMS_SignerInfo *sk_CMS_SignerInfo_shift(struct stack_st_CMS_SignerInfo *sk) { return (CMS_SignerInfo *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static inline void sk_CMS_SignerInfo_pop_free(struct stack_st_CMS_SignerInfo *sk, sk_CMS_SignerInfo_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static inline int sk_CMS_SignerInfo_insert(struct stack_st_CMS_SignerInfo *sk, CMS_SignerInfo *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static inline CMS_SignerInfo *sk_CMS_SignerInfo_set(struct stack_st_CMS_SignerInfo *sk, int idx, CMS_SignerInfo *ptr) { return (CMS_SignerInfo *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static inline int sk_CMS_SignerInfo_find(struct stack_st_CMS_SignerInfo *sk, CMS_SignerInfo *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_SignerInfo_find_ex(struct stack_st_CMS_SignerInfo *sk, CMS_SignerInfo *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static inline void sk_CMS_SignerInfo_sort(struct stack_st_CMS_SignerInfo *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static inline int sk_CMS_SignerInfo_is_sorted(const struct stack_st_CMS_SignerInfo *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static inline struct stack_st_CMS_SignerInfo * sk_CMS_SignerInfo_dup(const struct stack_st_CMS_SignerInfo *sk) { return (struct stack_st_CMS_SignerInfo *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static inline struct stack_st_CMS_SignerInfo *sk_CMS_SignerInfo_deep_copy(const struct stack_st_CMS_SignerInfo *sk, sk_CMS_SignerInfo_copyfunc copyfunc, sk_CMS_SignerInfo_freefunc freefunc) { return (struct stack_st_CMS_SignerInfo *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static inline sk_CMS_SignerInfo_compfunc sk_CMS_SignerInfo_set_cmp_func(struct stack_st_CMS_SignerInfo *sk, sk_CMS_SignerInfo_compfunc compare) { return (sk_CMS_SignerInfo_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
struct stack_st_CMS_RecipientEncryptedKey; typedef int (*sk_CMS_RecipientEncryptedKey_compfunc)(const CMS_RecipientEncryptedKey * const *a, const CMS_RecipientEncryptedKey *const *b); typedef void (*sk_CMS_RecipientEncryptedKey_freefunc)(CMS_RecipientEncryptedKey *a); typedef CMS_RecipientEncryptedKey * (*sk_CMS_RecipientEncryptedKey_copyfunc)(const CMS_RecipientEncryptedKey *a); static inline int sk_CMS_RecipientEncryptedKey_num(const struct stack_st_CMS_RecipientEncryptedKey *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static inline CMS_RecipientEncryptedKey *sk_CMS_RecipientEncryptedKey_value(const struct stack_st_CMS_RecipientEncryptedKey *sk, int idx) { return (CMS_RecipientEncryptedKey *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static inline struct stack_st_CMS_RecipientEncryptedKey *sk_CMS_RecipientEncryptedKey_new(sk_CMS_RecipientEncryptedKey_compfunc compare) { return (struct stack_st_CMS_RecipientEncryptedKey *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static inline struct stack_st_CMS_RecipientEncryptedKey *sk_CMS_RecipientEncryptedKey_new_null(void) { return (struct stack_st_CMS_RecipientEncryptedKey *)OPENSSL_sk_new_null(); } static inline struct stack_st_CMS_RecipientEncryptedKey *sk_CMS_RecipientEncryptedKey_new_reserve(sk_CMS_RecipientEncryptedKey_compfunc compare, int n) { return (struct stack_st_CMS_RecipientEncryptedKey *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static inline int sk_CMS_RecipientEncryptedKey_reserve(struct stack_st_CMS_RecipientEncryptedKey *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static inline void sk_CMS_RecipientEncryptedKey_free(struct stack_st_CMS_RecipientEncryptedKey *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static inline void sk_CMS_RecipientEncryptedKey_zero(struct stack_st_CMS_RecipientEncryptedKey *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static inline CMS_RecipientEncryptedKey *sk_CMS_RecipientEncryptedKey_delete(struct stack_st_CMS_RecipientEncryptedKey *sk, int i) { return (CMS_RecipientEncryptedKey *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static inline CMS_RecipientEncryptedKey *sk_CMS_RecipientEncryptedKey_delete_ptr(struct stack_st_CMS_RecipientEncryptedKey *sk, CMS_RecipientEncryptedKey *ptr) { return (CMS_RecipientEncryptedKey *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_RecipientEncryptedKey_push(struct stack_st_CMS_RecipientEncryptedKey *sk, CMS_RecipientEncryptedKey *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_RecipientEncryptedKey_unshift(struct stack_st_CMS_RecipientEncryptedKey *sk, CMS_RecipientEncryptedKey *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static inline CMS_RecipientEncryptedKey *sk_CMS_RecipientEncryptedKey_pop(struct stack_st_CMS_RecipientEncryptedKey *sk) { return (CMS_RecipientEncryptedKey *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static inline CMS_RecipientEncryptedKey *sk_CMS_RecipientEncryptedKey_shift(struct stack_st_CMS_RecipientEncryptedKey *sk) { return (CMS_RecipientEncryptedKey *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static inline void sk_CMS_RecipientEncryptedKey_pop_free(struct stack_st_CMS_RecipientEncryptedKey *sk, sk_CMS_RecipientEncryptedKey_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static inline int sk_CMS_RecipientEncryptedKey_insert(struct stack_st_CMS_RecipientEncryptedKey *sk, CMS_RecipientEncryptedKey *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static inline CMS_RecipientEncryptedKey *sk_CMS_RecipientEncryptedKey_set(struct stack_st_CMS_RecipientEncryptedKey *sk, int idx, CMS_RecipientEncryptedKey *ptr) { return (CMS_RecipientEncryptedKey *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static inline int sk_CMS_RecipientEncryptedKey_find(struct stack_st_CMS_RecipientEncryptedKey *sk, CMS_RecipientEncryptedKey *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_RecipientEncryptedKey_find_ex(struct stack_st_CMS_RecipientEncryptedKey *sk, CMS_RecipientEncryptedKey *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static inline void sk_CMS_RecipientEncryptedKey_sort(struct stack_st_CMS_RecipientEncryptedKey *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static inline int sk_CMS_RecipientEncryptedKey_is_sorted(const struct stack_st_CMS_RecipientEncryptedKey *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static inline struct stack_st_CMS_RecipientEncryptedKey * sk_CMS_RecipientEncryptedKey_dup(const struct stack_st_CMS_RecipientEncryptedKey *sk) { return (struct stack_st_CMS_RecipientEncryptedKey *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static inline struct stack_st_CMS_RecipientEncryptedKey *sk_CMS_RecipientEncryptedKey_deep_copy(const struct stack_st_CMS_RecipientEncryptedKey *sk, sk_CMS_RecipientEncryptedKey_copyfunc copyfunc, sk_CMS_RecipientEncryptedKey_freefunc freefunc) { return (struct stack_st_CMS_RecipientEncryptedKey *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static inline sk_CMS_RecipientEncryptedKey_compfunc sk_CMS_RecipientEncryptedKey_set_cmp_func(struct stack_st_CMS_RecipientEncryptedKey *sk, sk_CMS_RecipientEncryptedKey_compfunc compare) { return (sk_CMS_RecipientEncryptedKey_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
struct stack_st_CMS_RecipientInfo; typedef int (*sk_CMS_RecipientInfo_compfunc)(const CMS_RecipientInfo * const *a, const CMS_RecipientInfo *const *b); typedef void (*sk_CMS_RecipientInfo_freefunc)(CMS_RecipientInfo *a); typedef CMS_RecipientInfo * (*sk_CMS_RecipientInfo_copyfunc)(const CMS_RecipientInfo *a); static inline int sk_CMS_RecipientInfo_num(const struct stack_st_CMS_RecipientInfo *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static inline CMS_RecipientInfo *sk_CMS_RecipientInfo_value(const struct stack_st_CMS_RecipientInfo *sk, int idx) { return (CMS_RecipientInfo *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static inline struct stack_st_CMS_RecipientInfo *sk_CMS_RecipientInfo_new(sk_CMS_RecipientInfo_compfunc compare) { return (struct stack_st_CMS_RecipientInfo *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static inline struct stack_st_CMS_RecipientInfo *sk_CMS_RecipientInfo_new_null(void) { return (struct stack_st_CMS_RecipientInfo *)OPENSSL_sk_new_null(); } static inline struct stack_st_CMS_RecipientInfo *sk_CMS_RecipientInfo_new_reserve(sk_CMS_RecipientInfo_compfunc compare, int n) { return (struct stack_st_CMS_RecipientInfo *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static inline int sk_CMS_RecipientInfo_reserve(struct stack_st_CMS_RecipientInfo *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static inline void sk_CMS_RecipientInfo_free(struct stack_st_CMS_RecipientInfo *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static inline void sk_CMS_RecipientInfo_zero(struct stack_st_CMS_RecipientInfo *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static inline CMS_RecipientInfo *sk_CMS_RecipientInfo_delete(struct stack_st_CMS_RecipientInfo *sk, int i) { return (CMS_RecipientInfo *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static inline CMS_RecipientInfo *sk_CMS_RecipientInfo_delete_ptr(struct stack_st_CMS_RecipientInfo *sk, CMS_RecipientInfo *ptr) { return (CMS_RecipientInfo *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_RecipientInfo_push(struct stack_st_CMS_RecipientInfo *sk, CMS_RecipientInfo *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_RecipientInfo_unshift(struct stack_st_CMS_RecipientInfo *sk, CMS_RecipientInfo *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static inline CMS_RecipientInfo *sk_CMS_RecipientInfo_pop(struct stack_st_CMS_RecipientInfo *sk) { return (CMS_RecipientInfo *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static inline CMS_RecipientInfo *sk_CMS_RecipientInfo_shift(struct stack_st_CMS_RecipientInfo *sk) { return (CMS_RecipientInfo *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static inline void sk_CMS_RecipientInfo_pop_free(struct stack_st_CMS_RecipientInfo *sk, sk_CMS_RecipientInfo_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static inline int sk_CMS_RecipientInfo_insert(struct stack_st_CMS_RecipientInfo *sk, CMS_RecipientInfo *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static inline CMS_RecipientInfo *sk_CMS_RecipientInfo_set(struct stack_st_CMS_RecipientInfo *sk, int idx, CMS_RecipientInfo *ptr) { return (CMS_RecipientInfo *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static inline int sk_CMS_RecipientInfo_find(struct stack_st_CMS_RecipientInfo *sk, CMS_RecipientInfo *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_RecipientInfo_find_ex(struct stack_st_CMS_RecipientInfo *sk, CMS_RecipientInfo *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static inline void sk_CMS_RecipientInfo_sort(struct stack_st_CMS_RecipientInfo *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static inline int sk_CMS_RecipientInfo_is_sorted(const struct stack_st_CMS_RecipientInfo *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static inline struct stack_st_CMS_RecipientInfo * sk_CMS_RecipientInfo_dup(const struct stack_st_CMS_RecipientInfo *sk) { return (struct stack_st_CMS_RecipientInfo *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static inline struct stack_st_CMS_RecipientInfo *sk_CMS_RecipientInfo_deep_copy(const struct stack_st_CMS_RecipientInfo *sk, sk_CMS_RecipientInfo_copyfunc copyfunc, sk_CMS_RecipientInfo_freefunc freefunc) { return (struct stack_st_CMS_RecipientInfo *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static inline sk_CMS_RecipientInfo_compfunc sk_CMS_RecipientInfo_set_cmp_func(struct stack_st_CMS_RecipientInfo *sk, sk_CMS_RecipientInfo_compfunc compare) { return (sk_CMS_RecipientInfo_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
struct stack_st_CMS_RevocationInfoChoice; typedef int (*sk_CMS_RevocationInfoChoice_compfunc)(const CMS_RevocationInfoChoice * const *a, const CMS_RevocationInfoChoice *const *b); typedef void (*sk_CMS_RevocationInfoChoice_freefunc)(CMS_RevocationInfoChoice *a); typedef CMS_RevocationInfoChoice * (*sk_CMS_RevocationInfoChoice_copyfunc)(const CMS_RevocationInfoChoice *a); static inline int sk_CMS_RevocationInfoChoice_num(const struct stack_st_CMS_RevocationInfoChoice *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static inline CMS_RevocationInfoChoice *sk_CMS_RevocationInfoChoice_value(const struct stack_st_CMS_RevocationInfoChoice *sk, int idx) { return (CMS_RevocationInfoChoice *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static inline struct stack_st_CMS_RevocationInfoChoice *sk_CMS_RevocationInfoChoice_new(sk_CMS_RevocationInfoChoice_compfunc compare) { return (struct stack_st_CMS_RevocationInfoChoice *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static inline struct stack_st_CMS_RevocationInfoChoice *sk_CMS_RevocationInfoChoice_new_null(void) { return (struct stack_st_CMS_RevocationInfoChoice *)OPENSSL_sk_new_null(); } static inline struct stack_st_CMS_RevocationInfoChoice *sk_CMS_RevocationInfoChoice_new_reserve(sk_CMS_RevocationInfoChoice_compfunc compare, int n) { return (struct stack_st_CMS_RevocationInfoChoice *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static inline int sk_CMS_RevocationInfoChoice_reserve(struct stack_st_CMS_RevocationInfoChoice *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static inline void sk_CMS_RevocationInfoChoice_free(struct stack_st_CMS_RevocationInfoChoice *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static inline void sk_CMS_RevocationInfoChoice_zero(struct stack_st_CMS_RevocationInfoChoice *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static inline CMS_RevocationInfoChoice *sk_CMS_RevocationInfoChoice_delete(struct stack_st_CMS_RevocationInfoChoice *sk, int i) { return (CMS_RevocationInfoChoice *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static inline CMS_RevocationInfoChoice *sk_CMS_RevocationInfoChoice_delete_ptr(struct stack_st_CMS_RevocationInfoChoice *sk, CMS_RevocationInfoChoice *ptr) { return (CMS_RevocationInfoChoice *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_RevocationInfoChoice_push(struct stack_st_CMS_RevocationInfoChoice *sk, CMS_RevocationInfoChoice *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_RevocationInfoChoice_unshift(struct stack_st_CMS_RevocationInfoChoice *sk, CMS_RevocationInfoChoice *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static inline CMS_RevocationInfoChoice *sk_CMS_RevocationInfoChoice_pop(struct stack_st_CMS_RevocationInfoChoice *sk) { return (CMS_RevocationInfoChoice *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static inline CMS_RevocationInfoChoice *sk_CMS_RevocationInfoChoice_shift(struct stack_st_CMS_RevocationInfoChoice *sk) { return (CMS_RevocationInfoChoice *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static inline void sk_CMS_RevocationInfoChoice_pop_free(struct stack_st_CMS_RevocationInfoChoice *sk, sk_CMS_RevocationInfoChoice_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static inline int sk_CMS_RevocationInfoChoice_insert(struct stack_st_CMS_RevocationInfoChoice *sk, CMS_RevocationInfoChoice *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static inline CMS_RevocationInfoChoice *sk_CMS_RevocationInfoChoice_set(struct stack_st_CMS_RevocationInfoChoice *sk, int idx, CMS_RevocationInfoChoice *ptr) { return (CMS_RevocationInfoChoice *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static inline int sk_CMS_RevocationInfoChoice_find(struct stack_st_CMS_RevocationInfoChoice *sk, CMS_RevocationInfoChoice *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_CMS_RevocationInfoChoice_find_ex(struct stack_st_CMS_RevocationInfoChoice *sk, CMS_RevocationInfoChoice *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static inline void sk_CMS_RevocationInfoChoice_sort(struct stack_st_CMS_RevocationInfoChoice *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static inline int sk_CMS_RevocationInfoChoice_is_sorted(const struct stack_st_CMS_RevocationInfoChoice *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static inline struct stack_st_CMS_RevocationInfoChoice * sk_CMS_RevocationInfoChoice_dup(const struct stack_st_CMS_RevocationInfoChoice *sk) { return (struct stack_st_CMS_RevocationInfoChoice *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static inline struct stack_st_CMS_RevocationInfoChoice *sk_CMS_RevocationInfoChoice_deep_copy(const struct stack_st_CMS_RevocationInfoChoice *sk, sk_CMS_RevocationInfoChoice_copyfunc copyfunc, sk_CMS_RevocationInfoChoice_freefunc freefunc) { return (struct stack_st_CMS_RevocationInfoChoice *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static inline sk_CMS_RevocationInfoChoice_compfunc sk_CMS_RevocationInfoChoice_set_cmp_func(struct stack_st_CMS_RevocationInfoChoice *sk, sk_CMS_RevocationInfoChoice_compfunc compare) { return (sk_CMS_RevocationInfoChoice_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
static int save_certs(char *signerfile, struct stack_st_X509 *signers);
static int cms_cb(int ok, X509_STORE_CTX *ctx);
static void receipt_request_print(CMS_ContentInfo *cms);
static CMS_ReceiptRequest *make_receipt_request(struct stack_st_OPENSSL_STRING
                                                *rr_to, int rr_allorfirst, struct stack_st_OPENSSL_STRING
                                                *rr_from);
static int cms_set_pkey_param(EVP_PKEY_CTX *pctx,
                              struct stack_st_OPENSSL_STRING *param);
# 55 "apps/cms.c"
...
{
    ASN1_OBJECT *econtent_type = ((void*)0);
    BIO *in = ((void*)0), *out = ((void*)0), *indata = ((void*)0), *rctin = ((void*)0);
    CMS_ContentInfo *cms = ((void*)0), *rcms = ((void*)0);
    CMS_ReceiptRequest *rr = ((void*)0);
    ENGINE *e = ((void*)0);
    EVP_PKEY *key = ((void*)0);
    const EVP_CIPHER *cipher = ((void*)0), *wrap_cipher = ((void*)0);
    const EVP_MD *sign_md = ((void*)0);
    struct stack_st_OPENSSL_STRING *rr_to = ((void*)0), *rr_from = ((void*)0);
    struct stack_st_OPENSSL_STRING *sksigners = ((void*)0), *skkeys = ((void*)0);
    struct stack_st_X509 *encerts = ((void*)0), *other = ((void*)0);
    X509 *cert = ((void*)0), *recip = ((void*)0), *signer = ((void*)0);
    X509_STORE *store = ((void*)0);
    X509_VERIFY_PARAM *vpm = ((void*)0);
    char *certfile = ((void*)0), *keyfile = ((void*)0), *contfile = ((void*)0);
    const char *CAfile = ((void*)0), *CApath = ((void*)0);
    char *certsoutfile = ((void*)0);
    int noCAfile = 0, noCApath = 0;
    char *infile = ((void*)0), *outfile = ((void*)0), *rctfile = ((void*)0);
    char *passinarg = ((void*)0), *passin = ((void*)0), *signerfile = ((void*)0), *recipfile = ((void*)0);
    char *to = ((void*)0), *from = ((void*)0), *subject = ((void*)0), *prog;
    cms_key_param *key_first = ((void*)0), *key_param = ((void*)0);
    int flags = 0x40, noout = 0, print = 0, keyidx = -1, vpmtouched = 0;
    int informat = (7 | 0x8000), outformat = (7 | 0x8000);
    int operation = 0, ret = 1, rr_print = 0, rr_allorfirst = -1;
    int verify_retcode = 0, rctformat = (7 | 0x8000), keyform = (5 | 0x8000);
    size_t secret_keylen = 0, secret_keyidlen = 0;
    unsigned char *pwri_pass = ((void*)0), *pwri_tmp = ((void*)0);
    unsigned char *secret_key = ((void*)0), *secret_keyid = ((void*)0);
    long ltmp;
    const char *mime_eol = "\n";
    OPTION_CHOICE o;
 ...
 opthelp:
        ...
        case OPT_HELP:
            ...
            goto end;
        case OPT_INFORM:
            if (!opt_format(opt_arg(), ((1L << 1) | (1L << 3)), &informat))
                goto opthelp;
            break;
        case OPT_OUTFORM:
            if (!opt_format(opt_arg(), ((1L << 1) | (1L << 3)), &outformat))
                goto opthelp;
            break;
        case OPT_OUT:
            outfile = opt_arg();
        ...
        case OPT_DECRYPT:
            ...
            break;
        case OPT_SIGN:
            operation = (3 | 0x10 | 0x40);
            break;
        case OPT_SIGN_RECEIPT:
            operation = (15 | 0x20 | 0x10);
            break;
        case OPT_RESIGN:
            operation = (6 | 0x20 | 0x10 | 0x40);
            break;
        case OPT_VERIFY:
            operation = (4 | 0x20);
            break;
        ...
        case OPT_RR_FIRST:
            ...
            break;
        case OPT_RCTFORM:
            if (rctformat == (7 | 0x8000))
                rcms = SMIME_read_CMS(rctin, ((void*)0));
            else if (rctformat == (5 | 0x8000))
                rcms = PEM_read_bio_CMS(rctin, ((void*)0), ((void*)0), ((void*)0));
            else if (rctformat == 4)
        ...
        case OPT_RR_FROM:
            if (rr_from == ((void*)0)
                && (rr_from = sk_OPENSSL_STRING_new_null()) == ((void*)0))
                goto end;
            sk_OPENSSL_STRING_push(rr_from, opt_arg());
            break;
        case OPT_RR_TO:
            if (rr_to == ((void*)0)
                && (rr_to = sk_OPENSSL_STRING_new_null()) == ((void*)0))
                goto end;
        ...
        case OPT_SIGNER:
            ...
            if (signerfile != ((void*)0)) {
                if (sksigners == ((void*)0)
                    && (sksigners = sk_OPENSSL_STRING_new_null()) == ((void*)0))
                    goto end;
                sk_OPENSSL_STRING_push(sksigners, signerfile);
                if (keyfile == ((void*)0))
                    keyfile = signerfile;
                if (skkeys == ((void*)0)
                    && (skkeys = sk_OPENSSL_STRING_new_null()) == ((void*)0))
                    goto end;
        ...
        case OPT_INKEY:
            ...
            break;
        case OPT_KEYFORM:
            if (!opt_format(opt_arg(), ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10)), &keyform))
                goto opthelp;
            break;
        case OPT_RECIP:
            if (operation == (1 | 0x10)) {
                if (encerts == ((void*)0) && (encerts = sk_X509_new_null()) == ((void*)0))
                    goto end;
                cert = load_cert(opt_arg(), (5 | 0x8000),
        ...
        case OPT_KEYOPT:
            ...
            if (operation == (1 | 0x10)) {
                ...
                if (keyfile != ((void*)0) || signerfile != ((void*)0))
                    keyidx++;
                if (skkeys != ((void*)0))
            ...
            if (key_param == ((void*)0) || key_param->idx != keyidx) {
                cms_key_param *nparam;
                nparam = app_malloc(sizeof(*nparam), "key param buffer");
                nparam->idx = keyidx;
                if ((nparam->param = sk_OPENSSL_STRING_new_null()) == ((void*)0))
                    goto end;
                nparam->next = ((void*)0);
                if (key_first == ((void*)0))
                    key_first = nparam;
    ...
    if ((rr_allorfirst != -1 || rr_from != ((void*)0)) && rr_to == ((void*)0)) {
        BIO_puts(bio_err, "No Signed Receipts Recipients\n");
        goto opthelp;
    }

    if (!(operation & 0x40) && (rr_to != ((void*)0) || rr_from != ((void*)0))) {
        BIO_puts(bio_err, "Signed receipts only allowed with -sign\n");
        goto opthelp;
    }
    if (!(operation & 0x40) && (skkeys != ((void*)0) || sksigners != ((void*)0))) {
    ...
    if (operation & 0x40) {
        ...
        if (signerfile != ((void*)0)) {
            if (sksigners == ((void*)0)
                ...
                goto end;
            sk_OPENSSL_STRING_push(sksigners, signerfile);
            if (skkeys == ((void*)0) && (skkeys = sk_OPENSSL_STRING_new_null()) == ((void*)0))
                goto end;
            if (keyfile == ((void*)0))
                keyfile = signerfile;
            sk_OPENSSL_STRING_push(skkeys, keyfile);
        ...
        signerfile = ((void*)0);
        keyfile = ((void*)0);
    } else if (operation == (2 | 0x20)) {
        if (recipfile == ((void*)0) && keyfile == ((void*)0)
            && secret_key == ((void*)0) && pwri_pass == ((void*)0)) {
            BIO_printf(bio_err,
                       "No recipient certificate or key specified\n");
            goto opthelp;
        }
    } else if (operation == (1 | 0x10)) {
        if (*argv == ((void*)0) && secret_key == ((void*)0)
            && pwri_pass == ((void*)0) && encerts == ((void*)0)) {
    ...
    if (operation == (1 | 0x10)) {
        ...
        if (*argv && encerts == ((void*)0))
            if ((encerts = sk_X509_new_null()) == ((void*)0))
                goto end;
        while (*argv) {
            if ((cert = load_cert(*argv, (5 | 0x8000),
                                  "recipient certificate file")) == ((void*)0))
                goto end;
            sk_X509_push(encerts, cert);
            cert = ((void*)0);
            argv++;
    ...
    if (certfile != ((void*)0)) {
        if (!load_certs(certfile, &other, (5 | 0x8000), ((void*)0),
                        "certificate file")) {
    ...
    if (recipfile != ((void*)0) && (operation == (2 | 0x20))) {
        if ((recip = load_cert(recipfile, (5 | 0x8000),
                               "recipient certificate file")) == ((void*)0)) {
            ERR_print_errors(bio_err);
            goto end;
        }
    ...
    if (operation == (15 | 0x20 | 0x10)) {
        if ((signer = load_cert(signerfile, (5 | 0x8000),
                                "receipt signer certificate file")) == ((void*)0)) {
            ERR_print_errors(bio_err);
            goto end;
        }
    }
    ...
    if (operation == (2 | 0x20)) {
        if (keyfile == ((void*)0))
            keyfile = recipfile;
    } else if ((operation == (3 | 0x10 | 0x40)) || (operation == (15 | 0x20 | 0x10))) {
        if (keyfile == ((void*)0))
            keyfile = signerfile;
    } else {
        keyfile = ((void*)0);
    ...
    if (operation & 0x20) {
        if (informat == (7 | 0x8000)) {
            cms = SMIME_read_CMS(in, &indata);
        } else if (informat == (5 | 0x8000)) {
            cms = PEM_read_bio_CMS(in, ((void*)0), ((void*)0), ((void*)0));
        } else if (informat == 4) {
        ...
        if (contfile != ((void*)0)) {
            BIO_free(indata);
            if ((indata = BIO_new_file(contfile, "rb")) == ((void*)0)) {
                BIO_printf(bio_err, "Can't read content file %s\n", contfile);
                goto end;
            }
        }
        if (certsoutfile != ((void*)0)) {
            struct stack_st_X509 *allcerts;
    ...
    if (rctfile != ((void*)0)) {
        char *rctmode = (rctformat == 4) ? "rb" : "r";
        if ((rctin = BIO_new_file(rctfile, rctmode)) == ((void*)0)) {
    ...
    if ((operation == (4 | 0x20)) || (operation == (16 | 0x20))) {
    ...
    if (operation == (8 | 0x10)) {
    ...
    } else if (operation == (10 | 0x10)) {
        cms = CMS_digest_create(in, sign_md, flags);
    } else if (operation == (12 | 0x10)) {
        cms = CMS_compress(in, -1, flags);
    } else if (operation == (1 | 0x10)) {
        int i;
        flags |= 0x4000;
        cms = CMS_encrypt(((void*)0), in, cipher, flags);
        if (cms == ((void*)0))
            goto end;
        for (i = 0; i < sk_X509_num(encerts); i++) {
            ...
            if (CMS_RecipientInfo_type(ri) == 1
                && wrap_cipher) {
                EVP_CIPHER_CTX *wctx;
                wctx = CMS_RecipientInfo_kari_get0_ctx(ri);
                EVP_EncryptInit_ex(wctx, wrap_cipher, ((void*)0), ((void*)0), ((void*)0));
            }
        }

        if (secret_key != ((void*)0)) {
            if (!CMS_add0_recipient_key(cms, 0,
        ...
        if (pwri_pass != ((void*)0)) {
            pwri_tmp = (unsigned char *)CRYPTO_strdup((char *)pwri_pass, "apps/cms.c", 857);
            if (pwri_tmp == ((void*)0))
                goto end;
            if (CMS_add0_recipient_password(cms,
                                            -1, 0, 0,
                                            pwri_tmp, -1, ((void*)0)) == ((void*)0))
                goto end;
            pwri_tmp = ((void*)0);
        }
        if (!(flags & 0x1000)) {
            if (!CMS_final(cms, in, ((void*)0), flags))
                goto end;
        }
    } else if (operation == (14 | 0x10)) {
        cms = CMS_EncryptedData_encrypt(in, cipher,
                                        secret_key, secret_keylen, flags);

    } else if (operation == (15 | 0x20 | 0x10)) {
        CMS_ContentInfo *srcms = ((void*)0);
        struct stack_st_CMS_SignerInfo *sis;
        CMS_SignerInfo *si;
        ...
        if (operation == (3 | 0x10 | 0x40)) {

            if (flags & 0x40) {
                if (outformat == (7 | 0x8000))
                    flags |= 0x1000;
            }
            flags |= 0x4000;
            cms = CMS_sign(((void*)0), ((void*)0), other, in, flags);
            if (cms == ((void*)0))
                goto end;
            if (econtent_type != ((void*)0))
        ...
        for (i = 0; i < sk_OPENSSL_STRING_num(sksigners); i++) {
            ...
            signer = load_cert(signerfile, (5 | 0x8000), "signer certificate");
            if (signer == ((void*)0)) {
                ret = 2;
                goto end;
            }
            ...
            if (rr != ((void*)0) && !CMS_add1_ReceiptRequest(si, rr))
                goto end;
            X509_free(signer);
            signer = ((void*)0);
            EVP_PKEY_free(key);
        ...
        if ((operation == (3 | 0x10 | 0x40)) && !(flags & 0x1000)) {
            if (!CMS_final(cms, in, ((void*)0), flags))
                goto end;
        }
    }
    ...
    if (operation == (2 | 0x20)) {
        if (flags & 0x20000)
            CMS_decrypt(cms, ((void*)0), ((void*)0), ((void*)0), ((void*)0), flags);
        ...
        if (!CMS_decrypt(cms, ((void*)0), ((void*)0), indata, out, flags)) {
            BIO_printf(bio_err, "Error decrypting CMS structure\n");
            goto end;
        }
    } else if (operation == (7 | 0x20)) {
        if (!CMS_data(cms, out, flags))
            goto end;
    } else if (operation == (11 | 0x20)) {
        if (!CMS_uncompress(cms, indata, out, flags))
            goto end;
    } else if (operation == (9 | 0x20)) {
    ...
    } else if (operation == (13 | 0x20)) {
        if (!CMS_EncryptedData_decrypt(cms, secret_key, secret_keylen,
                                       indata, out, flags))
            goto end;
    } else if (operation == (4 | 0x20)) {
        ...
        if (noout) {
            if (print)
                CMS_ContentInfo_print_ctx(out, cms, 0, ((void*)0));
        } else if (outformat == (7 | 0x8000)) {
            if (to)
            ...
            if (operation == (6 | 0x20 | 0x10 | 0x40))
                ret = SMIME_write_CMS(out, cms, indata, flags);
            else
                ret = SMIME_write_CMS(out, cms, in, flags);
        } else if (outformat == (5 | 0x8000)) {
    ...
    CRYPTO_free(secret_key, "apps/cms.c", 1084);
    CRYPTO_free(secret_keyid, "apps/cms.c", 1085);
    CRYPTO_free(pwri_tmp, "apps/cms.c", 1086);
    ...
    for (key_param = key_first; key_param;) {
        ...
        CRYPTO_free(key_param, "apps/cms.c", 1095);
        key_param = tparam;
    }
    ...
    BIO_free(indata);
    BIO_free_all(out);
    CRYPTO_free(passin, "apps/cms.c", 1110);
    return ret;
}
...
static void gnames_stack_print(struct stack_st_GENERAL_NAMES *gns)
{
    struct stack_st_GENERAL_NAME *gens;
    GENERAL_NAME *gen;
    int i, j;
...
static void receipt_request_print(CMS_ContentInfo *cms)
{
    ...
    int allorfirst;
    struct stack_st_GENERAL_NAMES *rto, *rlist;
    ASN1_STRING *scid;
    int i, rv;
    sis = CMS_get0_SignerInfos(cms);
...
static struct stack_st_GENERAL_NAMES *make_names_stack(struct stack_st_OPENSSL_STRING *ns)
{
    int i;
    struct stack_st_GENERAL_NAMES *ret;
    ...
    for (i = 0; i < sk_OPENSSL_STRING_num(ns); i++) {
        ...
        gen = a2i_GENERAL_NAME(((void*)0), ((void*)0), ((void*)0), 1, str, 0);
        if (gen == ((void*)0))
            goto err;
...
static CMS_ReceiptRequest *make_receipt_request(struct stack_st_OPENSSL_STRING
                                                ...
                                                *rr_from)
{
    struct stack_st_GENERAL_NAMES *rct_to = ((void*)0), *rct_from = ((void*)0);
    CMS_ReceiptRequest *rr;
    ...
    rr = CMS_ReceiptRequest_create0(((void*)0), -1, rr_allorfirst, rct_from,
                                    rct_to);
    return rr;
 err:
