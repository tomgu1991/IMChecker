...
int opt_long(const char *value, long *result)
{
    ...
    if (*endp
            || endp == value
            || ((l == 9223372036854775807L || l == (-9223372036854775807L -1L)) && (*__errno_location ()) == 34)
            || (l == 0 && (*__errno_location ()) != 0)) {
...
int opt_imax(const char *value, intmax_t *result)
{
    ...
    if (*endp
            || endp == value
            || ((m == (9223372036854775807L) || m == (-9223372036854775807L -1)) && (*__errno_location ()) == 34)
            || (m == 0 && (*__errno_location ()) != 0)) {
        opt_number_error(value);
        (*__errno_location ()) = oerrno;
        return 0;
    }
...
int opt_umax(const char *value, uintmax_t *result)
{
    ...
    if (*endp
            || endp == value
            || (m == (18446744073709551615UL) && (*__errno_location ()) == 34)
            || (m == 0 && (*__errno_location ()) != 0)) {
        opt_number_error(value);
        (*__errno_location ()) = oerrno;
        return 0;
...
int opt_ulong(const char *value, unsigned long *result)
{
    ...
    if (*endptr
            || endptr == value
            || ((l == (9223372036854775807L *2UL+1UL)) && (*__errno_location ()) == 34)
            || (l == 0 && (*__errno_location ()) != 0)) {
        opt_number_error(value);
        (*__errno_location ()) = oerrno;
        return 0;
...
enum range { OPT_V__FIRST=2000, OPT_V_POLICY, OPT_V_PURPOSE, OPT_V_VERIFY_NAME, OPT_V_VERIFY_DEPTH, OPT_V_ATTIME, OPT_V_VERIFY_HOSTNAME, OPT_V_VERIFY_EMAIL, OPT_V_VERIFY_IP, OPT_V_IGNORE_CRITICAL, OPT_V_ISSUER_CHECKS, OPT_V_CRL_CHECK, OPT_V_CRL_CHECK_ALL, OPT_V_POLICY_CHECK, OPT_V_EXPLICIT_POLICY, OPT_V_INHIBIT_ANY, OPT_V_INHIBIT_MAP, OPT_V_X509_STRICT, OPT_V_EXTENDED_CRL, OPT_V_USE_DELTAS, OPT_V_POLICY_PRINT, OPT_V_CHECK_SS_SIG, OPT_V_TRUSTED_FIRST, OPT_V_SUITEB_128_ONLY, OPT_V_SUITEB_128, OPT_V_SUITEB_192, OPT_V_PARTIAL_CHAIN, OPT_V_NO_ALT_CHAINS, OPT_V_NO_CHECK_TIME, OPT_V_VERIFY_AUTH_LEVEL, OPT_V_ALLOW_PROXY_CERTS, OPT_V__LAST };
...
int opt_verify(int opt, X509_VERIFY_PARAM *vpm)
{
    ...
    case OPT_V_IGNORE_CRITICAL:
        X509_VERIFY_PARAM_set_flags(vpm, 0x10);
        break;
    case OPT_V_ISSUER_CHECKS:

        break;
    case OPT_V_CRL_CHECK:
        X509_VERIFY_PARAM_set_flags(vpm, 0x4);
        break;
    ...
    case OPT_V_POLICY_CHECK:
        X509_VERIFY_PARAM_set_flags(vpm, 0x80);
        break;
    case OPT_V_EXPLICIT_POLICY:
        X509_VERIFY_PARAM_set_flags(vpm, 0x100);
        break;
    case OPT_V_INHIBIT_ANY:
        X509_VERIFY_PARAM_set_flags(vpm, 0x200);
        break;
    case OPT_V_INHIBIT_MAP:
        X509_VERIFY_PARAM_set_flags(vpm, 0x400);
        break;
    case OPT_V_X509_STRICT:
        X509_VERIFY_PARAM_set_flags(vpm, 0x20);
        break;
    case OPT_V_EXTENDED_CRL:
        X509_VERIFY_PARAM_set_flags(vpm, 0x1000);
        break;
    case OPT_V_USE_DELTAS:
        X509_VERIFY_PARAM_set_flags(vpm, 0x2000);
        break;
    case OPT_V_POLICY_PRINT:
        X509_VERIFY_PARAM_set_flags(vpm, 0x800);
        break;
    case OPT_V_CHECK_SS_SIG:
        X509_VERIFY_PARAM_set_flags(vpm, 0x4000);
        break;
    case OPT_V_TRUSTED_FIRST:
        X509_VERIFY_PARAM_set_flags(vpm, 0x8000);
        break;
    case OPT_V_SUITEB_128_ONLY:
        X509_VERIFY_PARAM_set_flags(vpm, 0x10000);
        break;
    case OPT_V_SUITEB_128:
        X509_VERIFY_PARAM_set_flags(vpm, 0x30000);
        break;
    case OPT_V_SUITEB_192:
        X509_VERIFY_PARAM_set_flags(vpm, 0x20000);
        break;
    case OPT_V_PARTIAL_CHAIN:
        X509_VERIFY_PARAM_set_flags(vpm, 0x80000);
        break;
    case OPT_V_NO_ALT_CHAINS:
        X509_VERIFY_PARAM_set_flags(vpm, 0x100000);
        break;
    case OPT_V_NO_CHECK_TIME:
        X509_VERIFY_PARAM_set_flags(vpm, 0x200000);
        break;
    case OPT_V_ALLOW_PROXY_CERTS:
        X509_VERIFY_PARAM_set_flags(vpm, 0x40);
        break;
    }
    return 1;
...
int opt_next(void)
{
    ...
    for (o = opts; o->name; ++o) {
        ...
        case 'f':
            if (opt_format(arg,
                           o->valtype == 'c' ? ((1L << 1) | (1L << 3)) :
                           o->valtype == 'E' ? ((1L << 1) | (1L << 4)) :
                           o->valtype == 'F' ? (1L << 1)
                           : ( (1L << 1) | (1L << 2) | (1L << 3) | (1L << 4) | (1L << 5) | (1L << 6) | (1L << 7) | (1L << 8) | (1L << 9) | (1L << 10)), &ival))
                break;
            BIO_printf(bio_err,
