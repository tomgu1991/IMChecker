...
int enc_main(int argc, char **argv)
{
    ...
    ENGINE *e = ((void*)0);
    BIO *in = ((void*)0), *out = ((void*)0), *b64 = ((void*)0), *benc = ((void*)0), *rbio =
        ((void*)0), *wbio = ((void*)0);
    EVP_CIPHER_CTX *ctx = ((void*)0);
    const EVP_CIPHER *cipher = ((void*)0), *c;
    const EVP_MD *dgst = ((void*)0);
    char *hkey = ((void*)0), *hiv = ((void*)0), *hsalt = ((void*)0), *p;
    char *infile = ((void*)0), *outfile = ((void*)0), *prog;
    char *str = ((void*)0), *passarg = ((void*)0), *pass = ((void*)0), *strbuf = ((void*)0);
    char mbuf[sizeof(magic) - 1];
    OPTION_CHOICE o;
    int bsize = (8*1024), verbose = 0, debug = 0, olb64 = 0, nosalt = 0;
    int enc = 1, printkey = 0, i, k;
    int base64 = 0, informat = 2, outformat = 2;
    int ret = 1, inl, nopad = 0;
    unsigned char key[64], iv[16];
    unsigned char *buff = ((void*)0), salt[8];
    int pbkdf2 = 0;
    int iter = 0;
    long n;
    ...
    if (strcmp(prog, "base64") == 0) {
        ...
        if (cipher == ((void*)0) && strcmp(prog, "enc") != 0) {
 ...
 opthelp:
        ...
        case OPT_BUFSIZE:
            ...
            if (!opt_long(opt_arg(), &n)
                    || n < 0 || (k && n >= 9223372036854775807L / 1024))
                goto opthelp;
            if (k)
                n *= 1024;
            bsize = (int)n;
        ...
        case OPT_K:
            ...
            break;
        case OPT_KFILE:
            in = bio_open_default(opt_arg(), 'r', (1 | 0x8000));
            if (in == ((void*)0))
                goto opthelp;
    ...
    if (cipher && EVP_CIPHER_flags(cipher) & 0x200000) {
        BIO_printf(bio_err, "%s: AEAD ciphers not supported\n", prog);
        goto end;
    }

    if (cipher && ((EVP_CIPHER_flags(cipher) & 0xF0007) == 0x10001)) {
    ...
    strbuf = app_malloc((512), "strbuf");
    buff = app_malloc(((((bsize)+2)/3*4)+((bsize)/48+1)*2+80), "evp buffer");
    ...
    if ((str == ((void*)0)) && (cipher != ((void*)0)) && (hkey == ((void*)0))) {
        if (1) {
            ...
            for (;;) {
                ...
                strbuf[0] = '\0';
                i = EVP_read_pw_string((char *)strbuf, (512), prompt, enc);
                if (i == 0) {
                    if (strbuf[0] == '\0') {
                        ret = 1;
                        goto end;
...
# 397 "apps/enc.c"
    ...
    if (cipher != ((void*)0)) {
        ...
        if (str != ((void*)0)) {
            ...
            if (pbkdf2 == 1) {
                ...
                unsigned char tmpkeyiv[64 + 16];
                int iklen = EVP_CIPHER_key_length(cipher);
                int ivlen = EVP_CIPHER_iv_length(cipher);

                int islen = (sptr != ((void*)0) ? sizeof(salt) : 0);
        ...
        if ((benc = BIO_new(BIO_f_cipher())) == ((void*)0))
            goto end;
        ...
        BIO_ctrl(benc,129,0, (char *)(&ctx));

        if (!EVP_CipherInit_ex(ctx, cipher, ((void*)0), ((void*)0), ((void*)0), enc)) {
        ...
        if (!EVP_CipherInit_ex(ctx, ((void*)0), ((void*)0), key, iv, enc)) {
            BIO_printf(bio_err, "Error setting cipher %s\n",
                       OBJ_nid2sn(EVP_CIPHER_nid(cipher)));
            ERR_print_errors(bio_err);
            goto end;
    ...
    if (!(int)BIO_ctrl(wbio,11,0,((void*)0))) {
    ...
    ERR_print_errors(bio_err);
    CRYPTO_free(strbuf, "apps/enc.c", 610);
    CRYPTO_free(buff, "apps/enc.c", 611);
    BIO_free(in);
    BIO_free_all(out);
    BIO_free(benc);
    BIO_free(b64);
    ...
    release_engine(e);
    CRYPTO_free(pass, "apps/enc.c", 620);
    return ret;
}
...
static void show_ciphers(const OBJ_NAME *name, void *arg)
{
    ...
    if (!((*__ctype_b_loc ())[(int) (((unsigned char)*name->name))] & (unsigned short int) _ISlower))
        return;


    cipher = EVP_get_cipherbyname(name->name);
    if (cipher == ((void*)0) ||
            (EVP_CIPHER_flags(cipher) & 0x200000) != 0 ||
            (EVP_CIPHER_flags(cipher) & 0xF0007) == 0x10001)
        return;
...
static int set_hex(const char *in, unsigned char *out, int size)
{
    ...
    for (i = 0; i < n; i++) {
        j = (unsigned char)*in++;
        if (!((*__ctype_b_loc ())[(int) ((j))] & (unsigned short int) _ISxdigit)) {
