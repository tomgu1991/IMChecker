...
{
    BIO *in = ((void*)0), *out = ((void*)0), *indata = ((void*)0);
    EVP_PKEY *key = ((void*)0);
    PKCS7 *p7 = ((void*)0);
    ...
    const char *CAfile = ((void*)0), *CApath = ((void*)0), *prog = ((void*)0);
    char *certfile = ((void*)0), *keyfile = ((void*)0), *contfile = ((void*)0);
    char *infile = ((void*)0), *outfile = ((void*)0), *signerfile = ((void*)0), *recipfile = ((void*)0);
    char *passinarg = ((void*)0), *passin = ((void*)0), *to = ((void*)0), *from = ((void*)0), *subject = ((void*)0);
    OPTION_CHOICE o;
    int noCApath = 0, noCAfile = 0;
    int flags = 0x40, operation = 0, ret = 0, indef = 0;
    int informat = (7 | 0x8000), outformat = (7 | 0x8000), keyform =
        (5 | 0x8000);
 ...
 opthelp:
    ...
    if (operation & 0x40) {
        ...
        if (signerfile != ((void*)0)) {
            if (sksigners == ((void*)0)
                ...
                goto end;
            sk_OPENSSL_STRING_push(sksigners, signerfile);
            if (!skkeys && (skkeys = sk_OPENSSL_STRING_new_null()) == ((void*)0))
                goto end;
            if (!keyfile)
                keyfile = signerfile;
            sk_OPENSSL_STRING_push(skkeys, keyfile);
    ...
    if (operation & 0x20) {
        if (informat == (7 | 0x8000)) {
            ...
            p7 = PEM_read_bio_PKCS7(in, ((void*)0), ((void*)0), ((void*)0));
        } else if (informat == 4) {
            p7 = d2i_PKCS7_bio(in, ((void*)0));
        } else {
    ...
    if (operation == (1 | 0x10)) {
        ...
        if (operation == (3 | 0x10 | 0x40)) {
            ...
            flags |= 0x4000;
            p7 = PKCS7_sign(((void*)0), ((void*)0), other, in, flags);
            if (p7 == ((void*)0))
                goto end;
            if (flags & 0x2) {
        ...
        for (i = 0; i < sk_OPENSSL_STRING_num(sksigners); i++) {
            ...
            signer = load_cert(signerfile, (5 | 0x8000),
                               "signer certificate");
            if (signer == ((void*)0))
                goto end;
            key = load_key(keyfile, keyform, 0, passin, e, "signing key file");
    ...
    BIO_free(indata);
    BIO_free_all(out);
    CRYPTO_free(passin, "apps/smime.c", 612);
    return ret;
}
