...
# 1 "include/openssl/ts.h" 1
# 13 "include/openssl/ts.h"
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/ts.h" 2
# 25 "include/openssl/ts.h"
# 1 "include/openssl/tserr.h" 1
# 14 "include/openssl/tserr.h"
# 1 "include/openssl/opensslconf.h" 1
# 15 "include/openssl/tserr.h" 2
...
struct stack_st_ESS_CERT_ID; typedef int (*sk_ESS_CERT_ID_compfunc)(const ESS_CERT_ID * const *a, const ESS_CERT_ID *const *b); typedef void (*sk_ESS_CERT_ID_freefunc)(ESS_CERT_ID *a); typedef ESS_CERT_ID * (*sk_ESS_CERT_ID_copyfunc)(const ESS_CERT_ID *a); static inline int sk_ESS_CERT_ID_num(const struct stack_st_ESS_CERT_ID *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static inline ESS_CERT_ID *sk_ESS_CERT_ID_value(const struct stack_st_ESS_CERT_ID *sk, int idx) { return (ESS_CERT_ID *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static inline struct stack_st_ESS_CERT_ID *sk_ESS_CERT_ID_new(sk_ESS_CERT_ID_compfunc compare) { return (struct stack_st_ESS_CERT_ID *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static inline struct stack_st_ESS_CERT_ID *sk_ESS_CERT_ID_new_null(void) { return (struct stack_st_ESS_CERT_ID *)OPENSSL_sk_new_null(); } static inline struct stack_st_ESS_CERT_ID *sk_ESS_CERT_ID_new_reserve(sk_ESS_CERT_ID_compfunc compare, int n) { return (struct stack_st_ESS_CERT_ID *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static inline int sk_ESS_CERT_ID_reserve(struct stack_st_ESS_CERT_ID *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static inline void sk_ESS_CERT_ID_free(struct stack_st_ESS_CERT_ID *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static inline void sk_ESS_CERT_ID_zero(struct stack_st_ESS_CERT_ID *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static inline ESS_CERT_ID *sk_ESS_CERT_ID_delete(struct stack_st_ESS_CERT_ID *sk, int i) { return (ESS_CERT_ID *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static inline ESS_CERT_ID *sk_ESS_CERT_ID_delete_ptr(struct stack_st_ESS_CERT_ID *sk, ESS_CERT_ID *ptr) { return (ESS_CERT_ID *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_ESS_CERT_ID_push(struct stack_st_ESS_CERT_ID *sk, ESS_CERT_ID *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_ESS_CERT_ID_unshift(struct stack_st_ESS_CERT_ID *sk, ESS_CERT_ID *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static inline ESS_CERT_ID *sk_ESS_CERT_ID_pop(struct stack_st_ESS_CERT_ID *sk) { return (ESS_CERT_ID *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static inline ESS_CERT_ID *sk_ESS_CERT_ID_shift(struct stack_st_ESS_CERT_ID *sk) { return (ESS_CERT_ID *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static inline void sk_ESS_CERT_ID_pop_free(struct stack_st_ESS_CERT_ID *sk, sk_ESS_CERT_ID_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static inline int sk_ESS_CERT_ID_insert(struct stack_st_ESS_CERT_ID *sk, ESS_CERT_ID *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static inline ESS_CERT_ID *sk_ESS_CERT_ID_set(struct stack_st_ESS_CERT_ID *sk, int idx, ESS_CERT_ID *ptr) { return (ESS_CERT_ID *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static inline int sk_ESS_CERT_ID_find(struct stack_st_ESS_CERT_ID *sk, ESS_CERT_ID *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_ESS_CERT_ID_find_ex(struct stack_st_ESS_CERT_ID *sk, ESS_CERT_ID *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static inline void sk_ESS_CERT_ID_sort(struct stack_st_ESS_CERT_ID *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static inline int sk_ESS_CERT_ID_is_sorted(const struct stack_st_ESS_CERT_ID *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static inline struct stack_st_ESS_CERT_ID * sk_ESS_CERT_ID_dup(const struct stack_st_ESS_CERT_ID *sk) { return (struct stack_st_ESS_CERT_ID *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static inline struct stack_st_ESS_CERT_ID *sk_ESS_CERT_ID_deep_copy(const struct stack_st_ESS_CERT_ID *sk, sk_ESS_CERT_ID_copyfunc copyfunc, sk_ESS_CERT_ID_freefunc freefunc) { return (struct stack_st_ESS_CERT_ID *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static inline sk_ESS_CERT_ID_compfunc sk_ESS_CERT_ID_set_cmp_func(struct stack_st_ESS_CERT_ID *sk, sk_ESS_CERT_ID_compfunc compare) { return (sk_ESS_CERT_ID_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }

typedef struct ESS_cert_id_v2_st ESS_CERT_ID_V2;
typedef struct ESS_signing_cert_v2_st ESS_SIGNING_CERT_V2;

struct stack_st_ESS_CERT_ID_V2; typedef int (*sk_ESS_CERT_ID_V2_compfunc)(const ESS_CERT_ID_V2 * const *a, const ESS_CERT_ID_V2 *const *b); typedef void (*sk_ESS_CERT_ID_V2_freefunc)(ESS_CERT_ID_V2 *a); typedef ESS_CERT_ID_V2 * (*sk_ESS_CERT_ID_V2_copyfunc)(const ESS_CERT_ID_V2 *a); static inline int sk_ESS_CERT_ID_V2_num(const struct stack_st_ESS_CERT_ID_V2 *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static inline ESS_CERT_ID_V2 *sk_ESS_CERT_ID_V2_value(const struct stack_st_ESS_CERT_ID_V2 *sk, int idx) { return (ESS_CERT_ID_V2 *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static inline struct stack_st_ESS_CERT_ID_V2 *sk_ESS_CERT_ID_V2_new(sk_ESS_CERT_ID_V2_compfunc compare) { return (struct stack_st_ESS_CERT_ID_V2 *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static inline struct stack_st_ESS_CERT_ID_V2 *sk_ESS_CERT_ID_V2_new_null(void) { return (struct stack_st_ESS_CERT_ID_V2 *)OPENSSL_sk_new_null(); } static inline struct stack_st_ESS_CERT_ID_V2 *sk_ESS_CERT_ID_V2_new_reserve(sk_ESS_CERT_ID_V2_compfunc compare, int n) { return (struct stack_st_ESS_CERT_ID_V2 *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static inline int sk_ESS_CERT_ID_V2_reserve(struct stack_st_ESS_CERT_ID_V2 *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static inline void sk_ESS_CERT_ID_V2_free(struct stack_st_ESS_CERT_ID_V2 *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static inline void sk_ESS_CERT_ID_V2_zero(struct stack_st_ESS_CERT_ID_V2 *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static inline ESS_CERT_ID_V2 *sk_ESS_CERT_ID_V2_delete(struct stack_st_ESS_CERT_ID_V2 *sk, int i) { return (ESS_CERT_ID_V2 *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static inline ESS_CERT_ID_V2 *sk_ESS_CERT_ID_V2_delete_ptr(struct stack_st_ESS_CERT_ID_V2 *sk, ESS_CERT_ID_V2 *ptr) { return (ESS_CERT_ID_V2 *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_ESS_CERT_ID_V2_push(struct stack_st_ESS_CERT_ID_V2 *sk, ESS_CERT_ID_V2 *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_ESS_CERT_ID_V2_unshift(struct stack_st_ESS_CERT_ID_V2 *sk, ESS_CERT_ID_V2 *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static inline ESS_CERT_ID_V2 *sk_ESS_CERT_ID_V2_pop(struct stack_st_ESS_CERT_ID_V2 *sk) { return (ESS_CERT_ID_V2 *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static inline ESS_CERT_ID_V2 *sk_ESS_CERT_ID_V2_shift(struct stack_st_ESS_CERT_ID_V2 *sk) { return (ESS_CERT_ID_V2 *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static inline void sk_ESS_CERT_ID_V2_pop_free(struct stack_st_ESS_CERT_ID_V2 *sk, sk_ESS_CERT_ID_V2_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static inline int sk_ESS_CERT_ID_V2_insert(struct stack_st_ESS_CERT_ID_V2 *sk, ESS_CERT_ID_V2 *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static inline ESS_CERT_ID_V2 *sk_ESS_CERT_ID_V2_set(struct stack_st_ESS_CERT_ID_V2 *sk, int idx, ESS_CERT_ID_V2 *ptr) { return (ESS_CERT_ID_V2 *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static inline int sk_ESS_CERT_ID_V2_find(struct stack_st_ESS_CERT_ID_V2 *sk, ESS_CERT_ID_V2 *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_ESS_CERT_ID_V2_find_ex(struct stack_st_ESS_CERT_ID_V2 *sk, ESS_CERT_ID_V2 *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static inline void sk_ESS_CERT_ID_V2_sort(struct stack_st_ESS_CERT_ID_V2 *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static inline int sk_ESS_CERT_ID_V2_is_sorted(const struct stack_st_ESS_CERT_ID_V2 *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static inline struct stack_st_ESS_CERT_ID_V2 * sk_ESS_CERT_ID_V2_dup(const struct stack_st_ESS_CERT_ID_V2 *sk) { return (struct stack_st_ESS_CERT_ID_V2 *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static inline struct stack_st_ESS_CERT_ID_V2 *sk_ESS_CERT_ID_V2_deep_copy(const struct stack_st_ESS_CERT_ID_V2 *sk, sk_ESS_CERT_ID_V2_copyfunc copyfunc, sk_ESS_CERT_ID_V2_freefunc freefunc) { return (struct stack_st_ESS_CERT_ID_V2 *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static inline sk_ESS_CERT_ID_V2_compfunc sk_ESS_CERT_ID_V2_set_cmp_func(struct stack_st_ESS_CERT_ID_V2 *sk, sk_ESS_CERT_ID_V2_compfunc compare) { return (sk_ESS_CERT_ID_V2_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
const struct stack_st_ASN1_UTF8STRING *
...
struct stack_st_EVP_MD; typedef int (*sk_EVP_MD_compfunc)(const EVP_MD * const *a, const EVP_MD *const *b); typedef void (*sk_EVP_MD_freefunc)(EVP_MD *a); typedef EVP_MD * (*sk_EVP_MD_copyfunc)(const EVP_MD *a); static inline int sk_EVP_MD_num(const struct stack_st_EVP_MD *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static inline const EVP_MD *sk_EVP_MD_value(const struct stack_st_EVP_MD *sk, int idx) { return (const EVP_MD *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static inline struct stack_st_EVP_MD *sk_EVP_MD_new(sk_EVP_MD_compfunc compare) { return (struct stack_st_EVP_MD *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static inline struct stack_st_EVP_MD *sk_EVP_MD_new_null(void) { return (struct stack_st_EVP_MD *)OPENSSL_sk_new_null(); } static inline struct stack_st_EVP_MD *sk_EVP_MD_new_reserve(sk_EVP_MD_compfunc compare, int n) { return (struct stack_st_EVP_MD *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static inline int sk_EVP_MD_reserve(struct stack_st_EVP_MD *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static inline void sk_EVP_MD_free(struct stack_st_EVP_MD *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static inline void sk_EVP_MD_zero(struct stack_st_EVP_MD *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static inline const EVP_MD *sk_EVP_MD_delete(struct stack_st_EVP_MD *sk, int i) { return (const EVP_MD *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static inline const EVP_MD *sk_EVP_MD_delete_ptr(struct stack_st_EVP_MD *sk, const EVP_MD *ptr) { return (const EVP_MD *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_EVP_MD_push(struct stack_st_EVP_MD *sk, const EVP_MD *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_EVP_MD_unshift(struct stack_st_EVP_MD *sk, const EVP_MD *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static inline const EVP_MD *sk_EVP_MD_pop(struct stack_st_EVP_MD *sk) { return (const EVP_MD *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static inline const EVP_MD *sk_EVP_MD_shift(struct stack_st_EVP_MD *sk) { return (const EVP_MD *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static inline void sk_EVP_MD_pop_free(struct stack_st_EVP_MD *sk, sk_EVP_MD_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static inline int sk_EVP_MD_insert(struct stack_st_EVP_MD *sk, const EVP_MD *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static inline const EVP_MD *sk_EVP_MD_set(struct stack_st_EVP_MD *sk, int idx, const EVP_MD *ptr) { return (const EVP_MD *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static inline int sk_EVP_MD_find(struct stack_st_EVP_MD *sk, const EVP_MD *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_EVP_MD_find_ex(struct stack_st_EVP_MD *sk, const EVP_MD *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static inline void sk_EVP_MD_sort(struct stack_st_EVP_MD *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static inline int sk_EVP_MD_is_sorted(const struct stack_st_EVP_MD *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static inline struct stack_st_EVP_MD * sk_EVP_MD_dup(const struct stack_st_EVP_MD *sk) { return (struct stack_st_EVP_MD *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static inline struct stack_st_EVP_MD *sk_EVP_MD_deep_copy(const struct stack_st_EVP_MD *sk, sk_EVP_MD_copyfunc copyfunc, sk_EVP_MD_freefunc freefunc) { return (struct stack_st_EVP_MD *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static inline sk_EVP_MD_compfunc sk_EVP_MD_set_cmp_func(struct stack_st_EVP_MD *sk, sk_EVP_MD_compfunc compare) { return (sk_EVP_MD_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
struct stack_st_X509 *TS_VERIFY_CTS_set_certs(TS_VERIFY_CTX *ctx, struct stack_st_X509 *certs);
# 500 "include/openssl/ts.h"
...
typedef enum OPTION_choice {
    ...
    OPT_MD, OPT_V__FIRST=2000, OPT_V_POLICY, OPT_V_PURPOSE, OPT_V_VERIFY_NAME, OPT_V_VERIFY_DEPTH, OPT_V_ATTIME, OPT_V_VERIFY_HOSTNAME, OPT_V_VERIFY_EMAIL, OPT_V_VERIFY_IP, OPT_V_IGNORE_CRITICAL, OPT_V_ISSUER_CHECKS, OPT_V_CRL_CHECK, OPT_V_CRL_CHECK_ALL, OPT_V_POLICY_CHECK, OPT_V_EXPLICIT_POLICY, OPT_V_INHIBIT_ANY, OPT_V_INHIBIT_MAP, OPT_V_X509_STRICT, OPT_V_EXTENDED_CRL, OPT_V_USE_DELTAS, OPT_V_POLICY_PRINT, OPT_V_CHECK_SS_SIG, OPT_V_TRUSTED_FIRST, OPT_V_SUITEB_128_ONLY, OPT_V_SUITEB_128, OPT_V_SUITEB_192, OPT_V_PARTIAL_CHAIN, OPT_V_NO_ALT_CHAINS, OPT_V_NO_CHECK_TIME, OPT_V_VERIFY_AUTH_LEVEL, OPT_V_ALLOW_PROXY_CERTS, OPT_V__LAST, OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST
} OPTION_CHOICE;
...
int ts_main(int argc, char **argv)
{
 ...
 opthelp:
    ...
    if (mode == OPT_QUERY) {
        ...
        if ((in == ((void*)0)) || !(( queryfile && !data && !digest) || ( data && !queryfile && !digest) || ( digest && !queryfile && !data)))
            goto opthelp;
    ...
    NCONF_free(conf);
    CRYPTO_free(password, "apps/ts.c", 323);
    return ret;
}
...
static CONF *load_config_file(const char *configfile)
{
    ...
    if (conf != ((void*)0)) {
        ...
        p = NCONF_get_string(conf, ((void*)0), "oid_file");
        if (p != ((void*)0)) {
                         ...
                         int cert, const char *in, const char *out, int text)
{
    ...
    if (in != ((void*)0)) {
        if ((in_bio = bio_open_default(in, 'r', 4)) == ((void*)0))
            goto end;
        query = d2i_TS_REQ_bio(in_bio, ((void*)0));
    } else {
        if (digest == ((void*)0)
            && (data_bio = bio_open_default(data, 'r', 4)) == ((void*)0))
            goto end;
    ...
    if (text) {
        if ((out_bio = bio_open_default(out, 'w', (1 | 0x8000))) == ((void*)0))
            goto end;
        if (!TS_REQ_print_bio(out_bio, query))
            goto end;
    } else {
        if ((out_bio = bio_open_default(out, 'w', 4)) == ((void*)0))
            goto end;
                            ...
                            const char *policy, int no_nonce, int cert)
{
    ...
    if (!no_nonce && (nonce_asn1 = create_nonce(64)) == ((void*)0))
        goto err;
 ...
 err:
    ...
    CRYPTO_free(data, "apps/ts.c", 474);
    ...
    if (input != ((void*)0)) {
        ...
        *md_value = OPENSSL_hexstr2buf(digest, &digest_len);
        if (!*md_value || md_value_len != digest_len) {
            CRYPTO_free(*md_value, "apps/ts.c", 512);
            *md_value = ((void*)0);
...
static ASN1_INTEGER *create_nonce(int bits)
{
    ...
    if ((nonce = ASN1_INTEGER_new()) == ((void*)0))
        goto err;
    CRYPTO_free(nonce->data, "apps/ts.c", 542);
    nonce->length = len - i;
...
static TS_RESP *read_PKCS7(BIO *in_bio)
{
    ...
    if ((si = TS_STATUS_INFO_new()) == ((void*)0))
        goto end;
    if (!TS_STATUS_INFO_set_status(si, 0))
        goto end;
...
static ASN1_INTEGER *serial_cb(TS_RESP_CTX *ctx, void *data)
{
    ...
    if (serial == ((void*)0)) {
        TS_RESP_CTX_set_status_info(ctx, 2,
                                    "Error during serial number "
                                    "generation.");
        TS_RESP_CTX_add_failure_info(ctx, 17);
    } else {
                                        ...
                                        X509_VERIFY_PARAM *vpm)
{
    ...
    TS_VERIFY_CTX_add_flags(ctx, f | (1u << 0));
                                     ...
                                     X509_VERIFY_PARAM *vpm)
{
    ...
    if (CApath != ((void*)0)) {
        ...
        i = X509_LOOKUP_ctrl((lookup),2,(CApath),(long)(1),((void*)0));
        if (!i) {
    ...
    if (CAfile != ((void*)0)) {
        ...
        i = X509_LOOKUP_ctrl((lookup),1,(CAfile),(long)(1),((void*)0));
        if (!i) {
