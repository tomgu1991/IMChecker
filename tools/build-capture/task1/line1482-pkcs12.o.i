...
int dump_certs_pkeys_bags(BIO *out, const struct stack_st_PKCS12_SAFEBAG *bags,
                          const char *pass, int passlen, int options,
                          char *pempass, const EVP_CIPHER *enc);
int dump_certs_pkeys_bag(BIO *out, const PKCS12_SAFEBAG *bags,
                         const char *pass, int passlen,
                         int options, char *pempass, const EVP_CIPHER *enc);
int print_attribs(BIO *out, const struct stack_st_X509_ATTRIBUTE *attrlst,
                  const char *name);
void hex_prin(BIO *out, unsigned char *buf, int len);
static int alg_print(const X509_ALGOR *alg);
int cert_load(BIO *in, struct stack_st_X509 *sk);
...
{
    char *infile = ((void*)0), *outfile = ((void*)0), *keyname = ((void*)0), *certfile = ((void*)0);
    char *name = ((void*)0), *csp_name = ((void*)0);
    char pass[2048] = "", macpass[2048] = "";
    int export_cert = 0, options = 0, chain = 0, twopass = 0, keytype = 0;
    int iter = 2048, maciter = 2048;
    ...
    int noprompt = 0;
    char *passinarg = ((void*)0), *passoutarg = ((void*)0), *passarg = ((void*)0);
    char *passin = ((void*)0), *passout = ((void*)0), *macalg = ((void*)0);
    char *cpass = ((void*)0), *mpass = ((void*)0), *badpass = ((void*)0);
    const char *CApath = ((void*)0), *CAfile = ((void*)0), *prog;
    int noCApath = 0, noCAfile = 0;
    ENGINE *e = ((void*)0);
    BIO *in = ((void*)0), *out = ((void*)0);
    PKCS12 *p12 = ((void*)0);
    struct stack_st_OPENSSL_STRING *canames = ((void*)0);
 ...
 opthelp:
        ...
        case OPT_CANAME:
            if (canames == ((void*)0)
                && (canames = sk_OPENSSL_STRING_new_null()) == ((void*)0))
                goto end;
    ...
    if (export_cert) {
        EVP_PKEY *key = ((void*)0);
        X509 *ucert = ((void*)0), *x = ((void*)0);
        struct stack_st_X509 *certs = ((void*)0);
        const EVP_MD *macmd = ((void*)0);
        unsigned char *catmp = ((void*)0);
        int i;

        if ((options & (0x2 | 0x1)) == (0x2 | 0x1)) {
        ...
        if (!(options & 0x1)) {
            key = load_key(keyname ? keyname : infile,
                           (5 | 0x8000), 1, passin, e, "private key");
            if (key == ((void*)0))
                goto export_end;
        }
        ...
        if (!(options & 0x2)) {
            if (!load_certs(infile, &certs, (5 | 0x8000), ((void*)0),
                            "certificates"))
                goto export_end;
            ...
            if (key != ((void*)0)) {
                ...
                for (i = 0; i < sk_X509_num(certs); i++) {
                    ...
                    if (X509_check_private_key(x, key)) {
                        ...
                        X509_keyid_set1(ucert, ((void*)0), 0);
                        X509_alias_set1(ucert, ((void*)0), 0);
        ...
        if (certfile != ((void*)0)) {
            if (!load_certs(certfile, &certs, (5 | 0x8000), ((void*)0),
        ...
        if (csp_name != ((void*)0) && key != ((void*)0))
            EVP_PKEY_add1_attr_by_NID(key, 417,
                                      (0x1000|1), (unsigned char *)csp_name,
                                      -1);

        if (add_lmk && key != ((void*)0))
            EVP_PKEY_add1_attr_by_NID(key, 856, 0, ((void*)0), -1);
        ...
        if (maciter != -1)
            PKCS12_set_mac(p12, mpass, -1, ((void*)0), 0, maciter, macmd);

        ((void) (0));

        out = bio_open_owner(outfile, 6, private);
        if (out == ((void*)0))
            goto end;
 ...
 export_end:
    ...
    in = bio_open_default(infile, 'r', 6);
    if (in == ((void*)0))
        goto end;
    out = bio_open_owner(outfile, (5 | 0x8000), private);
    if (out == ((void*)0))
        goto end;

    if ((p12 = d2i_PKCS12_bio(in, ((void*)0))) == ((void*)0)) {
        ERR_print_errors(bio_err);
        goto end;
    }
    ...
    if ((options & 0x4) && PKCS12_mac_present(p12)) {
        ...
        X509_ALGOR_get0(&macobj, ((void*)0), ((void*)0), macalgid);
        BIO_puts(bio_err, "MAC: ");
        i2a_ASN1_OBJECT(bio_err, macobj);
        BIO_printf(bio_err, ", Iteration %ld\n",
                   tmaciter != ((void*)0) ? ASN1_INTEGER_get(tmaciter) : 1L);
        BIO_printf(bio_err, "MAC length: %ld, salt length: %ld\n",
                   tmac != ((void*)0) ? ASN1_STRING_length(tmac) : 0L,
                   tsalt != ((void*)0) ? ASN1_STRING_length(tsalt) : 0L);
    }
    if (macver) {

        if (!mpass[0] && PKCS12_verify_mac(p12, ((void*)0), 0)) {
            ...
            unsigned char *utmp;
            int utmplen;
            utmp = OPENSSL_asc2uni(mpass, -1, ((void*)0), &utmplen);
            if (utmp == ((void*)0))
                goto end;
            badpass = OPENSSL_uni2utf8(utmp, utmplen);
            CRYPTO_free(utmp, "apps/pkcs12.c", 560);
    ...
    CRYPTO_free(badpass, "apps/pkcs12.c", 586);
    CRYPTO_free(passin, "apps/pkcs12.c", 587);
    CRYPTO_free(passout, "apps/pkcs12.c", 588);
    return ret;
}
...
int dump_certs_keys_p12(BIO *out, const PKCS12 *p12, const char *pass,
                        ...
                        const EVP_CIPHER *enc)
{
    struct stack_st_PKCS7 *asafes = ((void*)0);
    struct stack_st_PKCS12_SAFEBAG *bags;
    int i, bagnid;
    int ret = 0;
    PKCS7 *p7;

    if ((asafes = PKCS12_unpack_authsafes(p12)) == ((void*)0))
        return 0;
                         ...
                         char *pempass, const EVP_CIPHER *enc)
{
    ...
    X509 *x509;
    const struct stack_st_X509_ATTRIBUTE *attrs;
    int ret = 0;
    ...
    case 150:
        ...
        if ((pkey = EVP_PKCS82PKEY(p8c)) == ((void*)0))
            return 0;
        print_attribs(out, PKCS8_pkey_get0_attrs(p8c), "Key Attributes");
        ret = PEM_write_bio_PrivateKey(out, pkey, enc, ((void*)0), 0, ((void*)0), pempass);
        EVP_PKEY_free(pkey);
        break;
    ...
    case 151:
        if (options & 0x4) {
            ...
            X509_SIG_get0(tp8, &tp8alg, ((void*)0));
            alg_print(tp8alg);
        }
        if (options & 0x1)
            return 1;
        print_attribs(out, attrs, "Bag Attributes");
        if ((p8 = PKCS12_decrypt_skey(bag, pass, passlen)) == ((void*)0))
            return 0;
        if ((pkey = EVP_PKCS82PKEY(p8)) == ((void*)0)) {
    ...
    case 152:
        ...
        if (options & 0x2)
            return 1;
        if (PKCS12_SAFEBAG_get0_attr(bag, 157)) {
            if (options & 0x10)
                return 1;
        } else if (options & 0x8)
            return 1;
        print_attribs(out, attrs, "Bag Attributes");
        if (PKCS12_SAFEBAG_get_bag_nid(bag) != 158)
            return 1;
        if ((x509 = PKCS12_SAFEBAG_get1_cert(bag)) == ((void*)0))
            return 0;
...
static int get_cert_chain(X509 *cert, X509_STORE *store,
                          struct stack_st_X509 **chain)
{
    X509_STORE_CTX *store_ctx = ((void*)0);
    struct stack_st_X509 *chn = ((void*)0);
    int i = 0;
    ...
    if (!X509_STORE_CTX_init(store_ctx, store, cert, ((void*)0))) {
        i = 1;
        goto end;
    }
...
static int alg_print(const X509_ALGOR *alg)
{
    ...
    if (pbenid == 161) {
        PBE2PARAM *pbe2 = ((void*)0);
        int encnid;
        if (aparamtype == 16)
            pbe2 = ASN1_item_unpack(aparam, (&(PBE2PARAM_it)));
        if (pbe2 == ((void*)0)) {
        ...
        pbenid = OBJ_obj2nid(aoid);
        X509_ALGOR_get0(&aoid, ((void*)0), ((void*)0), pbe2->encryption);
        encnid = OBJ_obj2nid(aoid);
        BIO_printf(bio_err, ", %s, %s", OBJ_nid2ln(pbenid),
                   OBJ_nid2sn(encnid));

        if (pbenid == 69) {
            PBKDF2PARAM *kdf = ((void*)0);
            int prfnid;
            if (aparamtype == 16)
                kdf = ASN1_item_unpack(aparam, (&(PBKDF2PARAM_it)));
            if (kdf == ((void*)0)) {
                BIO_puts(bio_err, ", <unsupported parameters>");
                goto done;
            }
            ...
            if (kdf->prf == ((void*)0)) {
                ...
                X509_ALGOR_get0(&aoid, ((void*)0), ((void*)0), kdf->prf);
            ...
            SCRYPT_PARAMS *kdf = ((void*)0);

            if (aparamtype == 16)
                kdf = ASN1_item_unpack(aparam, (&(SCRYPT_PARAMS_it)));
            if (kdf == ((void*)0)) {
                BIO_puts(bio_err, ", <unsupported parameters>");
                goto done;
            }
        ...
        if (aparamtype == 16)
            pbe = ASN1_item_unpack(aparam, (&(PBEPARAM_it)));
        if (pbe == ((void*)0)) {
            BIO_puts(bio_err, ", <unsupported parameters>");
            goto done;
        }
...
int cert_load(BIO *in, struct stack_st_X509 *sk)
{
    ...
    X509 *cert;
    ret = 0;
    while ((cert = PEM_read_bio_X509(in, ((void*)0), ((void*)0), ((void*)0)))) {
        ret = 1;
    ...
    for (i = 0; i < sk_X509_ATTRIBUTE_num(attrlst); i++) {
        ...
        if (X509_ATTRIBUTE_count(attr)) {
            ...
            case 30:
                ...
                BIO_printf(out, "%s\n", value);
                CRYPTO_free(value, "apps/pkcs12.c", 912);
                break;
