...
int pkeyparam_main(int argc, char **argv)
{
 ...
 opthelp:
    ...
    in = bio_open_default(infile, 'r', (5 | 0x8000));
    if (in == ((void*)0))
        goto end;
    out = bio_open_default(outfile, 'w', (5 | 0x8000));
    if (out == ((void*)0))
        goto end;
