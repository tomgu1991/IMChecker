...
int pkeyutl_main(int argc, char **argv)
{
    ...
    char *infile = ((void*)0), *outfile = ((void*)0), *sigfile = ((void*)0), *passinarg = ((void*)0);
    char hexdump = 0, asn1parse = 0, rev = 0, *prog;
    unsigned char *buf_in = ((void*)0), *buf_out = ((void*)0), *sig = ((void*)0);
    OPTION_CHOICE o;
    int buf_inlen = 0, siglen = -1, keyform = (5 | 0x8000), peerform = (5 | 0x8000);
    int keysize = -1, pkey_op = (1<<3), key_type = 1;
    int engine_impl = 0;
    int ret = 1, rv = -1;
    size_t buf_outlen;
    const char *inkey = ((void*)0);
    const char *peerkey = ((void*)0);
    const char *kdfalg = ((void*)0);
    int kdflen = 0;
    struct stack_st_OPENSSL_STRING *pkeyopts = ((void*)0);
 ...
 opthelp:
        ...
        case OPT_PASSIN:
            ...
            break;
        case OPT_PEERFORM:
            if (!opt_format(opt_arg(), ((1L << 1) | (1L << 4)), &peerform))
                goto opthelp;
            break;
        case OPT_KEYFORM:
            if (!opt_format(opt_arg(), ((1L << 1) | (1L << 4)), &keyform))
                goto opthelp;
            break;
        ...
        case OPT_PKEYOPT:
            if ((pkeyopts == ((void*)0) &&
                 (pkeyopts = sk_OPENSSL_STRING_new_null()) == ((void*)0)) ||
    ...
    } else if (inkey == ((void*)0)) {
        BIO_printf(bio_err,
                   "%s: no private key given (-inkey parameter).\n", prog);
        goto opthelp;
    } else if (peerkey != ((void*)0) && pkey_op != (1<<10)) {
        BIO_printf(bio_err,
    ...
    if (peerkey != ((void*)0) && !setup_peer(ctx, peerform, peerkey, e)) {
    ...
    if (pkey_op != (1<<10)) {
        in = bio_open_default(infile, 'r', 2);
        if (in == ((void*)0))
            goto end;
    }
    out = bio_open_default(outfile, 'w', 2);
    if (out == ((void*)0))
        goto end;
    ...
    if (kdflen != 0) {
        ...
        rv = do_keyop(ctx, pkey_op, ((void*)0), (size_t *)&buf_outlen,
                      buf_in, (size_t)buf_inlen);
    }
    ...
    BIO_free(in);
    BIO_free_all(out);
    CRYPTO_free(buf_in, "apps/pkeyutl.c", 358);
    CRYPTO_free(buf_out, "apps/pkeyutl.c", 359);
    CRYPTO_free(sig, "apps/pkeyutl.c", 360);
                              ...
                              const int engine_impl)
{
    ...
    int rv = -1;
    X509 *x;
    if (((pkey_op == (1<<3)) || (pkey_op == (1<<9))
         || (pkey_op == (1<<10)))
        && (key_type != 1 && kdfalg == ((void*)0))) {
    ...
    CRYPTO_free(passin, "apps/pkeyutl.c", 468);
    return ctx;
