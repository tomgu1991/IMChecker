...
const OPTIONS s_time_options[] = {
    ...
    {"time", OPT_TIME, 'p', "Seconds to collect data, default " "30"},
...
int s_time_main(int argc, char **argv)
{
    ...
    char *host = "localhost:4433", *certfile = ((void*)0), *keyfile = ((void*)0), *prog;
    double totalTime = 0.0;
    int noCApath = 0, noCAfile = 0;
    int maxtime = 30, nConn = 0, perform = 3, ret = 1, i, st_bugs = 0;
 ...
 opthelp:
    ...
    if (SSL_CTX_ctrl(ctx, 124, max_version, ((void*)0)) == 0)
        goto end;

    if (st_bugs)
        SSL_CTX_set_options(ctx, (0x80000000U| 0x00000800U| 0x00000004U| 0x00000010U| 0x00000040U));
...
static SSL *doConnection(SSL *scon, const char *host, SSL_CTX *ctx)
{
    ...
    BIO_ctrl(conn,100,0, (char *)(host));
    BIO_ctrl(conn,155,(0x10),((void*)0));
...

    {
        ...
        if (fd >= 0)
            (void)setsockopt(fd, 1, 13, (char*)&no_linger,
                             sizeof(no_linger));
    }
