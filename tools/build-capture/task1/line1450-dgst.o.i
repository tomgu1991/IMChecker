...
{
    BIO *in = ((void*)0), *inp, *bmd = ((void*)0), *out = ((void*)0);
    ENGINE *e = ((void*)0), *impl = ((void*)0);
    EVP_PKEY *sigkey = ((void*)0);
    struct stack_st_OPENSSL_STRING *sigopts = ((void*)0), *macopts = ((void*)0);
    char *hmac_key = ((void*)0);
    char *mac_name = ((void*)0);
    char *passinarg = ((void*)0), *passin = ((void*)0);
    const EVP_MD *md = ((void*)0), *m;
    const char *outfile = ((void*)0), *keyfile = ((void*)0), *prog = ((void*)0);
    const char *sigfile = ((void*)0);
    OPTION_CHOICE o;
    int separator = 0, debug = 0, keyform = (5 | 0x8000), siglen = 0;
    int i, ret = 1, out_bin = -1, want_pub = 0, do_verify = 0;
    unsigned char *buf = ((void*)0), *sigbuf = ((void*)0);
    int engine_impl = 0;

    prog = opt_progname(argv[0]);
    buf = app_malloc(1024*8, "I/O buffer");
 ...
 opthelp:
    ...
    argc = opt_num_rest();
    argv = opt_rest();
    if (keyfile != ((void*)0) && argc > 1) {
        BIO_printf(bio_err, "%s: Can only sign or verify one file.\n", prog);
        goto end;
    }

    if (do_verify && sigfile == ((void*)0)) {
        BIO_printf(bio_err,
    ...
    out = bio_open_default(outfile, 'w', out_bin ? 2 : (1 | 0x8000));
    if (out == ((void*)0))
        goto end;

    if ((!(mac_name == ((void*)0)) + !(keyfile == ((void*)0)) + !(hmac_key == ((void*)0))) > 1) {
    ...
    if (keyfile != ((void*)0)) {
        ...
        if (want_pub)
            sigkey = load_pubkey(keyfile, keyform, 0, ((void*)0), e, "key file");
        else
 ...
 mac_end:
    ...
    if (hmac_key != ((void*)0)) {
        sigkey = EVP_PKEY_new_raw_private_key(855, impl,
    ...
    if (sigfile != ((void*)0) && sigkey != ((void*)0)) {
    ...
    if (md == ((void*)0)) {
        EVP_MD_CTX *tctx;
        BIO_ctrl(bmd,120,0, (char *)(&tctx));
        md = EVP_MD_CTX_md(tctx);
    }

    if (argc == 0) {
        BIO_ctrl(in,106,0x00,(char *)(stdin));
        ret = do_fp(out, buf, inp, separator, out_bin, sigkey, sigbuf,
                    siglen, ((void*)0), ((void*)0), "stdin");
    } else {
        const char *md_name = ((void*)0), *sig_name = ((void*)0);
        if (!out_bin) {
            if (sigkey != ((void*)0)) {
                const EVP_PKEY_ASN1_METHOD *ameth;
                ameth = EVP_PKEY_get0_asn1(sigkey);
                if (ameth)
                    EVP_PKEY_asn1_get0_info(((void*)0), ((void*)0),
                                            ((void*)0), ((void*)0), &sig_name, ameth);
            }
            if (md != ((void*)0))
                md_name = OBJ_nid2sn(EVP_MD_type(md));
        }
        ret = 0;
        for (i = 0; i < argc; i++) {
            int r;
            if ((int)BIO_ctrl(in,108, 0x01|0x02,(char *)(argv[i])) <= 0) {
                perror(argv[i]);
                ret++;
                continue;
            } else {
            ...
            if (r)
                ret = r;
            (void)(int)BIO_ctrl(bmd,1,0,((void*)0));
        }
    }
 end:
    CRYPTO_clear_free(buf, 1024*8, "apps/dgst.c", 403);
    BIO_free(in);
    CRYPTO_free(passin, "apps/dgst.c", 405);
    BIO_free_all(out);
    EVP_PKEY_free(sigkey);
    sk_OPENSSL_STRING_free(sigopts);
    sk_OPENSSL_STRING_free(macopts);
    CRYPTO_free(sigbuf, "apps/dgst.c", 410);
    BIO_free(bmd);
    release_engine(e);
    return ret;
}
          ...
          const char *file)
{
    ...
    if (key != ((void*)0)) {
        ...
        len = BIO_gets(bp, (char *)buf, 1024*8);
        if ((int)len < 0) {
            ERR_print_errors(bio_err);
            return 1;
        }
