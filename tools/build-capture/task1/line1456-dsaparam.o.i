...
typedef enum OPTION_choice {
    ...
    OPT_NOOUT, OPT_GENKEY, OPT_ENGINE, OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST
} OPTION_CHOICE;
 ...
 opthelp:
    ...
    if (C) {
        ...
        BIO_printf(bio_out, "    if (!dsa->p || !dsa->q || !dsa->g) {\n"
                            ...
                            "    }\n"
                            "    return(dsa);\n}\n");
        CRYPTO_free(data, "apps/dsaparam.c", 201);
    }
    ...
    if (!noout) {
        if (outformat == 4)
            i = (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_DSAparams : ((int (*)(const DSA *,unsigned char **))0))), out, ((void*) (1 ? dsa : (const DSA*)0))));
        else
