...
# 1 "/usr/local/bin/../lib/clang/3.9.0/include/stddef.h" 1 3
# 14 "include/openssl/asn1t.h" 2
# 468 "include/openssl/asn1t.h"
...
struct stack_st_ASN1_VALUE; typedef int (*sk_ASN1_VALUE_compfunc)(const ASN1_VALUE * const *a, const ASN1_VALUE *const *b); typedef void (*sk_ASN1_VALUE_freefunc)(ASN1_VALUE *a); typedef ASN1_VALUE * (*sk_ASN1_VALUE_copyfunc)(const ASN1_VALUE *a); static inline int sk_ASN1_VALUE_num(const struct stack_st_ASN1_VALUE *sk) { return OPENSSL_sk_num((const OPENSSL_STACK *)sk); } static inline ASN1_VALUE *sk_ASN1_VALUE_value(const struct stack_st_ASN1_VALUE *sk, int idx) { return (ASN1_VALUE *)OPENSSL_sk_value((const OPENSSL_STACK *)sk, idx); } static inline struct stack_st_ASN1_VALUE *sk_ASN1_VALUE_new(sk_ASN1_VALUE_compfunc compare) { return (struct stack_st_ASN1_VALUE *)OPENSSL_sk_new((OPENSSL_sk_compfunc)compare); } static inline struct stack_st_ASN1_VALUE *sk_ASN1_VALUE_new_null(void) { return (struct stack_st_ASN1_VALUE *)OPENSSL_sk_new_null(); } static inline struct stack_st_ASN1_VALUE *sk_ASN1_VALUE_new_reserve(sk_ASN1_VALUE_compfunc compare, int n) { return (struct stack_st_ASN1_VALUE *)OPENSSL_sk_new_reserve((OPENSSL_sk_compfunc)compare, n); } static inline int sk_ASN1_VALUE_reserve(struct stack_st_ASN1_VALUE *sk, int n) { return OPENSSL_sk_reserve((OPENSSL_STACK *)sk, n); } static inline void sk_ASN1_VALUE_free(struct stack_st_ASN1_VALUE *sk) { OPENSSL_sk_free((OPENSSL_STACK *)sk); } static inline void sk_ASN1_VALUE_zero(struct stack_st_ASN1_VALUE *sk) { OPENSSL_sk_zero((OPENSSL_STACK *)sk); } static inline ASN1_VALUE *sk_ASN1_VALUE_delete(struct stack_st_ASN1_VALUE *sk, int i) { return (ASN1_VALUE *)OPENSSL_sk_delete((OPENSSL_STACK *)sk, i); } static inline ASN1_VALUE *sk_ASN1_VALUE_delete_ptr(struct stack_st_ASN1_VALUE *sk, ASN1_VALUE *ptr) { return (ASN1_VALUE *)OPENSSL_sk_delete_ptr((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_ASN1_VALUE_push(struct stack_st_ASN1_VALUE *sk, ASN1_VALUE *ptr) { return OPENSSL_sk_push((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_ASN1_VALUE_unshift(struct stack_st_ASN1_VALUE *sk, ASN1_VALUE *ptr) { return OPENSSL_sk_unshift((OPENSSL_STACK *)sk, (const void *)ptr); } static inline ASN1_VALUE *sk_ASN1_VALUE_pop(struct stack_st_ASN1_VALUE *sk) { return (ASN1_VALUE *)OPENSSL_sk_pop((OPENSSL_STACK *)sk); } static inline ASN1_VALUE *sk_ASN1_VALUE_shift(struct stack_st_ASN1_VALUE *sk) { return (ASN1_VALUE *)OPENSSL_sk_shift((OPENSSL_STACK *)sk); } static inline void sk_ASN1_VALUE_pop_free(struct stack_st_ASN1_VALUE *sk, sk_ASN1_VALUE_freefunc freefunc) { OPENSSL_sk_pop_free((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc); } static inline int sk_ASN1_VALUE_insert(struct stack_st_ASN1_VALUE *sk, ASN1_VALUE *ptr, int idx) { return OPENSSL_sk_insert((OPENSSL_STACK *)sk, (const void *)ptr, idx); } static inline ASN1_VALUE *sk_ASN1_VALUE_set(struct stack_st_ASN1_VALUE *sk, int idx, ASN1_VALUE *ptr) { return (ASN1_VALUE *)OPENSSL_sk_set((OPENSSL_STACK *)sk, idx, (const void *)ptr); } static inline int sk_ASN1_VALUE_find(struct stack_st_ASN1_VALUE *sk, ASN1_VALUE *ptr) { return OPENSSL_sk_find((OPENSSL_STACK *)sk, (const void *)ptr); } static inline int sk_ASN1_VALUE_find_ex(struct stack_st_ASN1_VALUE *sk, ASN1_VALUE *ptr) { return OPENSSL_sk_find_ex((OPENSSL_STACK *)sk, (const void *)ptr); } static inline void sk_ASN1_VALUE_sort(struct stack_st_ASN1_VALUE *sk) { OPENSSL_sk_sort((OPENSSL_STACK *)sk); } static inline int sk_ASN1_VALUE_is_sorted(const struct stack_st_ASN1_VALUE *sk) { return OPENSSL_sk_is_sorted((const OPENSSL_STACK *)sk); } static inline struct stack_st_ASN1_VALUE * sk_ASN1_VALUE_dup(const struct stack_st_ASN1_VALUE *sk) { return (struct stack_st_ASN1_VALUE *)OPENSSL_sk_dup((const OPENSSL_STACK *)sk); } static inline struct stack_st_ASN1_VALUE *sk_ASN1_VALUE_deep_copy(const struct stack_st_ASN1_VALUE *sk, sk_ASN1_VALUE_copyfunc copyfunc, sk_ASN1_VALUE_freefunc freefunc) { return (struct stack_st_ASN1_VALUE *)OPENSSL_sk_deep_copy((const OPENSSL_STACK *)sk, (OPENSSL_sk_copyfunc)copyfunc, (OPENSSL_sk_freefunc)freefunc); } static inline sk_ASN1_VALUE_compfunc sk_ASN1_VALUE_set_cmp_func(struct stack_st_ASN1_VALUE *sk, sk_ASN1_VALUE_compfunc compare) { return (sk_ASN1_VALUE_compfunc)OPENSSL_sk_set_cmp_func((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare); }
...
{
    ASN1_TYPE *at = ((void*)0);
    BIO *in = ((void*)0), *b64 = ((void*)0), *derout = ((void*)0);
    BUF_MEM *buf = ((void*)0);
    struct stack_st_OPENSSL_STRING *osk = ((void*)0);
    char *genstr = ((void*)0), *genconf = ((void*)0);
    char *infile = ((void*)0), *oidfile = ((void*)0), *derfile = ((void*)0);
    unsigned char *str = ((void*)0);
    char *name = ((void*)0), *header = ((void*)0), *prog;
    const unsigned char *ctmpbuf;
    int indent = 0, noout = 0, dump = 0, strictpem = 0, informat = (5 | 0x8000);
    int offset = 0, ret = 1, i, j;
    long num, tmplen;
    unsigned char *tmpbuf;
    unsigned int length = 0;
    OPTION_CHOICE o;
    const ASN1_ITEM *it = ((void*)0);

    prog = opt_init(argc, argv, asn1parse_options);

    if ((osk = sk_OPENSSL_STRING_new_null()) == ((void*)0)) {
 ...
 opthelp:
        ...
        case OPT_OID:
            ...
            break;
        case OPT_OFFSET:
            offset = strtol(opt_arg(), ((void*)0), 0);
            break;
        case OPT_LENGTH:
            length = strtol(opt_arg(), ((void*)0), 0);
            break;
        case OPT_DUMP:
            dump = -1;
            break;
        case OPT_DLIMIT:
            dump = strtol(opt_arg(), ((void*)0), 0);
            break;
        case OPT_STRPARSE:
    ...
    if (oidfile != ((void*)0)) {
        in = bio_open_default(oidfile, 'r', (1 | 0x8000));
        if (in == ((void*)0))
            goto end;
    ...
    if ((in = bio_open_default(infile, 'r', informat)) == ((void*)0))
        goto end;

    if (derfile && (derout = bio_open_default(derfile, 'w', 4)) == ((void*)0))
        goto end;
    ...
    if (strictpem) {
        ...
        if (genstr || genconf) {
            ...
            num = 0;
            for (;;) {
                if (!BUF_MEM_grow(buf, num + 8192))
                    goto end;
                i = BIO_read(in, &(buf->data[num]), 8192);
                if (i <= 0)
                    break;
                num += i;
            }
    ...
    if (sk_OPENSSL_STRING_num(osk)) {
        ...
        for (i = 0; i < sk_OPENSSL_STRING_num(osk); i++) {
            ASN1_TYPE *atmp;
            int typ;
            j = strtol(sk_OPENSSL_STRING_value(osk, i), ((void*)0), 0);
            if (j <= 0 || j >= tmplen) {
            ...
            atmp = at;
            ctmpbuf = tmpbuf;
            at = d2i_ASN1_TYPE(((void*)0), &ctmpbuf, tmplen);
            ASN1_TYPE_free(atmp);
            if (!at) {
    ...
    if (!noout) {
        ...
        if (it != ((void*)0)) {
            ASN1_VALUE *value = ASN1_item_d2i(((void*)0), &p, length, it);
            if (value == ((void*)0)) {
                BIO_printf(bio_err, "Error parsing item %s\n", it->sname);
                ERR_print_errors(bio_err);
                goto end;
            }
            ASN1_item_print(bio_out, value, 0, it, ((void*)0));
    ...
    if (ret != 0)
        ERR_print_errors(bio_err);
    BUF_MEM_free(buf);
    CRYPTO_free(name, "apps/asn1pars.c", 304);
    CRYPTO_free(header, "apps/asn1pars.c", 305);
    if (strictpem)
        CRYPTO_free(str, "apps/asn1pars.c", 307);
    ASN1_TYPE_free(at);
