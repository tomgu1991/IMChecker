...
static void print_user(CA_DB *db, int userindex, int verbose)
{
    if (verbose > 0) {
        ...
        if (pp[0][0] != 'I') {
            ...
            print_entry(db, get_index(db, pp[4], 'I'), verbose,
                        "g N entry");
        }
...
static int update_index(CA_DB *db, char **row)
{
    ...
    irow = app_malloc(sizeof(*irow) * (6 + 1), "row pointers");
    for (i = 0; i < 6; i++)
        irow[i] = row[i];
    irow[6] = ((void*)0);
    ...
    if (!TXT_DB_insert(db->db, irow)) {
        ...
        CRYPTO_free(irow, "apps/srp.c", 108);
        return 0;
    }
    return 1;
}
                             ...
                             const char *passin, int verbose)
{
    ...
    if (len > 0) {
        ...
        (void)((srp_usersalt != ((void*)0)) ? 0 : (OPENSSL_die("assertion failed: " "srp_usersalt != NULL", "apps/srp.c", 145), 1));
        if ((gNid = SRP_create_verifier(user, password, &srp_usersalt,
            ...
            if (strcmp(verifier, srp_verifier))
                gNid = ((void*)0);
            CRYPTO_free(verifier, "apps/srp.c", 152);
        }
...
typedef enum OPTION_choice {
    ...
    OPT_PASSIN, OPT_PASSOUT, OPT_ENGINE, OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST
} OPTION_CHOICE;
...
int srp_main(int argc, char **argv)
{
    ...
    char *user = ((void*)0), *passinarg = ((void*)0), *passoutarg = ((void*)0);
    char *passin = ((void*)0), *passout = ((void*)0), *gN = ((void*)0), *userinfo = ((void*)0);
    char *section = ((void*)0);
    char **gNrow = ((void*)0), *configfile = ((void*)0);
    char *srpvfile = ((void*)0), **pp, *prog;
    OPTION_CHOICE o;
 ...
 opthelp:
    ...
    if (srpvfile != ((void*)0) && configfile != ((void*)0)) {
        BIO_printf(bio_err,
    ...
    if ((passinarg != ((void*)0) || passoutarg != ((void*)0)) && argc != 1) {
        BIO_printf(bio_err,
    ...
    if (srpvfile == ((void*)0)) {
        ...
        if (section == ((void*)0)) {
            if (verbose)
                BIO_printf(bio_err,
                           "trying to read " "default_srp"
                           " in " "srp" "\n");

            section = lookup_conf(conf, "srp", "default_srp");
            if (section == ((void*)0))
                goto end;
        }

        app_RAND_load_conf(conf, "srp");
        ...
        srpvfile = lookup_conf(conf, section, "srpvfile");
        if (srpvfile == ((void*)0))
            goto end;
    }
    ...
    for (i = 0; i < sk_OPENSSL_PSTRING_num(db->db->data); i++) {
        ...
        if (pp[0][0] == 'I') {
            maxgN = i;
            if ((gNindex < 0) && (gN != ((void*)0)) && strcmp(gN, pp[3]) == 0)
                gNindex = i;
    ...
    while (mode == OPT_LIST || user != ((void*)0)) {
        int userindex = -1;

        if (user != ((void*)0) && verbose > 1)
        ...
        if (mode == OPT_LIST) {
            ...
            if (userindex >= 0) {
                ...
                if (!
                    (gNid =
                     srp_create_user(user, &(row[1]),
                                     &(row[2]),
                                     gNrow ? gNrow[2] : gN,
                                     gNrow ? gNrow[1] : ((void*)0),
                                     passout, verbose))) {
                    BIO_printf(bio_err,
                ...
                row[3] = CRYPTO_strdup(user, "apps/srp.c", 446);
                row[0] = CRYPTO_strdup("v", "apps/srp.c", 447);
                row[4] = CRYPTO_strdup(gNid, "apps/srp.c", 448);
                ...
                if ((row[3] == ((void*)0))
                    ...
                    || (row[2] == ((void*)0))
                    || (userinfo
                        && ((row[5] = CRYPTO_strdup(userinfo, "apps/srp.c", 456)) == ((void*)0)))
                    || !update_index(db, row)) {
                    CRYPTO_free(row[3], "apps/srp.c", 458);
                    CRYPTO_free(row[4], "apps/srp.c", 459);
                    CRYPTO_free(row[5], "apps/srp.c", 460);
                    CRYPTO_free(row[0], "apps/srp.c", 461);
                    CRYPTO_free(row[1], "apps/srp.c", 462);
                    CRYPTO_free(row[2], "apps/srp.c", 463);
                    goto end;
                }
                doupdatedb = 1;
            }
            ...
            if (userindex < 0) {
                ...
                if (type == 'v') {
                    ...
                    row[0][0] = 'v';
                    row[4] = CRYPTO_strdup(gNid, "apps/srp.c", 531);
                    ...
                    if (row[3] == ((void*)0)
                        ...
                        || row[2] == ((void*)0)
                        || (userinfo
                            && ((row[5] = CRYPTO_strdup(userinfo, "apps/srp.c", 539))
                                == ((void*)0))))
                        goto end;
    ...
    CRYPTO_free(passin, "apps/srp.c", 604);
    CRYPTO_free(passout, "apps/srp.c", 605);
    if (ret)
