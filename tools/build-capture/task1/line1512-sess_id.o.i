...
int sess_id_main(int argc, char **argv)
{
    ...
    int informat = (5 | 0x8000), outformat = (5 | 0x8000);
 ...
 opthelp:
        ...
        case OPT_INFORM:
            ...
            break;
        case OPT_OUTFORM:
            if (!opt_format(opt_arg(), (1L << 1) | (1L << 7),
                            &outformat))
                goto opthelp;
            break;
        case OPT_IN:
    ...
    if (!noout && !cert) {
        if (outformat == 4) {
            i = (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_SSL_SESSION : ((int (*)(SSL_SESSION *,unsigned char **))0))), out, ((void*) (1 ? x : (SSL_SESSION*)0))));
        } else if (outformat == (5 | 0x8000)) {
            i = PEM_write_bio_SSL_SESSION(out, x);
        } else if (outformat == 14) {
...
static SSL_SESSION *load_sess_id(char *infile, int format)
{
    ...
    if (in == ((void*)0))
        goto end;
    if (format == 4)
        x = ((SSL_SESSION*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? SSL_SESSION_new : ((SSL_SESSION *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_SSL_SESSION : ((SSL_SESSION *(*)(SSL_SESSION **,const unsigned char **,long))0))), in, ((void**) (1 ? ((void*)0) : (SSL_SESSION**)0))));
    else
