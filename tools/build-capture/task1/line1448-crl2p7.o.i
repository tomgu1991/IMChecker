...
static int add_certs_from_file(struct stack_st_X509 *stack, char *certfile);
...
int crl2pkcs7_main(int argc, char **argv)
{
    ...
    PKCS7 *p7 = ((void*)0);
    PKCS7_SIGNED *p7s = ((void*)0);
    struct stack_st_OPENSSL_STRING *certflst = ((void*)0);
    struct stack_st_X509 *cert_stack = ((void*)0);
    struct stack_st_X509_CRL *crl_stack = ((void*)0);
    X509_CRL *crl = ((void*)0);
    char *infile = ((void*)0), *outfile = ((void*)0), *prog, *certfile;
    int i = 0, informat = (5 | 0x8000), outformat = (5 | 0x8000), ret = 1, nocrl =
        0;
    OPTION_CHOICE o;
 ...
 opthelp:
        ...
        case OPT_CERTFILE:
            if ((certflst == ((void*)0))
                && (certflst = sk_OPENSSL_STRING_new_null()) == ((void*)0))
                goto end;
    ...
    if (!nocrl) {
        ...
        if (informat == 4)
            crl = d2i_X509_CRL_bio(in, ((void*)0));
        else if (informat == (5 | 0x8000))
            crl = PEM_read_bio_X509_CRL(in, ((void*)0), ((void*)0), ((void*)0));
        if (crl == ((void*)0)) {
    ...
    if ((p7 = PKCS7_new()) == ((void*)0))
        goto end;
    if ((p7s = PKCS7_SIGNED_new()) == ((void*)0))
        goto end;
    p7->type = OBJ_nid2obj(22);
    p7->d.sign = p7s;
    p7s->contents->type = OBJ_nid2obj(21);

    if (!ASN1_INTEGER_set(p7s->version, 1))
        goto end;
    if ((crl_stack = sk_X509_CRL_new_null()) == ((void*)0))
        goto end;
    p7s->crl = crl_stack;
    if (crl != ((void*)0)) {
    ...
    if ((cert_stack = sk_X509_new_null()) == ((void*)0))
        goto end;
    p7s->cert = cert_stack;
...
static int add_certs_from_file(struct stack_st_X509 *stack, char *certfile)
{
    ...
    int count = 0;
    int ret = -1;
    struct stack_st_X509_INFO *sk = ((void*)0);
    X509_INFO *xi;
    ...
    sk = PEM_X509_INFO_read_bio(in, ((void*)0), ((void*)0), ((void*)0));
    if (sk == ((void*)0)) {
