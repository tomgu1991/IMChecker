...
int passwd_main(int argc, char **argv)
{
 ...
 opthelp:
    ...
    if (infile != ((void*)0) || in_stdin) {
        ...
        in = bio_open_default(infile, 'r', (1 | 0x8000));
        if (in == ((void*)0))
            goto end;
    }
    ...
    CRYPTO_free(salt_malloc, "apps/passwd.c", 296);
    CRYPTO_free(passwd_malloc, "apps/passwd.c", 297);
    BIO_free(in);
    return ret;
}
# 311 "apps/passwd.c"
...
# 350 "apps/passwd.c"
 ...
 err:
    CRYPTO_free(ascii_passwd, "apps/passwd.c", 482);
    EVP_MD_CTX_free(md2);
    EVP_MD_CTX_free(md);
    return ((void*)0);
}
...
# 583 "apps/passwd.c"
    ...
    md = EVP_MD_CTX_new();
    if (md == ((void*)0)
        || !EVP_DigestInit_ex(md, sha, ((void*)0))
        || !EVP_DigestUpdate(md, passwd, passwd_len)
    ...
    md2 = EVP_MD_CTX_new();
    if (md2 == ((void*)0)
        || !EVP_DigestInit_ex(md2, sha, ((void*)0))
        || !EVP_DigestUpdate(md2, passwd, passwd_len)
        || !EVP_DigestUpdate(md2, ascii_salt, salt_len)
        || !EVP_DigestUpdate(md2, passwd, passwd_len)
        || !EVP_DigestFinal_ex(md2, buf, ((void*)0)))
    ...
    if (!EVP_DigestInit_ex(md2, sha, ((void*)0)))
        goto err;
    ...
    if (!EVP_DigestFinal_ex(md2, temp_buf, ((void*)0)))
        return ((void*)0);

    if ((p_bytes = CRYPTO_zalloc(passwd_len, "apps/passwd.c", 649)) == ((void*)0))
        goto err;
    ...
    if ((s_bytes = CRYPTO_zalloc(salt_len, "apps/passwd.c", 666)) == ((void*)0))
        goto err;
    ...
    md2 = ((void*)0);
    md = ((void*)0);
    CRYPTO_free(p_bytes, "apps/passwd.c", 698);
    CRYPTO_free(s_bytes, "apps/passwd.c", 699);
    p_bytes = ((void*)0);
    s_bytes = ((void*)0);
...
# 717 "apps/passwd.c"
    switch (magic[0]) {
    case '5':
        do { unsigned int w = ((buf[0]) << 16) | ((buf[10]) << 8) | (buf[20]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[21]) << 16) | ((buf[1]) << 8) | (buf[11]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[12]) << 16) | ((buf[22]) << 8) | (buf[2]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[3]) << 16) | ((buf[13]) << 8) | (buf[23]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[24]) << 16) | ((buf[4]) << 8) | (buf[14]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[15]) << 16) | ((buf[25]) << 8) | (buf[5]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[6]) << 16) | ((buf[16]) << 8) | (buf[26]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[27]) << 16) | ((buf[7]) << 8) | (buf[17]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[18]) << 16) | ((buf[28]) << 8) | (buf[8]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[9]) << 16) | ((buf[19]) << 8) | (buf[29]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((0) << 16) | ((buf[31]) << 8) | (buf[30]); int i = (3); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        break;
    case '6':
        do { unsigned int w = ((buf[0]) << 16) | ((buf[21]) << 8) | (buf[42]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[22]) << 16) | ((buf[43]) << 8) | (buf[1]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[44]) << 16) | ((buf[2]) << 8) | (buf[23]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[3]) << 16) | ((buf[24]) << 8) | (buf[45]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[25]) << 16) | ((buf[46]) << 8) | (buf[4]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[47]) << 16) | ((buf[5]) << 8) | (buf[26]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[6]) << 16) | ((buf[27]) << 8) | (buf[48]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[28]) << 16) | ((buf[49]) << 8) | (buf[7]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[50]) << 16) | ((buf[8]) << 8) | (buf[29]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[9]) << 16) | ((buf[30]) << 8) | (buf[51]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[31]) << 16) | ((buf[52]) << 8) | (buf[10]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[53]) << 16) | ((buf[11]) << 8) | (buf[32]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[12]) << 16) | ((buf[33]) << 8) | (buf[54]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[34]) << 16) | ((buf[55]) << 8) | (buf[13]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[56]) << 16) | ((buf[14]) << 8) | (buf[35]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[15]) << 16) | ((buf[36]) << 8) | (buf[57]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[37]) << 16) | ((buf[58]) << 8) | (buf[16]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[59]) << 16) | ((buf[17]) << 8) | (buf[38]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[18]) << 16) | ((buf[39]) << 8) | (buf[60]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[40]) << 16) | ((buf[61]) << 8) | (buf[19]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((buf[62]) << 16) | ((buf[20]) << 8) | (buf[41]); int i = (4); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        do { unsigned int w = ((0) << 16) | ((0) << 8) | (buf[63]); int i = (2); while (i-- > 0) { *cp++ = cov_2char[w & 0x3f]; w >>= 6; } } while (0);
        break;
    default:
        goto err;
    }
 ...
 err:
    EVP_MD_CTX_free(md2);
    EVP_MD_CTX_free(md);
    CRYPTO_free(p_bytes, "apps/passwd.c", 768);
    CRYPTO_free(s_bytes, "apps/passwd.c", 769);
    CRYPTO_free(ascii_passwd, "apps/passwd.c", 770);
    return ((void*)0);
}
