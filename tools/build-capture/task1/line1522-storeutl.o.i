...
int storeutl_main(int argc, char *argv[])
{
    ...
    char *outfile = ((void*)0), *passin = ((void*)0), *passinarg = ((void*)0);
    BIO *out = ((void*)0);
    ENGINE *e = ((void*)0);
    OPTION_CHOICE o;
    ...
    int expected = 0;
    int criterion = 0;
    X509_NAME *subject = ((void*)0), *issuer = ((void*)0);
    ASN1_INTEGER *serial = ((void*)0);
    unsigned char *fingerprint = ((void*)0);
    size_t fingerprintlen = 0;
    char *alias = ((void*)0);
    OSSL_STORE_SEARCH *search = ((void*)0);
 ...
 opthelp:
        ...
        case OPT_SEARCHFOR_CRLS:
            ...
            }
            {
                static const struct {
                    ...
                    {OPT_SEARCHFOR_CERTS, 4},
                    {OPT_SEARCHFOR_KEYS, 3},
                    {OPT_SEARCHFOR_CRLS, 5},
                };
                size_t i;
                ...
                (void)((expected != 0) ? 0 : (OPENSSL_die("assertion failed: " "expected != 0", "apps/storeutl.c", 130), 1));
            }
            break;
        case OPT_CRITERION_SUBJECT:
            ...
            if ((subject = parse_name(opt_arg(), (0x1000), 1)) == ((void*)0)) {
        ...
        case OPT_CRITERION_ISSUER:
            ...
            if ((issuer = parse_name(opt_arg(), (0x1000), 1)) == ((void*)0)) {
        ...
        case OPT_CRITERION_SERIAL:
            ...
            if ((serial = s2i_ASN1_INTEGER(((void*)0), opt_arg())) == ((void*)0)) {
        ...
        case OPT_CRITERION_ALIAS:
            ...
            if ((alias = CRYPTO_strdup(opt_arg(), "apps/storeutl.c", 230)) == ((void*)0)) {
    ...
    if (criterion != 0) {
        switch (criterion) {
        case 1:
            if ((search = OSSL_STORE_SEARCH_by_name(subject)) == ((void*)0)) {
        ...
        case 3:
            ...
            break;
        case 4:
            if ((search = OSSL_STORE_SEARCH_by_alias(alias)) == ((void*)0)) {
                ERR_print_errors(bio_err);
                goto end;
            }
            break;
    ...
    CRYPTO_free(fingerprint, "apps/storeutl.c", 311);
    CRYPTO_free(alias, "apps/storeutl.c", 312);
    ASN1_INTEGER_free(serial);
    X509_NAME_free(subject);
    X509_NAME_free(issuer);
    OSSL_STORE_SEARCH_free(search);
    BIO_free_all(out);
    CRYPTO_free(passin, "apps/storeutl.c", 318);
    release_engine(e);
    return ret;
}
