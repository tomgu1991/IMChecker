...
{
    ENGINE *e = ((void*)0);
    BIGNUM *ec_gen = ((void*)0), *ec_order = ((void*)0), *ec_cofactor = ((void*)0);
    BIGNUM *ec_p = ((void*)0), *ec_a = ((void*)0), *ec_b = ((void*)0);
    BIO *in = ((void*)0), *out = ((void*)0);
    EC_GROUP *group = ((void*)0);
    point_conversion_form_t form = POINT_CONVERSION_UNCOMPRESSED;
    char *curve_name = ((void*)0);
    char *infile = ((void*)0), *outfile = ((void*)0), *prog;
    unsigned char *buffer = ((void*)0);
    OPTION_CHOICE o;
    int asn1_flag = 0x001, new_asn1_flag = 0;
    int informat = (5 | 0x8000), outformat = (5 | 0x8000), noout = 0, C = 0;
    int ret = 1, private = 0;
 ...
 opthelp:
    ...
    if (list_curves) {
        EC_builtin_curve *curves = ((void*)0);
        size_t crv_len = EC_get_builtin_curves(((void*)0), 0);
        size_t n;

        curves = app_malloc((int)sizeof(*curves) * crv_len, "list curves");
        if (!EC_get_builtin_curves(curves, crv_len)) {
            CRYPTO_free(curves, "apps/ecparam.c", 185);
            goto end;
        }
        ...
        CRYPTO_free(curves, "apps/ecparam.c", 203);
        ret = 0;
        goto end;
    }

    if (curve_name != ((void*)0)) {
        int nid;
        ...
        group = ((EC_GROUP*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? ((void*)0) : ((EC_GROUP *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_ECPKParameters : ((EC_GROUP *(*)(EC_GROUP **,const unsigned char **,long))0))), in, ((void**) (1 ? ((void*)0) : (EC_GROUP**)0))));
    } else {
        group = PEM_read_bio_ECPKParameters(in, ((void*)0), ((void*)0), ((void*)0));
    }
    if (group == ((void*)0)) {
    ...
    if (no_seed) {
        EC_GROUP_set_seed(group, ((void*)0), 0);
    }
    ...
    if (check) {
        ...
        if (!EC_GROUP_check(group, ((void*)0))) {
    ...
    if (C) {
        ...
        if ((ec_p = BN_new()) == ((void*)0)
                || (ec_a = BN_new()) == ((void*)0)
                || (ec_b = BN_new()) == ((void*)0)
                || (ec_gen = BN_new()) == ((void*)0)
                || (ec_order = BN_new()) == ((void*)0)
                || (ec_cofactor = BN_new()) == ((void*)0)) {
            perror("Can't allocate BN");
            goto end;
        }

        is_prime = (EC_METHOD_get_field_type(meth) == 406);
        if (!is_prime) {
            BIO_printf(bio_err, "Can only handle X9.62 prime fields\n");
            goto end;
        }

        if (!EC_GROUP_get_curve_GFp(group, ec_p, ec_a, ec_b, ((void*)0)))
            goto end;
        ...
        if (!EC_POINT_point2bn(group, point,
                               ...
                               ec_gen, ((void*)0)))
            goto end;
        if (!EC_GROUP_get_order(group, ec_order, ((void*)0)))
            goto end;
        if (!EC_GROUP_get_cofactor(group, ec_cofactor, ((void*)0)))
            goto end;
        ...
        if ((tmp_len = (size_t)((BN_num_bits(ec_p)+7)/8)) > buf_len)
            buf_len = tmp_len;
        if ((tmp_len = (size_t)((BN_num_bits(ec_a)+7)/8)) > buf_len)
            buf_len = tmp_len;
        if ((tmp_len = (size_t)((BN_num_bits(ec_b)+7)/8)) > buf_len)
            buf_len = tmp_len;
        if ((tmp_len = (size_t)((BN_num_bits(ec_gen)+7)/8)) > buf_len)
            buf_len = tmp_len;
        if ((tmp_len = (size_t)((BN_num_bits(ec_order)+7)/8)) > buf_len)
            buf_len = tmp_len;
        if ((tmp_len = (size_t)((BN_num_bits(ec_cofactor)+7)/8)) > buf_len)
            buf_len = tmp_len;
    ...
    if (outformat == 4 && genkey)
        noout = 1;

    if (!noout) {
        if (outformat == 4)
            i = (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_ECPKParameters : ((int (*)(const EC_GROUP *,unsigned char **))0))), out, ((void*) (1 ? group : (const EC_GROUP*)0))));
        else
    ...
    if (genkey) {
        ...
        if (outformat == 4)
            ...
            i = PEM_write_bio_ECPrivateKey(out, eckey, ((void*)0),
    ...
    BN_free(ec_order);
    BN_free(ec_cofactor);
    CRYPTO_free(buffer, "apps/ecparam.c", 442);
    EC_GROUP_free(group);
    release_engine(e);
    BIO_free(in);
    BIO_free_all(out);
