...
# 49 "apps/s_client.c" 2
# 1 "apps/timeouts.h" 1
# 50 "apps/s_client.c" 2
...
static BIO *bio_c_out = ((void*)0);
static int c_quiet = 0;
static char *sess_out = ((void*)0);
                                  ...
                                  unsigned int max_psk_len)
{
    ...
    if (max_psk_len > 2147483647 || key_len > (long)max_psk_len) {
        BIO_printf(bio_err,
                   "psk buffer of callback is too small (%d) for key (%ld)\n",
                   max_psk_len, key_len);
        CRYPTO_free(key, "apps/s_client.c", 159);
        return 0;
    }

    memcpy(psk, key, key_len);
    CRYPTO_free(key, "apps/s_client.c", 164);
                              ...
                              SSL_SESSION **sess)
{
    ...
    if (psksess != ((void*)0)) {
        ...
        if (cipher == ((void*)0)) {
            ...
            CRYPTO_free(key, "apps/s_client.c", 204);
            return 0;
        }
        ...
        if (usesess == ((void*)0)
                ...
                || !SSL_SESSION_set_protocol_version(usesess, 0x0304)) {
            CRYPTO_free(key, "apps/s_client.c", 213);
            goto err;
        }
        CRYPTO_free(key, "apps/s_client.c", 216);
    }
...
static int ssl_servername_cb(SSL *s, int *ad, void *arg)
{
    ...
    const char *hn = SSL_get_servername(s, 0);
...
static int srp_Verify_N_and_g(const BIGNUM *N, const BIGNUM *g)
{
    ...
    int ret =
        ...
        BN_is_prime_ex(N, 64, bn_ctx, ((void*)0)) == 1 &&
        p != ((void*)0) && BN_rshift1(p, N) &&

        BN_is_prime_ex(p, 64, bn_ctx, ((void*)0)) == 1 &&
        r != ((void*)0) &&
...
static int ssl_srp_verify_param_cb(SSL *s, void *arg)
{
    ...
    if (srp_arg->amp == 1) {
        ...
        if (BN_num_bits(g) <= ((8 * 8) * 2) && srp_Verify_N_and_g(N, g))
            return 1;
    }
...
{
    SRP_ARG *srp_arg = (SRP_ARG *)arg;
    char *pass = app_malloc(1024 + 1, "SRP password buffer");
    PW_CB_DATA cb_tmp;
    int l;

    cb_tmp.password = (char *)srp_arg->srppassin;
    cb_tmp.prompt_info = "SRP user";
    if ((l = password_callback(pass, 1024, 0, &cb_tmp)) < 0) {
        BIO_printf(bio_err, "Can't read Password\n");
        CRYPTO_free(pass, "apps/s_client.c", 361);
        return ((void*)0);
    }
    *(pass + l) = '\0';
...
static ssize_t hexdecode(const char **inptr, void *result)
{
    ...
    for (byte = 0; *in; ++in) {
        ...
        if (((*__ctype_b_loc ())[(int) ((((unsigned char)(*in))))] & (unsigned short int) _ISspace))
            continue;
        x = OPENSSL_hexchar2int(*in);
        if (x < 0) {
            CRYPTO_free(ret, "apps/s_client.c", 450);
            return 0;
        }
        byte |= (char)x;
        if ((nibble ^= 1) == 0) {
    ...
    if (nibble != 0) {
        CRYPTO_free(ret, "apps/s_client.c", 462);
        return 0;
    }
    *inptr = in;
...
static ssize_t checked_uint8(const char **inptr, void *out)
{
    ...
    if (((v == (-9223372036854775807L -1L) || v == 9223372036854775807L) && e == 34) ||
        endp == in || !((*__ctype_b_loc ())[(int) ((((unsigned char)(*endp))))] & (unsigned short int) _ISspace) ||
        v != (*result = (uint8_t) v)) {
        return -1;
    }
    for (in = endp; ((*__ctype_b_loc ())[(int) ((((unsigned char)(*in))))] & (unsigned short int) _ISspace); ++in)
        continue;
...
struct tlsa_field {
    void *var;
    const char *name;
    ssize_t (*parser)(const char **, void *);
};
...
static int tlsa_import_rr(SSL *con, const char *rrdata)
{
    ...
    CRYPTO_free(data, "apps/s_client.c", 533);
...
static int tlsa_import_rrset(SSL *con, struct stack_st_OPENSSL_STRING *rrset)
{
...
{
    CRYPTO_free(*dest, "apps/s_client.c", 841);
    *dest = ((void*)0);
    if (source != ((void*)0))
        *dest = CRYPTO_strdup(source, "apps/s_client.c", 844);
}
...
int s_client_main(int argc, char **argv)
{
    ...
    SSL *con = ((void*)0);
    SSL_CTX *ctx = ((void*)0);
    struct stack_st_X509 *chain = ((void*)0);
    X509 *cert = ((void*)0);
    X509_VERIFY_PARAM *vpm = ((void*)0);
    SSL_EXCERT *exc = ((void*)0);
    SSL_CONF_CTX *cctx = ((void*)0);
    struct stack_st_OPENSSL_STRING *ssl_args = ((void*)0);
    char *dane_tlsa_domain = ((void*)0);
    struct stack_st_OPENSSL_STRING *dane_tlsa_rrset = ((void*)0);
    int dane_ee_no_name = 0;
    struct stack_st_X509_CRL *crls = ((void*)0);
    const SSL_METHOD *meth = TLS_client_method();
    const char *CApath = ((void*)0), *CAfile = ((void*)0);
    char *cbuf = ((void*)0), *sbuf = ((void*)0);
    char *mbuf = ((void*)0), *proxystr = ((void*)0), *connectstr = ((void*)0), *bindstr = ((void*)0);
    char *cert_file = ((void*)0), *key_file = ((void*)0), *chain_file = ((void*)0);
    char *chCApath = ((void*)0), *chCAfile = ((void*)0), *host = ((void*)0);
    char *port = CRYPTO_strdup("4433", "apps/s_client.c", 887);
    char *bindhost = ((void*)0), *bindport = ((void*)0);
    char *passarg = ((void*)0), *pass = ((void*)0), *vfyCApath = ((void*)0), *vfyCAfile = ((void*)0);
    char *ReqCAfile = ((void*)0);
    char *sess_in = ((void*)0), *crl_file = ((void*)0), *p;
    const char *protohost = ((void*)0);
    struct timeval timeout, *timeoutp;
    fd_set readfds, writefds;
    int noCApath = 0, noCAfile = 0;
    int build_chain = 0, cbuf_len, cbuf_off, cert_format = (5 | 0x8000);
    int key_format = (5 | 0x8000), crlf = 0, full_log = 1, mbuf_len = 0;
    int prexit = 0;
    int sdebug = 0;
    int reconnect = 0, verify = 0x00, vpmtouched = 0;
    int ret = 1, in_init = 1, i, nbio_test = 0, s = -1, k, width, state = 0;
    int sbuf_len, sbuf_off, cmdletters = 1;
    int socket_family = 0, socket_type = SOCK_STREAM, protocol = 0;
    int starttls_proto = PROTO_OFF, crl_format = (5 | 0x8000), crl_download = 0;
    ...
    ENGINE *ssl_client_engine = ((void*)0);

    ENGINE *e = ((void*)0);



    const char *servername = ((void*)0);
    int noservername = 0;
    const char *alpn_in = ((void*)0);
    tlsextctx tlsextcbp = { ((void*)0), 0 };
    ...
    char *srppass = ((void*)0);
    int srp_lateuser = 0;
    SRP_ARG srp_arg = { ((void*)0), ((void*)0), 0, 0, 0, 1024 };


    char *srtp_profiles = ((void*)0);


    char *ctlog_file = ((void*)0);
    int ct_validation = 0;
    ...
    BIO *bio_c_msg = ((void*)0);
    const char *keylog_file = ((void*)0), *early_data_file = ((void*)0);
    ...
    do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&writefds)->__fds_bits)[0]) : "memory"); } while (0);
# 976 "apps/s_client.c"
    ...
    if (vpm == ((void*)0) || cctx == ((void*)0)) {
        BIO_printf(bio_err, "%s: out of memory\n", prog);
        goto end;
    }

    cbuf = app_malloc(1024*8, "cbuf");
    sbuf = app_malloc(1024*8, "sbuf");
    mbuf = app_malloc(1024*8, "mbuf");

    SSL_CONF_CTX_set_flags(cctx, 0x4 | 0x1);

    prog = opt_init(argc, argv, s_client_options);
    while ((o = opt_next()) != OPT_EOF) {

        if (connect_type == use_unix && (o == OPT_4 || o == OPT_6 || o == OPT_HOST || o == OPT_PORT || o == OPT_CONNECT)) {
            BIO_printf(bio_err,
                       "%s: Intermixed protocol flags (unix and internet domains)\n",
                       prog);
            goto end;
        }
        if (connect_type == use_inet && (o == OPT_UNIX)) {
            BIO_printf(bio_err,
 ...
 opthelp:
        ...
        case OPT_SESS_IN:
            ...
            break;
        case OPT_CERTFORM:
            if (!opt_format(opt_arg(), (1L << 1), &cert_format))
                goto opthelp;
            break;
        case OPT_CRLFORM:
        ...
        case OPT_FALLBACKSCSV:
            ...
            break;
        case OPT_KEYFORM:
            if (!opt_format(opt_arg(), ((1L << 1) | (1L << 4)), &key_format))
                goto opthelp;
            break;
        case OPT_PASS:
            passarg = opt_arg();
    ...
    if (proxystr != ((void*)0)) {
        ...
        if (tmp_host != host)
            CRYPTO_free(tmp_host, "apps/s_client.c", 1537);
        if (tmp_port != port)
            CRYPTO_free(tmp_port, "apps/s_client.c", 1539);
        if (!res) {
            BIO_printf(bio_err,
        ...
        if (connectstr != ((void*)0))
            res = BIO_parse_hostserv(connectstr, &host, &port,
                                     BIO_PARSE_PRIO_HOST);
        if (tmp_host != host)
            CRYPTO_free(tmp_host, "apps/s_client.c", 1552);
        if (tmp_port != port)
            CRYPTO_free(tmp_port, "apps/s_client.c", 1554);
        if (!res) {
            BIO_printf(bio_err,
...
# 1595 "apps/s_client.c"
    ...
    if (chain_file != ((void*)0)) {
        if (!load_certs(chain_file, &chain, (5 | 0x8000), ((void*)0),
    ...
    if (bio_c_out == ((void*)0)) {
        if (c_quiet && !c_debug) {
            ...
            if (c_msg && bio_c_msg == ((void*)0))
                bio_c_msg = dup_bio_out((1 | 0x8000));
        } else if (bio_c_out == ((void*)0))
            bio_c_out = dup_bio_out((1 | 0x8000));
    }

    if (!app_passwd(srppass, ((void*)0), &srp_arg.srppassin, ((void*)0))) {
        BIO_printf(bio_err, "Error getting password\n");
        goto end;
    }
    ...
    if (ReqCAfile != ((void*)0)) {
        struct stack_st_X509_NAME *nm = sk_X509_NAME_new_null();

        if (nm == ((void*)0) || !SSL_add_file_cert_subjects_to_stack(nm, ReqCAfile)) {
    ...
    if (alpn_in) {
        ...
        CRYPTO_free(alpn, "apps/s_client.c", 1832);
    }
    ...
    for (i = 0; i < serverinfo_count; i++) {
        if (!SSL_CTX_add_client_custom_ext(ctx,
                                           ...
                                           serverinfo_cli_parse_cb, ((void*)0))) {
            BIO_printf(bio_err,
    ...
    if (sess_out != ((void*)0)) {
        SSL_CTX_ctrl(ctx,44,0x0001 | 0x0200,((void*)0));
    ...
    if (sess_in != ((void*)0)) {
        ...
        sess = PEM_read_bio_SSL_SESSION(stmp, ((void*)0), 0, ((void*)0));
        BIO_free(stmp);
        if (sess == ((void*)0)) {
            BIO_printf(bio_err, "Can't open session file %s\n", sess_in);
            ERR_print_errors(bio_err);
    ...
    if (fallback_scsv)
        SSL_ctrl((con),33,(0x00000080U),((void*)0));

    if (!noservername && (servername != ((void*)0) || dane_tlsa_domain == ((void*)0))) {
        if (servername == ((void*)0))
            servername = (host == ((void*)0)) ? "localhost" : host;
        if (!SSL_ctrl(con,55,0, (void *)servername)) {
    ...
    if (dane_tlsa_domain != ((void*)0)) {
        ...
        if (dane_ee_no_name)
            SSL_dane_set_flags(con, (1L << 0));
    } else if (dane_tlsa_rrset != ((void*)0)) {
 ...
 re_start:
    ...
    if (isdtls) {
        ...
        if ((peer_info.addr = BIO_ADDR_new()) == ((void*)0)) {
        ...
        (void)(int)BIO_ctrl(sbio, 32, 0, (char *)(peer_info.addr));
        BIO_ADDR_free(peer_info.addr);
        peer_info.addr = ((void*)0);
    ...
    if (c_msg) {
        ...
        SSL_ctrl((con), 16, 0, (bio_c_msg ? bio_c_msg : bio_c_out));
    }

    if (c_tlsextdebug) {
        SSL_callback_ctrl(con,56, (void (*)(void))tlsext_cb);
        SSL_ctrl(con,57,0,bio_c_out);
    }

    if (c_status_req) {
        SSL_ctrl(con,65,1,((void*)0));
        SSL_CTX_callback_ctrl(ctx,63, (void (*)(void))ocsp_resp_cb);
        SSL_CTX_ctrl(ctx,64,0,bio_c_out);
    }
...
# 2142 "apps/s_client.c"
            ...
            do {
                mbuf_len = BIO_gets(fbio, mbuf, 1024*8);
            ...
            (void)(int)BIO_ctrl(fbio,11,0,((void*)0));
            ...
            BIO_read(sbio, sbuf, 1024*8);
        }
        break;
    case PROTO_POP3:
        {
            BIO_read(sbio, mbuf, 1024*8);
            BIO_printf(sbio, "STLS\r\n");
            mbuf_len = BIO_read(sbio, sbuf, 1024*8);
            if (mbuf_len < 0) {
    ...
    case PROTO_XMPP_SERVER:
        {
            ...
            seen = BIO_read(sbio, mbuf, 1024*8);
            if (seen < 0) {
                BIO_printf(bio_err, "BIO_read failed\n");
                goto end;
            }
            ...
            BIO_printf(sbio,
                       "<starttls xmlns='urn:ietf:params:xml:ns:xmpp-tls'/>");
            seen = BIO_read(sbio, sbuf, 1024*8);
            if (seen < 0) {
                BIO_printf(bio_err, "BIO_read failed\n");
                goto shut;
            }
    ...
    case PROTO_IRC:
        {
            ...
            do {
                ...
                do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&readfds)->__fds_bits)[0]) : "memory"); } while (0);
                ((void) (((&readfds)->__fds_bits)[((SSL_get_fd(con)) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) (1UL << ((SSL_get_fd(con)) % (8 * (int) sizeof (__fd_mask)))))));
                timeout.tv_sec = 8;
                timeout.tv_usec = 0;
                ...
                if (!BIO_ctrl(fbio,116,0,((void*)0))
                    && !(int)BIO_ctrl(fbio,10,0,((void*)0))
                    && !(int)BIO_ctrl(sbio,10,0,((void*)0))
                    && select(width, (void *)&readfds, ((void*)0), ((void*)0),
                              &timeout) < 1) {
                    BIO_printf(bio_err,
    ...
    case PROTO_MYSQL:
        {
            ...
            bytes = BIO_read(sbio, (void *)packet, 1024*8);
            if (bytes < 0) {
                BIO_printf(bio_err, "BIO_read failed\n");
                goto shut;
    ...
    case PROTO_POSTGRES:
        {
            ...
            bytes = BIO_read(sbio, sbuf, 1024*8);
            if (bytes != 1 || sbuf[0] != 'S')
                goto shut;
        }
        break;
    case PROTO_NNTP:
        {
            ...
            if (!foundit)
                BIO_printf(bio_err,
                           ...
                           " trying anyway...\n");
            BIO_printf(sbio, "STARTTLS\r\n");
            mbuf_len = BIO_read(sbio, mbuf, 1024*8);
            if (mbuf_len < 0) {
                BIO_printf(bio_err, "BIO_read failed\n");
                goto end;
            }
            mbuf[mbuf_len] = '\0';
            if (strstr(mbuf, "382") == ((void*)0)) {
    ...
    if (early_data_file != ((void*)0)
            && ((SSL_get_session(con) != ((void*)0)
                 && SSL_SESSION_get_max_early_data(SSL_get_session(con)) > 0)
                || (psksess != ((void*)0)
        ...
        while (!finish) {
            if (!BIO_read_ex(edfile, cbuf, 1024*8, &readbytes))
                finish = 1;
    ...
    for (;;) {
        ...
        if (!SSL_is_init_finished(con) && SSL_ctrl((con),12,0,((void*)0)) == 0
                && SSL_get_key_update_type(con) == -1) {
            in_init = 1;
            tty_on = 0;
        } else {
            tty_on = 1;
        ...
        if (!ssl_pending) {
            ...
            if (tty_on) {
                ...
                if (write_tty)
                    ((void) (((&writefds)->__fds_bits)[((fileno_stdout()) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) (1UL << ((fileno_stdout()) % (8 * (int) sizeof (__fd_mask)))))));

            }
            if (read_ssl)
                ((void) (((&readfds)->__fds_bits)[((SSL_get_fd(con)) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) (1UL << ((SSL_get_fd(con)) % (8 * (int) sizeof (__fd_mask)))))));
            if (write_ssl)
                ((void) (((&writefds)->__fds_bits)[((SSL_get_fd(con)) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) (1UL << ((SSL_get_fd(con)) % (8 * (int) sizeof (__fd_mask)))))));
# 2814 "apps/s_client.c"
        ...
        if (!ssl_pending && ((((&writefds)->__fds_bits)[((SSL_get_fd(con)) / (8 * (int) sizeof (__fd_mask)))] & ((__fd_mask) (1UL << ((SSL_get_fd(con)) % (8 * (int) sizeof (__fd_mask)))))) != 0)) {
        ...
        else if (!ssl_pending && ((((&writefds)->__fds_bits)[((fileno_stdout()) / (8 * (int) sizeof (__fd_mask)))] & ((__fd_mask) (1UL << ((fileno_stdout()) % (8 * (int) sizeof (__fd_mask)))))) != 0))
        ...
        } else if (ssl_pending || ((((&readfds)->__fds_bits)[((SSL_get_fd(con)) / (8 * (int) sizeof (__fd_mask)))] & ((__fd_mask) (1UL << ((SSL_get_fd(con)) % (8 * (int) sizeof (__fd_mask)))))) != 0)) {
# 2927 "apps/s_client.c"
        ...
        else if (((((&readfds)->__fds_bits)[((fileno_stdin()) / (8 * (int) sizeof (__fd_mask)))] & ((__fd_mask) (1UL << ((fileno_stdin()) % (8 * (int) sizeof (__fd_mask)))))) != 0))

        {
            if (crlf) {
                int j, lf_num;

                i = raw_read_stdin(cbuf, 1024*8 / 2);
                lf_num = 0;
...
# 3068 "apps/s_client.c"
    ...
    } while (select(s + 1, &readfds, ((void*)0), ((void*)0), &timeout) > 0
             && BIO_read(sbio, sbuf, 1024*8) > 0);
    ...
    CRYPTO_free(next_proto.data, "apps/s_client.c", 3091);
    ...
    CRYPTO_free(pass, "apps/s_client.c", 3099);

    CRYPTO_free(srp_arg.srppassin, "apps/s_client.c", 3101);

    CRYPTO_free(connectstr, "apps/s_client.c", 3103);
    CRYPTO_free(bindstr, "apps/s_client.c", 3104);
    CRYPTO_free(host, "apps/s_client.c", 3105);
    CRYPTO_free(port, "apps/s_client.c", 3106);
    X509_VERIFY_PARAM_free(vpm);
    ssl_excert_free(exc);
    sk_OPENSSL_STRING_free(ssl_args);
    sk_OPENSSL_STRING_free(dane_tlsa_rrset);
    SSL_CONF_CTX_free(cctx);
    CRYPTO_clear_free(cbuf, 1024*8, "apps/s_client.c", 3112);
    CRYPTO_clear_free(sbuf, 1024*8, "apps/s_client.c", 3113);
    CRYPTO_clear_free(mbuf, 1024*8, "apps/s_client.c", 3114);
    release_engine(e);
    BIO_free(bio_c_out);
    bio_c_out = ((void*)0);
    BIO_free(bio_c_msg);
...
# 3184 "apps/s_client.c"
        if (peer != ((void*)0) && !SSL_session_reused(s) && SSL_ct_is_enabled(s)) {
            const struct stack_st_SCT *scts = SSL_get0_peer_scts(s);
            int sct_count = scts != ((void*)0) ? sk_SCT_num(scts) : 0;
...
# 3253 "apps/s_client.c"
    ...
    if (SSL_get_session(s) != ((void*)0) && keymatexportlabel != ((void*)0)) {
        ...
        CRYPTO_free(exportedkeymat, "apps/s_client.c", 3320);
    }
    BIO_printf(bio, "---\n");
    X509_free(peer);

    (void)(int)BIO_ctrl(bio,11,0,((void*)0));
}
