...
static BIO_METHOD *prefix_meth = ((void*)0);

BIO_METHOD *apps_bf_prefix(void)
{
    if (prefix_meth == ((void*)0)) {
        if ((prefix_meth =
             BIO_meth_new(0x0200, "Prefix filter")) == ((void*)0)
...
static int prefix_create(BIO *b)
{
    PREFIX_CTX *ctx = CRYPTO_zalloc(sizeof(*ctx), "apps/bf_prefix.c", 55);
...
static int prefix_destroy(BIO *b)
{
    ...
    CRYPTO_free(ctx->prefix, "apps/bf_prefix.c", 71);
    CRYPTO_free(ctx, "apps/bf_prefix.c", 72);
    return 1;
}
    ...
    case (1 << 15):
        {
            ...
            CRYPTO_free(ctx->prefix, "apps/bf_prefix.c", 151);
            ctx->prefix = CRYPTO_strdup((const char *)ptr, "apps/bf_prefix.c", 152);
