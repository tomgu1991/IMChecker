...
# 1 "include/openssl/aes.h" 1
# 13 "include/openssl/aes.h"
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/aes.h" 2

# 1 "/usr/local/bin/../lib/clang/3.9.0/include/stddef.h" 1 3
# 16 "include/openssl/aes.h" 2
...
# 13 "include/openssl/camellia.h"
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/camellia.h" 2


# 1 "/usr/local/bin/../lib/clang/3.9.0/include/stddef.h" 1 3
# 17 "include/openssl/camellia.h" 2
...
# 1 "include/openssl/mdc2.h" 1
# 13 "include/openssl/mdc2.h"
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/mdc2.h" 2
...
# 1 "include/openssl/md4.h" 1
# 13 "include/openssl/md4.h"
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/md4.h" 2



# 1 "/usr/local/bin/../lib/clang/3.9.0/include/stddef.h" 1 3
# 18 "include/openssl/md4.h" 2
...
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/md5.h" 2



# 1 "/usr/local/bin/../lib/clang/3.9.0/include/stddef.h" 1 3
# 18 "include/openssl/md5.h" 2
...
# 1 "include/openssl/ripemd.h" 1
# 13 "include/openssl/ripemd.h"
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/ripemd.h" 2



# 1 "/usr/local/bin/../lib/clang/3.9.0/include/stddef.h" 1 3
# 18 "include/openssl/ripemd.h" 2
...
# 1 "include/openssl/whrlpool.h" 1
# 13 "include/openssl/whrlpool.h"
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/whrlpool.h" 2



# 1 "/usr/local/bin/../lib/clang/3.9.0/include/stddef.h" 1 3
# 18 "include/openssl/whrlpool.h" 2
...
# 1 "include/openssl/rc4.h" 1
# 13 "include/openssl/rc4.h"
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/rc4.h" 2


# 1 "/usr/local/bin/../lib/clang/3.9.0/include/stddef.h" 1 3
# 17 "include/openssl/rc4.h" 2
...
# 13 "include/openssl/idea.h"
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/idea.h" 2
...
# 1 "include/openssl/seed.h" 1
# 38 "include/openssl/seed.h"
# 1 "include/openssl/opensslconf.h" 1
# 39 "include/openssl/seed.h" 2
# 60 "include/openssl/seed.h"
...
void SEED_set_key(const unsigned char rawkey[16],
                  SEED_KEY_SCHEDULE *ks);

void SEED_encrypt(const unsigned char s[16],
                  unsigned char d[16],
                  const SEED_KEY_SCHEDULE *ks);
void SEED_decrypt(const unsigned char s[16],
                  unsigned char d[16],
                  const SEED_KEY_SCHEDULE *ks);
...
# 1 "include/openssl/opensslconf.h" 1
# 14 "include/openssl/blowfish.h" 2
# 34 "include/openssl/blowfish.h"
...
DSA *get_dsa(int dsa_bits)
{
    ...
    switch (dsa_bits) {
    case 512:
        do { dsa_t.priv = dsa512_priv; dsa_t.pub = dsa512_pub; dsa_t.p = dsa512_p; dsa_t.g = dsa512_g; dsa_t.q = dsa512_q; dsa_t.priv_l = sizeof(dsa512_priv); dsa_t.pub_l = sizeof(dsa512_pub); dsa_t.p_l = sizeof(dsa512_p); dsa_t.g_l = sizeof(dsa512_g); dsa_t.q_l = sizeof(dsa512_q); } while (0);
        break;
    case 1024:
        do { dsa_t.priv = dsa1024_priv; dsa_t.pub = dsa1024_pub; dsa_t.p = dsa1024_p; dsa_t.g = dsa1024_g; dsa_t.q = dsa1024_q; dsa_t.priv_l = sizeof(dsa1024_priv); dsa_t.pub_l = sizeof(dsa1024_pub); dsa_t.p_l = sizeof(dsa1024_p); dsa_t.g_l = sizeof(dsa1024_g); dsa_t.q_l = sizeof(dsa1024_q); } while (0);
        break;
    case 2048:
        do { dsa_t.priv = dsa2048_priv; dsa_t.pub = dsa2048_pub; dsa_t.p = dsa2048_p; dsa_t.g = dsa2048_g; dsa_t.q = dsa2048_q; dsa_t.priv_l = sizeof(dsa2048_priv); dsa_t.pub_l = sizeof(dsa2048_pub); dsa_t.p_l = sizeof(dsa2048_p); dsa_t.g_l = sizeof(dsa2048_g); dsa_t.q_l = sizeof(dsa2048_q); } while (0);
        break;
    default:
        return ((void*)0);
    }
...
typedef enum OPTION_choice {
    ...
    OPT_MR, OPT_MB, OPT_MISALIGN, OPT_ASYNCJOBS, OPT_R__FIRST=1500, OPT_R_RAND, OPT_R_WRITERAND, OPT_R__LAST,
...
static double results[(sizeof(names)/sizeof((names)[0]))][(sizeof(lengths_list)/sizeof((lengths_list)[0]))];
...
static double dsa_results[(sizeof(dsa_choices)/sizeof((dsa_choices)[0]))][2];
# 474 "apps/speed.c"
...
static double rsa_results[(sizeof(rsa_choices)/sizeof((rsa_choices)[0]))][2];
# 513 "apps/speed.c"
...
static double ecdsa_results[(sizeof(ecdsa_choices)/sizeof((ecdsa_choices)[0]))][2];
...
static double ecdh_results[(sizeof(ecdh_choices)/sizeof((ecdh_choices)[0]))][1];
# 580 "apps/speed.c"
typedef struct loopargs_st {
    ...
    RSA *rsa_key[(sizeof(rsa_choices)/sizeof((rsa_choices)[0]))];


    DSA *dsa_key[(sizeof(dsa_choices)/sizeof((dsa_choices)[0]))];


    EC_KEY *ecdsa[(sizeof(ecdsa_choices)/sizeof((ecdsa_choices)[0]))];
    EVP_PKEY_CTX *ecdh_ctx[(sizeof(ecdh_choices)/sizeof((ecdh_choices)[0]))];
    unsigned char *secret_a;
    unsigned char *secret_b;
    size_t outlen[(sizeof(ecdh_choices)/sizeof((ecdh_choices)[0]))];
...
static long c[(sizeof(names)/sizeof((names)[0]))][(sizeof(lengths_list)/sizeof((lengths_list)[0]))];
# 632 "apps/speed.c"
static int EVP_Digest_MDC2_loop(void *args)
{
    loopargs_t *tempargs = *(loopargs_t **) args;
    unsigned char *buf = tempargs->buf;
    unsigned char mdc2[16];
    int count;

    for (count = 0; (run && count<0x7fffffff); count++) {
        if (!EVP_Digest(buf, (size_t)lengths[testnum], mdc2, ((void*)0), EVP_mdc2(),
                        ((void*)0)))
            return -1;
    }
    return count;
...
static unsigned char iv[2 * 128 / 8];
...
static int AES_cbc_128_encrypt_loop(void *args)
{
    ...
    for (count = 0; (run && count<0x7fffffff); count++)
        AES_cbc_encrypt(buf, buf,
                        (size_t)lengths[testnum], &aes_ks1, iv, 1);
    return count;
}
...
static int AES_cbc_192_encrypt_loop(void *args)
{
    ...
    for (count = 0; (run && count<0x7fffffff); count++)
        AES_cbc_encrypt(buf, buf,
                        (size_t)lengths[testnum], &aes_ks2, iv, 1);
    return count;
}
...
static int AES_cbc_256_encrypt_loop(void *args)
{
    ...
    for (count = 0; (run && count<0x7fffffff); count++)
        AES_cbc_encrypt(buf, buf,
                        (size_t)lengths[testnum], &aes_ks3, iv, 1);
    return count;
}
...
static int EVP_Update_loop_ccm(void *args)
{
    ...
    if (decrypt) {
        for (count = 0; (run && count<0x7fffffff); count++) {
            ...
            EVP_DecryptUpdate(ctx, ((void*)0), &outl, ((void*)0), lengths[testnum]);
...
static const EVP_MD *evp_md = ((void*)0);
static int EVP_Digest_loop(void *args)
{
    loopargs_t *tempargs = *(loopargs_t **) args;
    unsigned char *buf = tempargs->buf;
...
static long rsa_c[(sizeof(rsa_choices)/sizeof((rsa_choices)[0]))][2];
...
static int RSA_sign_loop(void *args)
{
    ...
    int ret, count;
    for (count = 0; (run && count<0x7fffffff); count++) {
        ret = RSA_sign(114, buf, 36, buf2, rsa_num, rsa_key[testnum]);
        if (ret == 0) {
...
static int RSA_verify_loop(void *args)
{
    ...
    for (count = 0; (run && count<0x7fffffff); count++) {
        ret =
            RSA_verify(114, buf, 36, buf2, rsa_num, rsa_key[testnum]);
        if (ret <= 0) {
...
static long dsa_c[(sizeof(dsa_choices)/sizeof((dsa_choices)[0]))][2];
static int DSA_sign_loop(void *args)
{
    loopargs_t *tempargs = *(loopargs_t **) args;
    unsigned char *buf = tempargs->buf;
...
static long ecdsa_c[(sizeof(ecdsa_choices)/sizeof((ecdsa_choices)[0]))][2];
static int ECDSA_sign_loop(void *args)
{
    loopargs_t *tempargs = *(loopargs_t **) args;
    unsigned char *buf = tempargs->buf;
...
static long ecdh_c[(sizeof(ecdh_choices)/sizeof((ecdh_choices)[0]))][1];
                         ...
                         int (*loop_function) (void *), loopargs_t * loopargs)
{
    ...
    while (num_inprogress > 0) {
        ...
        do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&waitfdset)->__fds_bits)[0]) : "memory"); } while (0);
        ...
        for (i = 0; i < async_jobs && num_inprogress > 0; i++) {
            ...
            ASYNC_WAIT_CTX_get_all_fds(loopargs[i].wait_ctx, &job_fd,
                                       &num_job_fds);
            ((void) (((&waitfdset)->__fds_bits)[((job_fd) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) (1UL << ((job_fd) % (8 * (int) sizeof (__fd_mask)))))));
            if (job_fd > max_fd)
                max_fd = job_fd;
        }
        ...
        select_result = select(max_fd + 1, &waitfdset, ((void*)0), ((void*)0), ((void*)0));
        if (select_result == -1 && (*__errno_location ()) == 4)
            continue;
        ...
        for (i = 0; i < async_jobs; i++) {
            ...
            if (num_job_fds == 1 && !((((&waitfdset)->__fds_bits)[((job_fd) / (8 * (int) sizeof (__fd_mask)))] & ((__fd_mask) (1UL << ((job_fd) % (8 * (int) sizeof (__fd_mask)))))) != 0))
                continue;
...
{
    ENGINE *e = ((void*)0);
    loopargs_t *loopargs = ((void*)0);
    const char *prog;
    const char *engine_id = ((void*)0);
    const EVP_CIPHER *evp_cipher = ((void*)0);
    double d = 0.0;
    OPTION_CHOICE o;
    int async_init = 0, multiblock = 0, pr_header = 0;
    int doit[(sizeof(names)/sizeof((names)[0]))] = { 0 };
    int ret = 1, misalign = 0, lengths_single = 0, aead = 0;
    long count = 0;
    unsigned int size_num = (sizeof(lengths_list)/sizeof((lengths_list)[0]));
    ...
    openssl_speed_sec_t seconds = { 3, 10, 10,
                                    10, 10 };
    ...
    static const unsigned int rsa_bits[(sizeof(rsa_choices)/sizeof((rsa_choices)[0]))] = {
        512, 1024, 2048, 3072, 4096, 7680, 15360
    };
    static const unsigned char *rsa_data[(sizeof(rsa_choices)/sizeof((rsa_choices)[0]))] = {
        test512, test1024, test2048, test3072, test4096, test7680, test15360
    };
    static const int rsa_data_length[(sizeof(rsa_choices)/sizeof((rsa_choices)[0]))] = {
        sizeof(test512), sizeof(test1024),
        sizeof(test2048), sizeof(test3072),
        sizeof(test4096), sizeof(test7680),
        sizeof(test15360)
    };
    int rsa_doit[(sizeof(rsa_choices)/sizeof((rsa_choices)[0]))] = { 0 };
    int primes = 2;


    static const unsigned int dsa_bits[(sizeof(dsa_choices)/sizeof((dsa_choices)[0]))] = { 512, 1024, 2048 };
    int dsa_doit[(sizeof(dsa_choices)/sizeof((dsa_choices)[0]))] = { 0 };
    ...
    static const struct {
        ...
        {"nistb409", 732, 409},
        {"nistb571", 734, 571},
        {"brainpoolP256r1", 927, 256},
        {"brainpoolP256t1", 928, 256},
        {"brainpoolP384r1", 931, 384},
        {"brainpoolP384t1", 932, 384},
        {"brainpoolP512r1", 933, 512},
        {"brainpoolP512t1", 934, 512},

        {"X25519", 1034, 253},
        {"X448", 1035, 448}
    };
    int ecdsa_doit[(sizeof(ecdsa_choices)/sizeof((ecdsa_choices)[0]))] = { 0 };
    int ecdh_doit[(sizeof(ecdh_choices)/sizeof((ecdh_choices)[0]))] = { 0 };
    (void)(((sizeof(test_curves)/sizeof((test_curves)[0])) >= (sizeof(ecdh_choices)/sizeof((ecdh_choices)[0]))) ? 0 : (OPENSSL_die("assertion failed: " "OSSL_NELEM(test_curves) >= EC_NUM", "apps/speed.c", 1460), 1));
 ...
 opterr:
        ...
        case OPT_EVP:
            ...
            if (evp_cipher == ((void*)0))
                evp_md = EVP_get_digestbyname(opt_arg());
            if (evp_cipher == ((void*)0) && evp_md == ((void*)0)) {
                BIO_printf(bio_err,
    ...
    for (; *argv; argv++) {
        if (opt_found(*argv, &i, doit_choices, (sizeof(doit_choices)/sizeof((doit_choices)[0])))) {
            doit[i] = 1;
            continue;
        }
        ...
        if (strcmp(*argv, "rsa") == 0) {
            for (loop = 0; loop < (sizeof(rsa_doit)/sizeof((rsa_doit)[0])); loop++)
                rsa_doit[loop] = 1;
            continue;
        }
        if (opt_found(*argv, &i, rsa_choices, (sizeof(rsa_choices)/sizeof((rsa_choices)[0])))) {
            rsa_doit[i] = 1;
            continue;
        }
        ...
        if (strcmp(*argv, "dsa") == 0) {
            dsa_doit[0] = dsa_doit[1] =
                dsa_doit[2] = 1;
            continue;
        }
        if (opt_found(*argv, &i, dsa_choices, (sizeof(dsa_choices)/sizeof((dsa_choices)[0])))) {
            dsa_doit[i] = 2;
            continue;
        }

        if (strcmp(*argv, "aes") == 0) {
            doit[16] = doit[17] = doit[18] = 1;
            continue;
        }

        if (strcmp(*argv, "camellia") == 0) {
            doit[19] = doit[20] = doit[21] = 1;
            continue;
        }


        if (strcmp(*argv, "ecdsa") == 0) {
            for (loop = 0; loop < (sizeof(ecdsa_doit)/sizeof((ecdsa_doit)[0])); loop++)
                ecdsa_doit[loop] = 1;
            continue;
        }
        if (opt_found(*argv, &i, ecdsa_choices, (sizeof(ecdsa_choices)/sizeof((ecdsa_choices)[0])))) {
            ecdsa_doit[i] = 2;
            continue;
        }
        if (strcmp(*argv, "ecdh") == 0) {
            for (loop = 0; loop < (sizeof(ecdh_doit)/sizeof((ecdh_doit)[0])); loop++)
                ecdh_doit[loop] = 1;
            continue;
        }
        if (opt_found(*argv, &i, ecdh_choices, (sizeof(ecdh_choices)/sizeof((ecdh_choices)[0])))) {
            ecdh_doit[i] = 2;
            continue;
        }
    ...
    for (i = 0; i < loopargs_len; i++) {
        ...
        loopargs[i].secret_a = app_malloc(256, "ECDH secret a");
        loopargs[i].secret_b = app_malloc(256, "ECDH secret b");
    ...
    if ((argc == 0) && !doit[22]) {
        ...
        for (i = 0; i < (sizeof(rsa_choices)/sizeof((rsa_choices)[0])); i++)
            rsa_doit[i] = 1;


        for (i = 0; i < (sizeof(dsa_choices)/sizeof((dsa_choices)[0])); i++)
            dsa_doit[i] = 1;
    ...
    for (i = 0; i < loopargs_len; i++) {
        ...
        for (k = 0; k < (sizeof(rsa_choices)/sizeof((rsa_choices)[0])); k++) {
            const unsigned char *p;

            p = rsa_data[k];
            loopargs[i].rsa_key[k] =
                d2i_RSAPrivateKey(((void*)0), &p, rsa_data_length[k]);
            if (loopargs[i].rsa_key[k] == ((void*)0)) {
                BIO_printf(bio_err,
...
# 2055 "apps/speed.c"
    if (doit[1]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[1], c[1][testnum], lengths[testnum],
                          seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, EVP_Digest_MDC2_loop, loopargs);
            d = Time_F(1);
            print_result(1, testnum, count, d);
        }
    }
    ...
    if (doit[2]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[2], c[2][testnum], lengths[testnum],
                          seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, EVP_Digest_MD4_loop, loopargs);
            d = Time_F(1);
            print_result(2, testnum, count, d);
        }
    }
    ...
    if (doit[3]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[3], c[3][testnum], lengths[testnum],
                          seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, MD5_loop, loopargs);
            d = Time_F(1);
            print_result(3, testnum, count, d);
        }
    }
    ...
    if (doit[4]) {
        ...
        for (i = 0; i < loopargs_len; i++) {
            ...
            if (loopargs[i].hctx == ((void*)0)) {
                BIO_printf(bio_err, "HMAC malloc failure, exiting...");
                exit(1);
            }

            HMAC_Init_ex(loopargs[i].hctx, hmac_key, len, EVP_md5(), ((void*)0));
        }
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[4], c[4][testnum], lengths[testnum],
                          seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, HMAC_loop, loopargs);
            d = Time_F(1);
            print_result(4, testnum, count, d);
        }
        for (i = 0; i < loopargs_len; i++) {
    ...
    if (doit[5]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[5], c[5][testnum], lengths[testnum],
                          seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, SHA1_loop, loopargs);
            d = Time_F(1);
            print_result(5, testnum, count, d);
        }
    }
    if (doit[23]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[23], c[23][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, SHA256_loop, loopargs);
            d = Time_F(1);
            print_result(23, testnum, count, d);
        }
    }
    if (doit[24]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[24], c[24][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, SHA512_loop, loopargs);
            d = Time_F(1);
            print_result(24, testnum, count, d);
        }
    }

    if (doit[25]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[25], c[25][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, WHIRLPOOL_loop, loopargs);
            d = Time_F(1);
            print_result(25, testnum, count, d);
        }
    }
    ...
    if (doit[6]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[6], c[6][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, EVP_Digest_RMD160_loop, loopargs);
            d = Time_F(1);
            print_result(6, testnum, count, d);
        }
    }
    ...
    if (doit[7]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[7], c[7][testnum], lengths[testnum],
                          seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, RC4_loop, loopargs);
            d = Time_F(1);
            print_result(7, testnum, count, d);
        }
    }
    ...
    if (doit[8]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[8], c[8][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, DES_ncbc_encrypt_loop, loopargs);
            d = Time_F(1);
            print_result(8, testnum, count, d);
        }
    }

    if (doit[9]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[9], c[9][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count =
                run_benchmark(async_jobs, DES_ede3_cbc_encrypt_loop, loopargs);
            d = Time_F(1);
            print_result(9, testnum, count, d);
        }
    }
    ...
    if (doit[16]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[16], c[16][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count =
                run_benchmark(async_jobs, AES_cbc_128_encrypt_loop, loopargs);
            d = Time_F(1);
            print_result(16, testnum, count, d);
        }
    }
    if (doit[17]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[17], c[17][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count =
                run_benchmark(async_jobs, AES_cbc_192_encrypt_loop, loopargs);
            d = Time_F(1);
            print_result(17, testnum, count, d);
        }
    }
    if (doit[18]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[18], c[18][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count =
                run_benchmark(async_jobs, AES_cbc_256_encrypt_loop, loopargs);
            d = Time_F(1);
            print_result(18, testnum, count, d);
        }
    }

    if (doit[26]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[26], c[26][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count =
                run_benchmark(async_jobs, AES_ige_128_encrypt_loop, loopargs);
            d = Time_F(1);
            print_result(26, testnum, count, d);
        }
    }
    if (doit[27]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[27], c[27][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count =
                run_benchmark(async_jobs, AES_ige_192_encrypt_loop, loopargs);
            d = Time_F(1);
            print_result(27, testnum, count, d);
        }
    }
    if (doit[28]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[28], c[28][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count =
                run_benchmark(async_jobs, AES_ige_256_encrypt_loop, loopargs);
            d = Time_F(1);
            print_result(28, testnum, count, d);
        }
    }
    if (doit[29]) {
        for (i = 0; i < loopargs_len; i++) {
        ...
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[29], c[29][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, CRYPTO_gcm128_aad_loop, loopargs);
            d = Time_F(1);
            print_result(29, testnum, count, d);
        }
        for (i = 0; i < loopargs_len; i++)
    ...
    if (doit[19]) {
        ...
        for (testnum = 0; testnum < size_num && async_init == 0; testnum++) {
            print_message(names[19], c[19][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            for (count = 0, run = 1; (run && count<0x7fffffff); count++)
                Camellia_cbc_encrypt(loopargs[0].buf, loopargs[0].buf,
                                     ...
                                     iv, 1);
            d = Time_F(1);
            print_result(19, testnum, count, d);
        }
    }
    if (doit[20]) {
        if (async_jobs > 0) {
        ...
        for (testnum = 0; testnum < size_num && async_init == 0; testnum++) {
            print_message(names[20], c[20][testnum],
                          lengths[testnum], seconds.sym);
            if (async_jobs > 0) {
            ...
            for (count = 0, run = 1; (run && count<0x7fffffff); count++)
                Camellia_cbc_encrypt(loopargs[0].buf, loopargs[0].buf,
                                     ...
                                     iv, 1);
            d = Time_F(1);
            print_result(20, testnum, count, d);
        }
    }
    if (doit[21]) {
        if (async_jobs > 0) {
        ...
        for (testnum = 0; testnum < size_num && async_init == 0; testnum++) {
            print_message(names[21], c[21][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            for (count = 0, run = 1; (run && count<0x7fffffff); count++)
                Camellia_cbc_encrypt(loopargs[0].buf, loopargs[0].buf,
                                     ...
                                     iv, 1);
            d = Time_F(1);
            print_result(21, testnum, count, d);
        }
    }
    ...
    if (doit[10]) {
        ...
        for (testnum = 0; testnum < size_num && async_init == 0; testnum++) {
            print_message(names[10], c[10][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            for (count = 0, run = 1; (run && count<0x7fffffff); count++)
                IDEA_cbc_encrypt(loopargs[0].buf, loopargs[0].buf,
                                 ...
                                 iv, 1);
            d = Time_F(1);
            print_result(10, testnum, count, d);
        }
    }
    ...
    if (doit[11]) {
        ...
        for (testnum = 0; testnum < size_num && async_init == 0; testnum++) {
            print_message(names[11], c[11][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            for (count = 0, run = 1; (run && count<0x7fffffff); count++)
            ...
            d = Time_F(1);
            print_result(11, testnum, count, d);
        }
    }
    ...
    if (doit[12]) {
        ...
        for (testnum = 0; testnum < size_num && async_init == 0; testnum++) {
            print_message(names[12], c[12][testnum],
                          lengths[testnum], seconds.sym);
            if (async_jobs > 0) {
                BIO_printf(bio_err, "Async mode is not supported, exiting...");
                exit(1);
            ...
            for (count = 0, run = 1; (run && count<0x7fffffff); count++)
                RC2_cbc_encrypt(loopargs[0].buf, loopargs[0].buf,
                                ...
                                iv, 1);
            d = Time_F(1);
            print_result(12, testnum, count, d);
        }
    }
# 2444 "apps/speed.c"
    if (doit[14]) {
        ...
        for (testnum = 0; testnum < size_num && async_init == 0; testnum++) {
            print_message(names[14], c[14][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            for (count = 0, run = 1; (run && count<0x7fffffff); count++)
                BF_cbc_encrypt(loopargs[0].buf, loopargs[0].buf,
                               ...
                               iv, 1);
            d = Time_F(1);
            print_result(14, testnum, count, d);
        }
    }
    ...
    if (doit[15]) {
        ...
        for (testnum = 0; testnum < size_num && async_init == 0; testnum++) {
            print_message(names[15], c[15][testnum],
                          lengths[testnum], seconds.sym);
            Time_F(0);
            for (count = 0, run = 1; (run && count<0x7fffffff); count++)
                CAST_cbc_encrypt(loopargs[0].buf, loopargs[0].buf,
                                 ...
                                 iv, 1);
            d = Time_F(1);
            print_result(15, testnum, count, d);
        }
    }

    if (doit[30]) {
        for (testnum = 0; testnum < size_num; testnum++) {
            print_message(names[30], c[30][testnum], lengths[testnum],
                          seconds.sym);
            Time_F(0);
            count = run_benchmark(async_jobs, RAND_bytes_loop, loopargs);
            d = Time_F(1);
            print_result(30, testnum, count, d);
        }
    }
    ...
    if (doit[22]) {
        if (evp_cipher != ((void*)0)) {
            ...
            names[22] = OBJ_nid2ln(EVP_CIPHER_nid(evp_cipher));

            if ((EVP_CIPHER_flags(evp_cipher) & 0xF0007) == 0x7) {
                ...
                if (lengths == lengths_list) {
                    ...
                    size_num = (sizeof(aead_lengths_list)/sizeof((aead_lengths_list)[0]));
                }
            }

            for (testnum = 0; testnum < size_num; testnum++) {
                print_message(names[22], save_count, lengths[testnum],
                              seconds.sym);

                for (k = 0; k < loopargs_len; k++) {
                    loopargs[k].ctx = EVP_CIPHER_CTX_new();
                    EVP_CipherInit_ex(loopargs[k].ctx, evp_cipher, ((void*)0), ((void*)0),
                                      iv, decrypt ? 0 : 1);
                    ...
                    EVP_CipherInit_ex(loopargs[k].ctx, ((void*)0), ((void*)0),
                                      loopargs[k].key, ((void*)0), -1);
                    CRYPTO_clear_free(loopargs[k].key, keylen, "apps/speed.c", 2534);
                }
                ...
                print_result(22, testnum, count, d);
            }
        } else if (evp_md != ((void*)0)) {
            names[22] = OBJ_nid2ln(EVP_MD_type(evp_md));
    ...
    for (testnum = 0; testnum < (sizeof(rsa_choices)/sizeof((rsa_choices)[0])); testnum++) {
        int st = 0;
        if (!rsa_doit[testnum])
            continue;
        for (i = 0; i < loopargs_len; i++) {
            if (primes > 2) {
                ...
                if (loopargs[i].rsa_key[testnum] == ((void*)0)) {
                    BN_free(bn);
                    goto end;
                }
            ...
            st = RSA_sign(114, loopargs[i].buf, 36, loopargs[i].buf2,
        ...
        for (i = 0; i < loopargs_len; i++) {
            st = RSA_verify(114, loopargs[i].buf, 36, loopargs[i].buf2,
                            loopargs[i].siglen, loopargs[i].rsa_key[testnum]);
            if (st <= 0)
                break;
        }
        ...
        if (rsa_count <= 1) {
            ...
            for (testnum++; testnum < (sizeof(rsa_choices)/sizeof((rsa_choices)[0])); testnum++)
                rsa_doit[testnum] = 0;
        }
    }
    ...
    for (testnum = 0; testnum < (sizeof(dsa_choices)/sizeof((dsa_choices)[0])); testnum++) {
        int st = 0;
        if (!dsa_doit[testnum])
            continue;
        ...
        if (rsa_count <= 1) {
            ...
            for (testnum++; testnum < (sizeof(dsa_choices)/sizeof((dsa_choices)[0])); testnum++)
                dsa_doit[testnum] = 0;
        }
    }
    ...
    for (testnum = 0; testnum < (sizeof(ecdsa_choices)/sizeof((ecdsa_choices)[0])); testnum++) {
        int st = 1;
        ...
        for (i = 0; i < loopargs_len; i++) {
            ...
            if (loopargs[i].ecdsa[testnum] == ((void*)0)) {
                st = 0;
                break;
            }
        }
        if (st == 0) {
            ...
            for (i = 0; i < loopargs_len; i++) {
                EC_KEY_precompute_mult(loopargs[i].ecdsa[testnum], ((void*)0));
            ...
            if (rsa_count <= 1) {
                ...
                for (testnum++; testnum < (sizeof(ecdh_choices)/sizeof((ecdh_choices)[0])); testnum++)
                    ecdsa_doit[testnum] = 0;
            }
        }
    }

    for (testnum = 0; testnum < (sizeof(ecdh_choices)/sizeof((ecdh_choices)[0])); testnum++) {
        int ecdh_checks = 1;
        ...
        for (i = 0; i < loopargs_len; i++) {
            ...
            EVP_PKEY_CTX *test_ctx = ((void*)0);
            EVP_PKEY_CTX *ctx = ((void*)0);
            EVP_PKEY *key_A = ((void*)0);
            EVP_PKEY *key_B = ((void*)0);
            size_t outlen;
            size_t test_outlen;
            ...
            kctx = EVP_PKEY_CTX_new_id(test_curves[testnum].nid, ((void*)0));
            if (!kctx) {
                EVP_PKEY_CTX *pctx = ((void*)0);
                EVP_PKEY *params = ((void*)0);
                ...
                if (error == ERR_peek_last_error() &&
                    ...
                    (int)(((error) >> 24L) & 0x0FFL) == 6 &&
                    (int)(((error) >> 12L) & 0xFFFL) == 157 &&
                    (int)( (error) & 0xFFFL) == 156)
                    ERR_get_error();
                if (ERR_peek_error()) {
                    BIO_printf(bio_err,
                ...
                if (
                       !(pctx = EVP_PKEY_CTX_new_id(408, ((void*)0))) ||

                       !EVP_PKEY_paramgen_init(pctx) ||

                       !EVP_PKEY_CTX_ctrl(pctx, 408, (1<<1)|(1<<2), (0x1000 + 1), test_curves [testnum].nid, ((void*)0)) ||
            ...
            if (!EVP_PKEY_keygen(kctx, &key_A) ||
                ...
                !(ctx = EVP_PKEY_CTX_new(key_A, ((void*)0))) ||
                !EVP_PKEY_derive_init(ctx) ||
                !EVP_PKEY_derive_set_peer(ctx, key_B) ||
                !EVP_PKEY_derive(ctx, ((void*)0), &outlen) ||
                outlen == 0 ||
                outlen > 256 ) {
                ecdh_checks = 0;
            ...
            if (!(test_ctx = EVP_PKEY_CTX_new(key_B, ((void*)0))) ||
                !EVP_PKEY_derive_init(test_ctx) ||
                !EVP_PKEY_derive_set_peer(test_ctx, key_A) ||
                !EVP_PKEY_derive(test_ctx, ((void*)0), &test_outlen) ||
        ...
        if (rsa_count <= 1) {
            ...
            for (testnum++; testnum < (sizeof(ecdh_doit)/sizeof((ecdh_doit)[0])); testnum++)
                ecdh_doit[testnum] = 0;
        }
    }
 ...
 show_res:
    ...
    testnum = 1;
    for (k = 0; k < (sizeof(dsa_choices)/sizeof((dsa_choices)[0])); k++) {
        if (!dsa_doit[k])
            continue;
        if (testnum && !mr) {
            printf("%18ssign    verify    sign/s verify/s\n", " ");
    ...
    testnum = 1;
    for (k = 0; k < (sizeof(ecdsa_doit)/sizeof((ecdsa_doit)[0])); k++) {
        if (!ecdsa_doit[k])
            continue;
        if (testnum && !mr) {
    ...
    testnum = 1;
    for (k = 0; k < (sizeof(ecdh_choices)/sizeof((ecdh_choices)[0])); k++) {
        if (!ecdh_doit[k])
            continue;
        if (testnum && !mr) {
            printf("%30sop      op/s\n", " ");
    ...
    ERR_print_errors(bio_err);
    for (i = 0; i < loopargs_len; i++) {
        CRYPTO_free(loopargs[i].buf_malloc, "apps/speed.c", 3108);
        CRYPTO_free(loopargs[i].buf2_malloc, "apps/speed.c", 3109);
        ...
        for (k = 0; k < (sizeof(ecdsa_choices)/sizeof((ecdsa_choices)[0])); k++)
            EC_KEY_free(loopargs[i].ecdsa[k]);
        for (k = 0; k < (sizeof(ecdh_choices)/sizeof((ecdh_choices)[0])); k++)
            EVP_PKEY_CTX_free(loopargs[i].ecdh_ctx[k]);
        CRYPTO_free(loopargs[i].secret_a, "apps/speed.c", 3124);
        CRYPTO_free(loopargs[i].secret_b, "apps/speed.c", 3125);
    ...
    CRYPTO_free(loopargs, "apps/speed.c", 3137);
    release_engine(e);
    return ret;
}
                             ...
                             const openssl_speed_sec_t *seconds)
{
    ...
    int j, count, keylen, num = (sizeof(mblengths_list)/sizeof((mblengths_list)[0]));
    const char *alg_name;
    ...
    EVP_EncryptInit_ex(ctx, evp_cipher, ((void*)0), ((void*)0), no_iv);

    keylen = EVP_CIPHER_CTX_key_length(ctx);
    key = app_malloc(keylen, "evp_cipher key");
    EVP_CIPHER_CTX_rand_key(ctx, key);
    EVP_EncryptInit_ex(ctx, ((void*)0), ((void*)0), key, ((void*)0));
    CRYPTO_clear_free(key, keylen, "apps/speed.c", 3374);

    EVP_CIPHER_CTX_ctrl(ctx, 0x17, sizeof(no_key), no_key);
    ...
    for (j = 0; j < num; j++) {
        ...
        for (count = 0, run = 1; run && count < 0x7fffffff; count++) {
            ...
            packlen = EVP_CIPHER_CTX_ctrl(ctx, 0x19,
            ...
            if (packlen > 0) {
                ...
                pad = EVP_CIPHER_CTX_ctrl(ctx, 0x16,
                                          13, aad);
        ...
        BIO_printf(bio_err, mr ? "+R:%d:%s:%f\n"
                   : "%d %s's in %.2fs\n", count, "evp", d);
        results[22][j] = ((double)count) / d * mblengths[j];
    }
    ...
    if (mr) {
        ...
        fprintf(stdout, "\n");
        fprintf(stdout, "+F:%d:%s", 22, alg_name);
        for (j = 0; j < num; j++)
            fprintf(stdout, ":%.2f", results[22][j]);
        fprintf(stdout, "\n");
    } else {
        fprintf(stdout,
                "The 'numbers' are in 1000s of bytes per second processed.\n");
        ...
        for (j = 0; j < num; j++) {
            if (results[22][j] > 10000)
                fprintf(stdout, " %11.2fk", results[22][j] / 1e3);
            else
                fprintf(stdout, " %11.2f ", results[22][j]);
        }
        fprintf(stdout, "\n");
    }

    CRYPTO_free(inp, "apps/speed.c", 3453);
    CRYPTO_free(out, "apps/speed.c", 3454);
