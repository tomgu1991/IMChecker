...
int dhparam_main(int argc, char **argv)
{
    ...
    int informat = (5 | 0x8000), outformat = (5 | 0x8000), check = 0, noout = 0;
    OPTION_CHOICE o;
 ...
 opthelp:
    ...
    if (num) {
        ...
        if (dsaparam) {
            ...
            if (informat == 4)
                dsa = ((DSA*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? DSA_new : ((DSA *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_DSAparams : ((DSA *(*)(DSA **,const unsigned char **,long))0))), in, ((void**) (1 ? ((void*)0) : (DSA**)0))));
            else
...

        {
            if (informat == 4) {
                ...
                dh = ((DH*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? DH_new : ((DH *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_DHparams : ((DH *(*)(DH **,const unsigned char **,long))0))), in, ((void**) (1 ? ((void*)0) : (DH**)0))));

                if (dh == ((void*)0) && (int)BIO_ctrl(in,1,0,((void*)0)) == 0)
                    dh = ((DH*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? DH_new : ((DH *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_DHxparams : ((DH *(*)(DH **,const unsigned char **,long))0))), in, ((void**) (1 ? ((void*)0) : (DH**)0))));
            } else {
    ...
    if (C) {
        ...
        CRYPTO_free(data, "apps/dhparam.c", 341);
    }
    ...
    if (!noout) {
        ...
        if (outformat == 4) {
            if (q != ((void*)0))
                i = (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_DHxparams : ((int (*)(const DH *,unsigned char **))0))), out, ((void*) (1 ? dh : (const DH*)0))));
            else
                i = (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_DHparams : ((int (*)(const DH *,unsigned char **))0))), out, ((void*) (1 ? dh : (const DH*)0))));
        } else if (q != ((void*)0)) {
...
static int dh_cb(int p, int n, BN_GENCB *cb)
{
    ...
    (void)(int)BIO_ctrl(BN_GENCB_get_arg(cb),11,0,((void*)0));
    return 1;
}
