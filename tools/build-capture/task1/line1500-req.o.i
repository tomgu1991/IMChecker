...
static int prompt_info(X509_REQ *req,
                       struct stack_st_CONF_VALUE *dn_sk, const char *dn_sect,
                       struct stack_st_CONF_VALUE *attr_sk, const char *attr_sect,
                       int attribs, unsigned long chtype);
static int auto_info(X509_REQ *req, struct stack_st_CONF_VALUE *sk,
                     struct stack_st_CONF_VALUE *attr, int attribs,
                     unsigned long chtype);
...
static CONF *req_conf = ((void*)0);
static CONF *addext_conf = ((void*)0);
static int batch = 0;
...
int req_main(int argc, char **argv)
{
    ...
    ENGINE *e = ((void*)0), *gen_eng = ((void*)0);
    EVP_PKEY *pkey = ((void*)0);
    EVP_PKEY_CTX *genctx = ((void*)0);
    struct stack_st_OPENSSL_STRING *pkeyopts = ((void*)0), *sigopts = ((void*)0);
    X509 *x509ss = ((void*)0);
    X509_REQ *req = ((void*)0);
    const EVP_CIPHER *cipher = ((void*)0);
    const EVP_MD *md_alg = ((void*)0), *digest = ((void*)0);
    BIO *addext_bio = ((void*)0);
    char *extensions = ((void*)0), *infile = ((void*)0);
    char *outfile = ((void*)0), *keyfile = ((void*)0);
    char *keyalgstr = ((void*)0), *p, *prog, *passargin = ((void*)0), *passargout = ((void*)0);
    char *passin = ((void*)0), *passout = ((void*)0);
    char *nofree_passin = ((void*)0), *nofree_passout = ((void*)0);
    char *req_exts = ((void*)0), *subj = ((void*)0);
    char *template = default_config_file, *keyout = ((void*)0);
    const char *keyalg = ((void*)0);
    OPTION_CHOICE o;
    int ret = 1, x509 = 0, days = 0, i = 0, newreq = 0, verbose = 0;
    int pkey_type = -1, private = 0;
    int informat = (5 | 0x8000), outformat = (5 | 0x8000), keyform = (5 | 0x8000);
    int modulus = 0, multirdn = 0, verify = 0, noout = 0, text = 0;
    int nodes = 0, newhdr = 0, subject = 0, pubkey = 0, precert = 0;
    long newkey = -1;
    unsigned long chtype = (0x1000|1), reqflag = 0;
 ...
 opthelp:
        ...
        case OPT_SET_SERIAL:
            ...
            serial = s2i_ASN1_INTEGER(((void*)0), opt_arg());
            if (serial == ((void*)0))
                goto opthelp;
            break;
        case OPT_SUBJECT:
    ...
    if (x509 && infile == ((void*)0))
        newreq = 1;


    private = newreq && (pkey == ((void*)0)) ? 1 : 0;
    ...
    if (addext_bio) {
        ...
        addext_conf = app_load_config_bio(addext_bio, ((void*)0));
    }
    if (template != default_config_file && !app_load_modules(req_conf))
        goto end;

    if (req_conf != ((void*)0)) {
        p = NCONF_get_string(req_conf, ((void*)0), "oid_file");
        if (p == ((void*)0))
            ERR_clear_error();
        if (p != ((void*)0)) {
            BIO *oid_bio;
    ...
    if (md_alg == ((void*)0)) {
        p = NCONF_get_string(req_conf, "req", "default_md");
        if (p == ((void*)0)) {
            ERR_clear_error();
        } else {
            if (!opt_md(p, &md_alg))
    ...
    if (extensions != ((void*)0)) {
        ...
        if (!X509V3_EXT_add_nconf(req_conf, &ctx, extensions, ((void*)0))) {
            BIO_printf(bio_err,
                       "Error Loading extension section %s\n", extensions);
            goto end;
        }
    }
    if (addext_conf != ((void*)0)) {

        X509V3_CTX ctx;
        X509V3_set_ctx(&ctx, ((void*)0), ((void*)0), ((void*)0), ((void*)0), 0x1);
        X509V3_set_nconf(&ctx, addext_conf);
        if (!X509V3_EXT_add_nconf(addext_conf, &ctx, "default", ((void*)0))) {
    ...
    if (passin == ((void*)0)) {
        passin = nofree_passin =
            NCONF_get_string(req_conf, "req", "input_password");
        if (passin == ((void*)0))
            ERR_clear_error();
    }
    ...
    if (passout == ((void*)0)) {
        passout = nofree_passout =
            NCONF_get_string(req_conf, "req", "output_password");
        if (passout == ((void*)0))
            ERR_clear_error();
    }

    p = NCONF_get_string(req_conf, "req", "string_mask");
    if (p == ((void*)0))
        ERR_clear_error();

    if (p != ((void*)0) && !ASN1_STRING_set_default_mask_asc(p)) {
        BIO_printf(bio_err, "Invalid global string mask setting %s\n", p);
        goto end;
    }

    if (chtype != (0x1000)) {
        p = NCONF_get_string(req_conf, "req", "utf8");
        if (p == ((void*)0))
            ERR_clear_error();
    ...
    if (req_exts == ((void*)0)) {
        req_exts = NCONF_get_string(req_conf, "req", "req_extensions");
        if (req_exts == ((void*)0))
            ERR_clear_error();
    }
    if (req_exts != ((void*)0)) {
        ...
        X509V3_set_ctx(&ctx, ((void*)0), ((void*)0), ((void*)0), ((void*)0), 0x1);
        X509V3_set_nconf(&ctx, req_conf);
        if (!X509V3_EXT_add_nconf(req_conf, &ctx, req_exts, ((void*)0))) {
            BIO_printf(bio_err,
    ...
    if (keyfile != ((void*)0)) {
        ...
        if (pkey == ((void*)0)) {
            ...
            app_RAND_load_conf(req_conf, "req");
        }
    }

    if (newreq && (pkey == ((void*)0))) {
        app_RAND_load_conf(req_conf, "req");

        if (!NCONF_get_number_e(req_conf,"req","default_bits",&newkey)) {
            newkey = 2048;
        }
        ...
        if (genctx == ((void*)0)) {
            genctx = set_keygen_ctx(((void*)0), &pkey_type, &newkey,
                                    &keyalgstr, gen_eng);
            if (!genctx)
                goto end;
        }
        ...
        if (keyout == ((void*)0)) {
            keyout = NCONF_get_string(req_conf, "req", "default_keyfile");
            if (keyout == ((void*)0))
                ERR_clear_error();
        }
        ...
        p = NCONF_get_string(req_conf, "req", "encrypt_rsa_key");
        if (p == ((void*)0)) {
            ERR_clear_error();
            p = NCONF_get_string(req_conf, "req", "encrypt_key");
            if (p == ((void*)0))
                ERR_clear_error();
        }
        if ((p != ((void*)0)) && (strcmp(p, "no") == 0))
            cipher = ((void*)0);
        if (nodes)
            cipher = ((void*)0);
 ...
 loop:
    ...
    if (!newreq) {
        ...
        if (informat == 4)
            req = d2i_X509_REQ_bio(in, ((void*)0));
        else
            req = PEM_read_bio_X509_REQ(in, ((void*)0), ((void*)0), ((void*)0));
        if (req == ((void*)0)) {
    ...
    if (newreq || x509) {
        ...
        if (x509) {
            EVP_PKEY *tmppkey;
            X509V3_CTX ext_ctx;
            if ((x509ss = X509_new()) == ((void*)0))
                goto end;


            if ((extensions != ((void*)0) || addext_conf != ((void*)0))
            ...
            if (serial != ((void*)0)) {
                ...
                if (!rand_serial(((void*)0), X509_get_serialNumber(x509ss)))
                    goto end;
            }
            ...
            if (!set_cert_times(x509ss, ((void*)0), ((void*)0), days))
                goto end;
            ...
            X509V3_set_ctx(&ext_ctx, x509ss, x509ss, ((void*)0), ((void*)0), 0);
            X509V3_set_nconf(&ext_ctx, req_conf);


            if (extensions != ((void*)0) && !X509V3_EXT_add_nconf(req_conf,
                                                            &ext_ctx, extensions,
                                                            x509ss)) {
            ...
            if (precert) {
                if (X509_add1_ext_i2d(x509ss, 952, ((void*)0), 1, 0)
                    != 1) {
            ...
            X509V3_set_ctx(&ext_ctx, ((void*)0), ((void*)0), req, ((void*)0), 0);
            X509V3_set_nconf(&ext_ctx, req_conf);
    ...
    if (modulus) {
        ...
        if (EVP_PKEY_base_id(tpubkey) == 6) {
            const BIGNUM *n;
            RSA_get0_key(EVP_PKEY_get0_RSA(tpubkey), &n, ((void*)0), ((void*)0));
            BN_print(out, n);
        } else
    ...
    CRYPTO_free(keyalgstr, "apps/req.c", 891);
    X509_REQ_free(req);
    X509_free(x509ss);
    ASN1_INTEGER_free(serial);
    release_engine(e);
    if (passin != nofree_passin)
        CRYPTO_free(passin, "apps/req.c", 897);
    if (passout != nofree_passout)
        CRYPTO_free(passout, "apps/req.c", 899);
    return ret;
}
                    ...
                    int attribs, unsigned long chtype)
{
    int ret = 0, i;
    char no_prompt = 0;
    struct stack_st_CONF_VALUE *dn_sk, *attr_sk = ((void*)0);
    char *tmp, *dn_sect, *attr_sect;

    tmp = NCONF_get_string(req_conf, "req", "prompt");
    if (tmp == ((void*)0))
        ERR_clear_error();
    if ((tmp != ((void*)0)) && strcmp(tmp, "no") == 0)
        no_prompt = 1;
    ...
    attr_sect = NCONF_get_string(req_conf, "req", "attributes");
    if (attr_sect == ((void*)0)) {
        ERR_clear_error();
        attr_sk = ((void*)0);
    } else {
                       ...
                       int attribs, unsigned long chtype)
{
 ...
 start:
        for ( ; ; ) {
            ...
            if (!join(buf, sizeof(buf), v->name, "_default", "Name"))
                return 0;
            if ((def = NCONF_get_string(req_conf, dn_sect, buf)) == ((void*)0)) {
                ERR_clear_error();
                def = "";
            }
            ...
            if (!join(buf, sizeof(buf), v->name, "_value", "Name"))
                return 0;
            if ((value = NCONF_get_string(req_conf, dn_sect, buf)) == ((void*)0)) {
                ERR_clear_error();
                value = ((void*)0);
            }
            ...
            if (!join(buf, sizeof(buf), v->name, "_min", "Name"))
                return 0;
            if (!NCONF_get_number_e(req_conf,dn_sect,buf,&n_min)) {
                ERR_clear_error();
                n_min = -1;
            }
            ...
            if (!join(buf, sizeof(buf), v->name, "_max", "Name"))
                return 0;
            if (!NCONF_get_number_e(req_conf,dn_sect,buf,&n_max)) {
                ERR_clear_error();
                n_max = -1;
            }
        ...
        if (attribs) {
            if ((attr_sk != ((void*)0)) && (sk_CONF_VALUE_num(attr_sk) > 0)
                && (!batch)) {
                BIO_printf(bio_err,
 ...
 start2:
            for ( ; ; ) {
                i++;
                if ((attr_sk == ((void*)0)) || (sk_CONF_VALUE_num(attr_sk) <= i))
                    break;
                ...
                if (!join(buf, sizeof(buf), type,"_min", "Name"))
                    return 0;
                if (!NCONF_get_number_e(req_conf,attr_sect,buf,&n_min)) {
                    ERR_clear_error();
                    n_min = -1;
                }
                ...
                if (!join(buf, sizeof(buf), type, "_max", "Name"))
                    return 0;
                if (!NCONF_get_number_e(req_conf,attr_sect,buf,&n_max)) {
                    ERR_clear_error();
                    n_max = -1;
                }
...
static int auto_info(X509_REQ *req, struct stack_st_CONF_VALUE *dn_sk,
                     struct stack_st_CONF_VALUE *attr_sk, int attribs,
                     unsigned long chtype)
{
                                    ...
                                    char **palgnam, ENGINE *keygen_engine)
{
    ...
    if (paramfile != ((void*)0)) {
        ...
        if (param == ((void*)0)) {
            ...
            (void)(int)BIO_ctrl(pbio,1,0,((void*)0));
    ...
    if (palgnam != ((void*)0)) {
        ...
        *palgnam = CRYPTO_strdup(anam, "apps/req.c", 1469);
    ...
    if ((*pkey_type == 6) && (keylen != -1)) {
        if (RSA_pkey_ctx_ctrl(gctx, (1<<2), (0x1000 + 3), keylen, ((void*)0)) <= 0) {
...
static int genpkey_cb(EVP_PKEY_CTX *ctx)
{
    ...
    if (p == 3)
        c = '\n';
    BIO_write(b, &c, 1);
    (void)(int)BIO_ctrl(b,11,0,((void*)0));
    return 1;
}

static int do_sign_init(EVP_MD_CTX *ctx, EVP_PKEY *pkey,
                        const EVP_MD *md, struct stack_st_OPENSSL_STRING *sigopts)
{
    ...
    if (ctx == ((void*)0))
        return 0;
    if (!EVP_DigestSignInit(ctx, &pkctx, md, ((void*)0), pkey))
        return 0;
