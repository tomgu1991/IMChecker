...
int rsautl_main(int argc, char **argv)
{
    ...
    RSA *rsa = ((void*)0);
    X509 *x;
    char *infile = ((void*)0), *outfile = ((void*)0), *keyfile = ((void*)0);
    char *passinarg = ((void*)0), *passin = ((void*)0), *prog;
    char rsa_mode = 2, key_type = 1;
    unsigned char *rsa_in = ((void*)0), *rsa_out = ((void*)0), pad = 1;
    int rsa_inlen, keyformat = (5 | 0x8000), keysize, ret = 1;
 ...
 opthelp:
        ...
        case OPT_HELP:
            ...
            goto end;
        case OPT_KEYFORM:
            if (!opt_format(opt_arg(), ((1L << 1) | (1L << 4)), &keyformat))
                goto opthelp;
            break;
        case OPT_IN:
            infile = opt_arg();
    ...
    case 2:
        pkey = load_pubkey(keyfile, keyformat, 0, ((void*)0), e, "Public Key");
        break;
    ...
    BIO_free(in);
    BIO_free_all(out);
    CRYPTO_free(rsa_in, "apps/rsautl.c", 277);
    CRYPTO_free(rsa_out, "apps/rsautl.c", 278);
    CRYPTO_free(passin, "apps/rsautl.c", 279);
    return ret;
}
